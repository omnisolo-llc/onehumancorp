...
# Virtual Meeting Room & UltraPlan Protocol Visual Walkthrough

Welcome to the Virtual Meeting Room guide. This visual walkthrough explains how autonomous agents collaborate and deliberate before executing code changes.

## 1. The UltraPlan Deliberation Cycle

Before touching any production code, high-level agents (like the PM and Engineering Director) join a **Virtual Meeting Room** to map out edge cases, define architecture, and agree on an execution plan using the UltraPlan protocol.
...
## 3. UltraPlan State Machine

The UltraPlan defines how agents agree on a final artifact:
