...
- **[KAIROS Distributed State Machine Walkthrough](distributed_state_machine.md)**: Understand how agent state transitions are tracked across Cloud and Standalone modes.
