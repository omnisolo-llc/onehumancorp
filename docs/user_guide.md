...
# User Guide: OHC Application

## 1. Overview

This guide covers the Bazel-native Next.js and Tauri v2 app workflow.
The app provides a unified, mobile-first onboarding experience for small business owners, operating across Web, Desktop (Linux, macOS, Windows), and Mobile platforms.

## 2. Onboarding Flow

The OHC application features a comprehensive 12-step onboarding wizard:
