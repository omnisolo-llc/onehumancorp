...
**Implementation Prompt**: Implement a direct Meta Graph API OAuth flow. Create a native webhook endpoint that receives incoming messages, stores them in the OmniSolo unified inbox, and triggers the Customer Success agent to draft a reply.
**Priority**: P0
