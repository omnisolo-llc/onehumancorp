# [Marketing] Auto-Social Media Manager
...
- **UI Flow:**
  ...
  2. User taps "Auto-Social Media Manager".
  3. User toggles "Enable AI Automation".
  4. System confirms activation via a subtle Glassmorphism toast notification.
- **Integration Points:** Vision LLM, Content Scheduling Service, OHC Core Service, OHC AI Orchestrator.

## Implementation Prompt
Implement the Auto-Social Media Manager feature. The agent must have real-time access to the user's data.
...
**Acceptance Criteria:**
- Agent successfully executes the core task (Agent generates 3 Instagram posts per week based on product photos.).
...
| Platform | Approach to Auto-Social Media Manager | Drawbacks |
| :--- | :--- | :--- |
