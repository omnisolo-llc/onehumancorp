# [Operations] AI Vendor Emails

## Problem Statement
SMBs pay retail for supplies.
...
## Design Doc
- **Entity Types:** `OperationsEntity`, `Task`, `AIAgentPersona`.
...
- **UI Flow:**
  ...
  2. User taps "AI Vendor Emails".
  3. User toggles "Enable AI Automation".
  4. System confirms activation via a subtle Glassmorphism toast notification.
- **Integration Points:** Supplier DB, Negotiation LLM, OHC Core Service, OHC AI Orchestrator.

## Implementation Prompt
Implement the AI Vendor Emails feature. The agent must have real-time access to the user's data.
...
**Acceptance Criteria:**
- Agent successfully executes the core task (Agent drafts emails to suppliers asking for wholesale discounts.).
...
| Platform | Approach to AI Vendor Emails | Drawbacks |
| :--- | :--- | :--- |
