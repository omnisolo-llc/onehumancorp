# [Customer_Support] Unhappy Customer Alert

## Problem Statement
SMBs miss negative feedback until a bad review is posted.
...
## Design Doc
- **Entity Types:** `CustomerSupportEntity`, `Task`, `AIAgentPersona`.
...
- **UI Flow:**
  ...
  2. User taps "Unhappy Customer Alert".
  3. User toggles "Enable AI Automation".
  4. System confirms activation via a subtle Glassmorphism toast notification.
- **Integration Points:** OHC Unified Inbox, Sentiment Analysis LLM, OHC Core Service, OHC AI Orchestrator.

## Implementation Prompt
Implement the Unhappy Customer Alert feature. The agent must have real-time access to the user's data.
...
**Acceptance Criteria:**
- Agent successfully executes the core task (Agent monitors DMs and emails for anger/frustration and flags to owner.).
...
| Platform | Approach to Unhappy Customer Alert | Drawbacks |
| :--- | :--- | :--- |
