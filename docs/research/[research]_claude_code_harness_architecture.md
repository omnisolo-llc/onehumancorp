...
*   **Implementation Prompt**:
    1. Open `srcs/server/api/agent_pool.go`.
...
*   **Implementation Prompt**:
    1. Modify `srcs/app/standalone_linux_launcher.sh` or the local startup logic to ensure `.ohc/memory/` directories are created.
