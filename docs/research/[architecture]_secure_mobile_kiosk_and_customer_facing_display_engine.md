...
3.  **Application-Level Sandbox:** We cannot fully override the OS, but we can intercept all navigation actions within the Tauri/React Native container to create a "walled garden" during checkout.
