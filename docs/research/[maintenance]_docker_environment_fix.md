...
graph TD
    ...
    Compose --> HealthyStack[Healthy OmniSolo Stack]
...
1.  Provide a script or Bazel target that builds all required OmniSolo services (`server`, `agent`) locally and loads them into the local Docker daemon.
