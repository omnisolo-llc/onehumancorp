...
## Title
[Marketing] Autonomous Social Promoter
...
- **Agent Action**: The Autonomous Social Promoter (Marketing Agent) is invoked.
...
Implement the "Autonomous Social Promoter" feature. Create an event listener that triggers the Marketing Agent whenever a user adds a new product or service. The agent should automatically generate corresponding social media drafts (images and captions) and surface them in the user's dashboard for 1-tap approval and publishing.
