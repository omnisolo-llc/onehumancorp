...
* **Graceful Degradation for Tests**: Following strict memory guidelines, our CI environment properly degrades when real databases are missing by utilizing `test skips`. Removing these skips would violate parity and resilience rules.
