...
**Research Report**:
- Ayrshare provides a unified platform for posting and retrieving messages across all major social networks (Instagram, Facebook, X, TikTok, LinkedIn).
...
- Works well for both central and local deployments.
**Design Doc**:
- Users link their social accounts via a simple connection screen in the "Marketing & Advertising" tab.
- "The Ambassador" AI monitors incoming messages and drafts replies visible in a unified "Customer Inbox."
