# [Finance] Invisible Bookkeeping

## Problem Statement
SMBs dread tax season and miscategorize expenses.
...
## Design Doc
- **Entity Types:** `FinanceEntity`, `Task`, `AIAgentPersona`.
...
- **UI Flow:**
  ...
  2. User taps "Invisible Bookkeeping".
  3. User toggles "Enable AI Automation".
  4. System confirms activation via a subtle Glassmorphism toast notification.
- **Integration Points:** Plaid API, Tax Agent Router, OHC Core Service, OHC AI Orchestrator.

## Implementation Prompt
Implement the Invisible Bookkeeping feature. The agent must have real-time access to the user's data.
...
**Acceptance Criteria:**
- Agent successfully executes the core task (Agent scans receipts and banking feed, categorizing them via LLM.).
...
| Platform | Approach to Invisible Bookkeeping | Drawbacks |
| :--- | :--- | :--- |
