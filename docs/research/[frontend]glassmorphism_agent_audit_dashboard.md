...
- **Visual Mandate**: Glassmorphism, 20px blur, Outfit/Inter typography, and smooth animations (Framer Motion/Flutter).
...
1. Build a new Flutter/React component `AgentAuditDashboard` in `srcs/app/ui/components/`.
