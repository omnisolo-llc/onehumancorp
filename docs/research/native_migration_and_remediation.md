...
| F04 | Model paths disagree on usage; proposal adapter no longer substitutes a default zero-usage result; proxy forwards streams | Preserve actual provider counts, model/request identity and missing-usage state; no invented free usage | Open |
