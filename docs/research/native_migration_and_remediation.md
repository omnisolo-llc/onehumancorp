...
| F03: budget increments before denial | Checked pricing budget and durable usage reservations, settlement/cancel/replay state; tenant limits cannot be lowered below outstanding exposure. | Closed |
