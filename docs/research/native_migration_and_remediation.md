...
| F14: economics/owner outcomes | Workload usage records and build/resource timing available; research keeps costs, owner correction time and actual outcome evidence separate. | Blocked due to missing Docker container (ohc-e2e-pg) required for Playwright E2E tests and metrics. |
