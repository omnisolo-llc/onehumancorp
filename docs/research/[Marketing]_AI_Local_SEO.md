# [Marketing] Zero-Touch Local SEO Optimizer

## Problem Statement
Carlos (handyman) doesn't know how to rank on Google Maps.
...
## Design Doc
- **Entity Types:** `MarketingEntity`, `Task`, `AIAgentPersona`.
...
- **UI Flow:**
  ...
  2. User taps "Zero-Touch Local SEO Optimizer".
  3. User toggles "Enable AI Automation".
  4. System confirms activation via a subtle Glassmorphism toast notification.
- **Integration Points:** Google My Business API, Copywriting Agent, OHC Core Service, OHC AI Orchestrator.

## Implementation Prompt
Implement the Zero-Touch Local SEO Optimizer feature. The agent must have real-time access to the user's data.
...
**Acceptance Criteria:**
- Agent successfully executes the core task (Agent automatically claims Google Business profile, optimizes keywords, posts weekly.).
...
| Platform | Approach to Zero-Touch Local SEO Optimizer | Drawbacks |
| :--- | :--- | :--- |
