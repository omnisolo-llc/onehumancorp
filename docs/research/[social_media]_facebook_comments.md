# Integrate Facebook Page Comments

## 1. Problem Statement
Business owners run ads on Facebook and receive hundreds of comments. They often miss sales because they don't reply quickly to people asking 'Is this still available?'.
...
## 2. Research Report
Facebook Graph API allows fetching and replying to comments on page posts and ads. This is a massive revenue driver. The integration is standard OAuth. Works well in Cloud and Standalone.
...
## 3. Design Document
Similar to Instagram DMs, a 'Connect Facebook' button in settings. Comments appear in the unified inbox. Users can reply directly.
...
Implement Facebook Page integration. Build the UI to display post comments in the inbox with visual context of the original ad/post.
