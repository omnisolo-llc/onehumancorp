...
## Research Report
- **Strategy**: Build a native email campaign manager.
...
- The user approves the AI-generated email, and OHC sends it.
...
Build a native email campaign management system. Allow the AI Marketing agent to create and queue email campaigns directly from the OHC customer list. Create an interface for users to approve and monitor campaign performance.
