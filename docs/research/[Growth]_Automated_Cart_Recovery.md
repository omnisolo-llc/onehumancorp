# [Growth] AI Cart Recovery Campaigns

## Problem Statement
Customers add items to cart but leave. Manual follow up is too hard for SMBs.
...
## Design Doc
- **Entity Types:** `GrowthEntity`, `Task`, `AIAgentPersona`.
...
- **UI Flow:**
  ...
  2. User taps "AI Cart Recovery Campaigns".
  3. User toggles "Enable AI Automation".
  4. System confirms activation via a subtle Glassmorphism toast notification.
- **Integration Points:** OHC Core Service, OHC Email Subsystem, OHC Core Service, OHC AI Orchestrator.

## Implementation Prompt
Implement the AI Cart Recovery Campaigns feature. The agent must have real-time access to the user's data.
...
**Acceptance Criteria:**
- Agent successfully executes the core task (Agent detects abandoned cart, generates personalized email with discount.).
...
| Platform | Approach to AI Cart Recovery Campaigns | Drawbacks |
| :--- | :--- | :--- |
