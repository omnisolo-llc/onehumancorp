...
<div style='background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(30px) saturate(210%); border-radius: 15px; padding: 20px; border: 1px solid rgba(255, 255, 255, 0.2);'>
