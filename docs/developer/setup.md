...
4. Generates an intelligence log in `${XDG_STATE_HOME:-$HOME/.local/state}/ohc/runtime/memory/` (or the configured `OHC_MEMORY_DIR`) confirming successful provisioning.
