...
We want you to understand exactly what you pay for. You pay for the computer power and AI tools the team uses. You will see an estimated cost before a task starts, and a detailed bill when it finishes. You pay your connected providers (like Stripe or Google) directly, and we do not charge you twice for those services. There are no hidden fees.
