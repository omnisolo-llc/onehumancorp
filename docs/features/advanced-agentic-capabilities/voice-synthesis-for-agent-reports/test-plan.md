...
- **Action:** Trigger an end-of-day summary task. Verify the backend successfully calls the TTS endpoint, generates a valid `.mp3` buffer, and streams it to the client.
