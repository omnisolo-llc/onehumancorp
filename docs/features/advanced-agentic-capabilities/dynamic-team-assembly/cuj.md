# CUJ: Dynamic Team Assembly

<div style="backdrop-filter: blur(20px) saturate(200%); background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); font-family: 'Outfit', 'Inter', sans-serif; padding: 20px; border-radius: 8px; color: white;">


**Persona:** Autonomous Agent / Human Manager
**Context:** Leveraging Dynamic Team Assembly during standard operational workflows or cross-team collaboration.
...
When a complex Epic is ingested, the Manager Agent analyzes the sub-tasks and dynamically defines and provisions a bespoke team of specialized agents, adjusting replica counts in real-time.
...
| 3 | Core Processing | The workflow integrates Dynamic Team Assembly securely | Operation completed | DB Check |
