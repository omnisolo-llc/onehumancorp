...
- **Action:** Register a mock 'Delete Database' tool. Ensure the agent can 'call' the tool, receive a successful 200 OK fixture, and verify zero actual database queries were executed.
