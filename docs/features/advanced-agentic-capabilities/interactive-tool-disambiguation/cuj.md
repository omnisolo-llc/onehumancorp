...
# CUJ: Interactive Tool Disambiguation

**Persona:** Autonomous Agent / Human Manager
**Context:** Leveraging Interactive Tool Disambiguation during standard operational workflows or cross-team collaboration.
...
When an agent attempts to use a tool but provides ambiguous or incomplete parameters, the system intercepts the call and prompts the agent interactively to clarify its intent before execution.
...
| 3 | Core Processing | The workflow integrates Interactive Tool Disambiguation securely | Operation completed | DB Check |
