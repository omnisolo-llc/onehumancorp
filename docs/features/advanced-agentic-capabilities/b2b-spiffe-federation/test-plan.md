...
- **Action:** Simulate a request from a 'Vendor' cluster to a 'Client' cluster's MCP Gateway. Verify the federated identity is validated and the request succeeds based on inter-org trust policies.
