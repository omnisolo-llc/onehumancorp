...
- **Integration Testing:** Verify the interaction between the OmniSolo Hub, Postgres DB, and the `omnisolo-operator` when instantiating new `RoleProfile` Custom Resource Definitions (CRDs).
