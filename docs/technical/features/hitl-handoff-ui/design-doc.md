...
- **Architecture**: A native K8s-backed system leveraging the OmniSolo Hub to route handoff requests. The frontend is built on Next.js, presenting a unified dashboard for human operators.
