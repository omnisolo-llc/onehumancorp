...
- Dynamically load the appropriate driver based on `os.Getenv("OMNISOLO_MULTITENANT") == "true"`.
...
2. Implement environment-agnostic logic. Check `os.Getenv(\"OMNISOLO_MULTITENANT\") == \"true\"` to determine the driver.
