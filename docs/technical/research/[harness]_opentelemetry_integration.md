...
1. Add OpenTelemetry metric initialization to `srcs/server/harness/sandbox.go`.
...
4. Add comprehensive unit tests in `srcs/server/harness/sandbox_test.go` verifying metric emissions during blocked executions.
