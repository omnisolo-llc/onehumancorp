...
# OmniSolo Hybrid Development Model

Welcome to the OmniSolo (OmniSolo) Hybrid Development Model guide. The OmniSolo platform is designed to effortlessly scale across single-user desktop environments and horizontal cloud deployments without modifying source code.
...
1. **Cloud-Native Mode**
   ...
   - **Command:** `source deploy/scripts/omnisolo-mode.sh cloud`
...
2. **Standalone Desktop Mode**
   ...
   - **Command:** `source deploy/scripts/omnisolo-mode.sh standalone`
...
3. **Headless Cloud API**
   ...
   - **Command:** `source deploy/scripts/omnisolo-mode.sh headless`
...
./deploy/scripts/omnisolo-cloud-start.sh
```
