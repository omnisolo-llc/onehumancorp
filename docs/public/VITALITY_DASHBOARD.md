...
- **Global Intelligence Entries:** > 10 recent observations added via Swarm Intelligence Protocol (`OHC_MEMORY_DIR`, typically `${XDG_STATE_HOME:-$HOME/.local/state}/ohc/runtime/memory`).
