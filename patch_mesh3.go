...
`
    // We will just place it before initTopic
    strContent = strings.Replace(strContent, "func (lm *LocalTeammateMesh) initTopic(topic string) {", discoverAgentsImplLocal+"func (lm *LocalTeammateMesh) initTopic(topic string) {", 1)
