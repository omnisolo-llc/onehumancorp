...
go_repository(
    ...
    sum = "h1:0U1Aea2iQ2Yl5XqAUB2n66uFpOPzR4c3Z7y8g0iE2eA=",
    version = "v1.14.22",
)
...
go_repository(
    ...
    sum = "h1:4DBwIQ0fdW/jB5yWEIZEnlNkcXp/r0O2WnQ7E1u9G2g=",
    version = "v1.0.0",
)
...
go_repository(
    ...
    sum = "h1:fxzj19A62rA8Xk2YVj/oTntP9L3KkS54H8N7JjZ6yyo=",
    version = "v3.0.1",
)
