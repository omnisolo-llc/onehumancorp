...
some other ruleset that depends on rules_playwright, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_playwright=$(pwd)/rules_playwright"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_playwright` on your system will point to this folder.
...
https://github.com/mrmeku/rules_playwright/actions/workflows/tag.yaml
