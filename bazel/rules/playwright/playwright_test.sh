...
export OHC_AGENT_TOKEN="12345678901234567890123456789012"
...
if [[ -n "${SERVER_BIN:-}" && -x "${SERVER_BIN:-}" ]]; then
  ...
  OHC_AGENT_TOKEN="12345678901234567890123456789012" \
  OHC_AGENT_AUTH_KEY="12345678901234567890123456789012" \
