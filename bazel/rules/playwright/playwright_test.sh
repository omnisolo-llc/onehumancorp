...
playwright_spec_workspace_name() {
  ...
  rel="${rel#./}"
  case "$rel" in
    app/src/e2e/*|src/e2e/*|/app/src/e2e/*)
      rel_clean="${rel#/app/}"
      rel_clean="${rel_clean#app/}"
      printf '%s\n' "$rel_clean"
      ;;
    src/ui/next/e2e/*.spec.ts|src/ui/next/src/e2e/*.spec.ts|app/src/ui/next/e2e/*.spec.ts|app/src/ui/next/src/e2e/*.spec.ts|/app/src/ui/next/e2e/*.spec.ts|/app/src/ui/next/src/e2e/*.spec.ts)
