...
(
  ...
  OMNISOLO_BACKEND_URL="$API_BASE_URL" \
  OMNISOLO_API_URL="$API_BASE_URL" \
  OMNISOLO_WEB_CANONICAL_ORIGIN="$BASE_URL" \
  OMNISOLO_WEB_LOCAL_DEV=true \
  OMNISOLO_WEB_SESSION_KEY_ID=e2e-v1 \
  OMNISOLO_WEB_SESSION_SECRET="$OMNISOLO_WEB_SESSION_SECRET" \
