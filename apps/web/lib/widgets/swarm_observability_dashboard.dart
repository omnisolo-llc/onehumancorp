...
class SwarmObservabilityDashboard extends StatefulWidget {
  final Stream<MeshMessage> messageStream;
  ...
  @override
  State<SwarmObservabilityDashboard> createState() =>
      _SwarmObservabilityDashboardState();
}
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.wifi_tethering, color: Colors.blueAccent, size: 24),
                    ),
...
class _AnimatedMessageItem extends StatefulWidget {
  ...
  const _AnimatedMessageItem({Key? key, required this.message}) : super(key: key);
