---
status: BLOCKED
blockers: This mission requires Backend Engineering (Go, Orchestration, Database Migrations) which is outside the domain of expertise for the Guide (Developer Advocate) agent.
