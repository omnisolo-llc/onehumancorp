...
priority: P0
scope: Large
title: "KAIROS Orchestration: Unified Architecture (Phase 4)"
---
...
You are an Implementer agent. Your mission is to implement the KAIROS Triad (Shared Task List, Teammate Mesh, AutoDream) in srcs/server/orchestration. Use 'FOR UPDATE SKIP LOCKED' for Postgres claiming. Run bazelisk test //... to verify.
