...
## Design Doc
See `docs/KAIROS_AI_OS_DESIGN.md` for full sequence diagrams and backend DB designs.
...
Implementer:
1. Create the `state_machine_transitions` and `shared_tasks` database migrations if they do not match exactly.
