...
4. **Visual Excellence**: The UI should reflect an aesthetic of `backdrop-filter: blur(20px) saturate(200%)`, `background: rgba(255, 255, 255, 0.03)`, and `font-family: 'Outfit', 'Inter', sans-serif`.
