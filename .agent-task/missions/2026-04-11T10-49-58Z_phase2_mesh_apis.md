...
## Research Report
- Current communication relies on basic interfaces or bare WebSockets. Memory indicates we must utilize `CentrifugeNode` for realtime pub/sub task broadcasting.
