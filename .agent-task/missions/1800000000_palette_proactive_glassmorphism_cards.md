...
# Research Report
An audit of `srcs/app/lib/screens/` indicates that standard `Card()` is still being instantiated in multiple locations. Using a central `GlassCard` widget will ensure visual consistency across the entire application.
...
- Standardize the hover scale to 1.02.
