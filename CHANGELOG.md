...
- Improved multi-tenant scaling and Redis caching performance for faster workspace loads.

### Privacy/Offline Improvements
- Enhanced offline reliability and strict data privacy controls for local execution.
