## v0.4.49 (Cloud) / v0.4.49+1 (Standalone)
...
- Enforce Multi-Environment Promotion behavior for Local desktop beta builds ensuring stricter local offline usage and privacy guarantees.
