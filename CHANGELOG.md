...
- Integrated division-by-zero safeguards within Cost metrics and ROI calculations for resilient scale-up behavior.

### Privacy/Offline Improvements
- Propagated zero-cost division fallbacks to the offline Standalone Slint UI layer to ensure visual stability under missing metric conditions.
