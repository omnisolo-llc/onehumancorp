...
- Enable resource requests for bazel test action in buildbuddy.yaml (#e384844)

### Privacy/Offline Improvements
- Update resource requirements to ensure stable standalone testing environments
