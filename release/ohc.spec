...
cp "../{ohc-builtin-agent}" "%{buildroot}/usr/local/bin/ohc-builtin-agent" 2>/dev/null || cp "../bazel-out/k8-fastbuild/bin/src/agents/builtin/ohc-builtin-agent" "%{buildroot}/usr/local/bin/ohc-builtin-agent"
