            ...
            <html>
                ...
                <body>
                    ...
                    <div id="dashboard-screen" class="screen">
                        <div id="push-notification-toast" class="glass" style="position:fixed; top:20px; left:50%; transform:translateX(-50%); z-index:9999; display:none; padding:16px 24px; border-radius:8px; border-left:4px solid var(--primary); box-shadow:0 10px 25px rgba(0,0,0,0.2); background:rgba(255,255,255,0.95);">
                            <h3 style="margin:0 0 4px 0; font-size:16px; color:#111;">First Deposit Received!</h3>
                            <p style="margin:0; font-size:14px; color:#666;">Cha-ching! You just got a new order.</p>
                        </div>
                        <h1>Dashboard</h1>

                        <div class="card glass" id="retention-widget" style="text-align: center; padding: 20px;">
                            <h3 style="color: var(--text); margin-bottom: 8px;">Business Update</h3>
