...
EXPECTED_REQUIRED_RESULT_LINES = (
    ...
    'echo "native-lint: ${NATIVE_LINT_RESULT}"',
    'echo "native-node-lint: ${NATIVE_NODE_LINT_RESULT}"',
    'echo "native-e2e-discovery: ${NATIVE_E2E_DISCOVERY_RESULT}"',
    'echo "native-e2e-report: ${NATIVE_E2E_REPORT_RESULT}"',
    'require_success() {',
    'local name="$1"',
    'local result="$2"',
    ...
    'allow_success_or_skipped "native-lint" "$NATIVE_LINT_RESULT"',
    'allow_success_or_skipped "native-node-lint" "$NATIVE_NODE_LINT_RESULT"',
    'allow_success_or_skipped "native-e2e-discovery" "$NATIVE_E2E_DISCOVERY_RESULT"',
    'allow_success_or_skipped "native-e2e-report" "$NATIVE_E2E_REPORT_RESULT"',
    ...
    'require_success "native-lint" "$NATIVE_LINT_RESULT"',
    'require_success "native-node-lint" "$NATIVE_NODE_LINT_RESULT"',
    'require_success "native-e2e-discovery" "$NATIVE_E2E_DISCOVERY_RESULT"',
    'require_success "native-e2e-report" "$NATIVE_E2E_REPORT_RESULT"',
...
EXPECTED_REQUIRED_ENV = (
    ...
    '          NATIVE_LINT_RESULT: ${{ needs.native-lint.result }}',
    '          NATIVE_NODE_LINT_RESULT: ${{ needs.native-node-lint.result }}',
    '          NATIVE_E2E_DISCOVERY_RESULT: ${{ needs.native-e2e-discovery.result }}',
    '          NATIVE_E2E_REPORT_RESULT: ${{ needs.native-e2e-report.result }}',
)
...
def check_workflow(path: Path) -> None:
    ...
    require_active(required, "      - native-lint", "ci-required independent evaluation")
    require_active(required, "      - native-node-lint", "ci-required independent evaluation")
    require_active(required, "      - native-e2e-discovery", "ci-required independent evaluation")
    require_active(required, "      - native-e2e-report", "ci-required independent evaluation")
