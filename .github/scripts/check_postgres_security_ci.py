...
EXPECTED_WORKFLOW_ENV = ("env:", '  FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: "true"', '  ACTIONS_RUNNER_DISABLE_COMPILE_CACHE: "1"')
...
def check_workflow(path: Path) -> None:
    ...
    if active_config_lines(workflow_env) != EXPECTED_WORKFLOW_ENV:
        raise ContractError("workflow env must contain exactly FORCE_JAVASCRIPT_ACTIONS_TO_NODE24 and ACTIONS_RUNNER_DISABLE_COMPILE_CACHE")
