...
EXPECTED_WORKFLOW_ENV = ("env:", '  FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: "true"', '  NODE_COMPILE_CACHE: ""')
...
def check_workflow(path: Path) -> None:
    ...
    if active_config_lines(workflow_env) != EXPECTED_WORKFLOW_ENV:
        raise ContractError("workflow env must contain only FORCE_JAVASCRIPT_ACTIONS_TO_NODE24 and NODE_COMPILE_CACHE")
