...
EXPECTED_WORKFLOW_ENV = ("env:", '  NODE_DISABLE_COMPILE_CACHE: "1"', '  FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: "true"')
...
def check_workflow(path: Path) -> None:
    ...
    if active_config_lines(workflow_env) != EXPECTED_WORKFLOW_ENV:
        raise ContractError("workflow env must contain NODE_DISABLE_COMPILE_CACHE and FORCE_JAVASCRIPT_ACTIONS_TO_NODE24")
