...
EXPECTED_REQUIRED_RESULT_LINES = (
    ...
    'echo "native-browser-results: ${NATIVE_BROWSER_RESULTS_RESULT}"',
    'echo "native-browser-inventory: ${NATIVE_BROWSER_INVENTORY_RESULT}"',
    'echo "native-rust-results: ${NATIVE_RUST_RESULTS_RESULT}"',
    'echo "native-rust-execute: ${NATIVE_RUST_EXECUTE_RESULT}"',
    'echo "native-rust-lint: ${NATIVE_RUST_LINT_RESULT}"',
    'echo "native-node-lint: ${NATIVE_NODE_LINT_RESULT}"',
    ...
    'allow_success_or_skipped "native-browser-results" "$NATIVE_BROWSER_RESULTS_RESULT"',
    'allow_success_or_skipped "native-browser-inventory" "$NATIVE_BROWSER_INVENTORY_RESULT"',
    'allow_success_or_skipped "native-rust-results" "$NATIVE_RUST_RESULTS_RESULT"',
    'allow_success_or_skipped "native-rust-execute" "$NATIVE_RUST_EXECUTE_RESULT"',
    'allow_success_or_skipped "native-rust-lint" "$NATIVE_RUST_LINT_RESULT"',
    'allow_success_or_skipped "native-node-lint" "$NATIVE_NODE_LINT_RESULT"',
    ...
    'require_success "native-browser-results" "$NATIVE_BROWSER_RESULTS_RESULT"',
    'require_success "native-browser-inventory" "$NATIVE_BROWSER_INVENTORY_RESULT"',
    'require_success "native-rust-results" "$NATIVE_RUST_RESULTS_RESULT"',
    'require_success "native-rust-execute" "$NATIVE_RUST_EXECUTE_RESULT"',
    'require_success "native-rust-lint" "$NATIVE_RUST_LINT_RESULT"',
    'require_success "native-node-lint" "$NATIVE_NODE_LINT_RESULT"',
...
EXPECTED_REQUIRED_ENV = (
    ...
    "          NATIVE_BROWSER_RESULTS_RESULT: ${{ needs.native-browser-results.result }}",
    "          NATIVE_BROWSER_INVENTORY_RESULT: ${{ needs.native-browser-inventory.result }}",
    "          NATIVE_RUST_RESULTS_RESULT: ${{ needs.native-rust-results.result }}",
    "          NATIVE_RUST_EXECUTE_RESULT: ${{ needs.native-rust-execute.result }}",
    "          NATIVE_RUST_LINT_RESULT: ${{ needs.native-rust-lint.result }}",
    "          NATIVE_NODE_LINT_RESULT: ${{ needs.native-node-lint.result }}",
