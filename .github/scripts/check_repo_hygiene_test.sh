...
assert_forbidden 'OmniSolo JWT secret' '.omnisolo_jwt_secret'
assert_forbidden 'nested OmniSolo JWT secret' 'nested/.omnisolo_jwt_secret'
assert_forbidden 'OmniSolo SQLite key' '.omnisolo_sqlite_key'
assert_forbidden 'legacy SQLite key' '.ohc_sqlite_key'
assert_near_misses_allowed
