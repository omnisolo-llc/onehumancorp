              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: Theme.of(context).colorScheme.error, fontFamily: 'Inter', fontWeight: FontWeight.bold),
                  ),
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _Metric(label: 'Response Time', value: '12ms', color: colors.tertiary, icon: Icons.speed),
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('We couldn\'t update your ${widget.role} team. Please try again later.', style: const TextStyle(fontFamily: 'Inter')),
...
class _StatCardState extends State<_StatCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = widget.width ?? (screenWidth < 768 ? (screenWidth - 48 - 16) / 2 : 200.0);
