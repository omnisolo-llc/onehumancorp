...
- Scaling (Cloud): Optimized cloud artifact deployment footprint by removing redundant documentation and license files from the unified build.
- Privacy/Offline (Standalone): Enhanced desktop client build reliability and reduced binary footprint by pruning unused mobile help center assets.
