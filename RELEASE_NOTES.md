...
- Scaling (Cloud): Enhance ActiveOrganizations tracking and AI Agent Memory Consolidation.
- Privacy/Offline (Standalone): Enhance Hybrid MCP RAG Sync Daemon privacy and resolve SQLite DB lock parity issues.
