...
- Scaling (Cloud): Implement formal realtime teammate mesh APIs, standardize Playwright E2E testing, simplify login flow, and improve E2E test reliability.
- Privacy/Offline (Standalone): Implement JetBrains Observation Masking mechanic for context management.
