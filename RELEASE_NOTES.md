...
- Scaling (Cloud): Hybrid Local-to-Cloud State Sync MCP Proxy integration for multi-tenant scalability.
- Privacy/Offline (Standalone): Strict Opt-in Telemetry Enforcement for Hybrid Privacy in Standalone mode.
