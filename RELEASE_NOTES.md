...
- Scaling (Cloud): Enable resource requests for bazel test action in buildbuddy.yaml.
- Privacy/Offline (Standalone): Minor test infrastructure tweaks for reliable standalone execution.
