...
- Scaling (Cloud): Enhanced AutoDream data pipeline architecture for horizontal pod concurrency.
- Privacy/Offline (Standalone): Hardened local telemetry with strict opt-in environment isolation and introduced a HybridHealthProbe for local-to-cloud mission sync reliability.
