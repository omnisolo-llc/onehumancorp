...
- Scaling (Cloud): fix(ui): replace mock text with functional checkboxes in onboarding checklists (#9171)
- Privacy/Offline (Standalone): fix(ui): replace mock text with functional checkboxes in onboarding checklists (#9171)
