...
- Scaling (Cloud): Codebase health improvements, refactoring, and test coverage maintenance for robust K8s multi-tenant orchestration.
- Privacy/Offline (Standalone): Maintained absolute local sovereignty and seamless synchronization stability for desktop clients.
