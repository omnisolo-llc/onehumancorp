...
- Scaling (Cloud): Implement formal realtime teammate mesh APIs and Harness Upgrade for JetBrains Observation Masking.
- Privacy/Offline (Standalone): Standardize E2E testing with Playwright, fix SQLite migration parsing, fix failing flutter widget tests, and simplify admin login flow.
