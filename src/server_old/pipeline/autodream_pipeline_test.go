...
func (m *mockLLM) Chat(ctx context.Context, req local.ChatRequest) (local.ChatResponse, error) {
	return local.ChatResponse{
		Message: local.Message{Content: m.response,
	}}, nil
}
