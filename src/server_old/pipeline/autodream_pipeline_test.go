...
func (m *mockLLM) Chat(ctx context.Context, req builtin.ChatRequest) (builtin.ChatResponse, error) { return builtin.ChatResponse{}, nil }
func (m *mockLLM) Complete(ctx context.Context, req builtin.CompletionRequest) (*builtin.AssistantMessage, error) {
