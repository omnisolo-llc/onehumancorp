...
func (t *ConfigTool) GetConfigTool() local.ToolDefinition {
	return local.ToolDefinition{
		...
		InputSchema: map[string]interface{}{"type":"object","properties":map[string]interface{}{"key":map[string]interface{}{"type":"string","description":"The configuration key to read"}},"required":[]interface{}{"key"}},
		}
}
...
func (t *ConfigTool) SyncConfigToCloudTool() local.ToolDefinition {
	return local.ToolDefinition{
		...
		InputSchema: map[string]interface{}{"type":"object","properties":map[string]interface{}{"tenant_id":map[string]interface{}{"type":"string"},"agent_id":map[string]interface{}{"type":"string"},"key":map[string]interface{}{"type":"string"},"value":map[string]interface{}{"type":"string"},"metadata":map[string]interface{}{"type":"object","additionalProperties":map[string]interface{}{"type":"string"}}},"required":[]interface{}{"tenant_id","agent_id","key","value"}},
		}
}
