...
func (t *ConfigTool) ExecuteGetConfigTool(ctx context.Context, args json.RawMessage) (string, error) {
			var input struct {
				Key string `json:"key"`
			}
...
func (t *ConfigTool) ExecuteSyncConfigToCloudTool(ctx context.Context, args json.RawMessage) (string, error) {
