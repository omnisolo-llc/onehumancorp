...
{}", last_assistant_content))],
            ...
            crate::masking::apply_observation_masking(&mut messages, final_cfg.enable_observation_masking, final_cfg.observation_masking_threshold, final_cfg.observation_masking_size_limit);
