...
{}", last_assistant_content))],
            ...
            for tc in &read_only_calls {
                ...
                // We resolve the tool reference before spawning the task to avoid passing `self`
                ...
                read_only_futures.push(tokio::task::spawn(async move {
                    ...
                    let max_retries = 2;
                    loop {
                        // We inline the execution logic here instead of `self.execute_tool` to satisfy `'static`
