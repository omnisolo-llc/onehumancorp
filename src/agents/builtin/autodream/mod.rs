        ...
        tokio::spawn(async move {
            loop {
                ...
                let repository = match &db.store {
                    ::server_lib::db::DbStore::Postgres => ohc_builtin_agent::memory::VectorRepository::new(db.pool.clone()),
                    ::server_lib::db::DbStore::Sqlite(sqlite_pool) => ohc_builtin_agent::memory::VectorRepository::new_sqlite(sqlite_pool.clone()),
                };
