        ...
        tokio::spawn(async move {
            loop {
                ...
                let repository = match &db.store {
                    ::server_lib::db::DbStore::Postgres => ohc_builtin_agent::memory_store::ConsolidatedMemoryRepository::new(db.pool.clone()),
                    ::server_lib::db::DbStore::Sqlite(sqlite_pool) => ohc_builtin_agent::memory_store::ConsolidatedMemoryRepository::new_sqlite(sqlite_pool.clone()),
                };
