...
impl ToolExecutor for QrGenerateExecutor {
    async fn execute(
        ...
        let content = args["content"]
            .as_str()
            .ok_or_else(|| crate::types::ToolError::LlmRecoverable("qr_generate: content is required".to_string()))?;
        ...
        let code = QrCode::new(content.as_bytes())
            .map_err(|e| crate::types::ToolError::LlmRecoverable(format!("failed to generate QR code: {}", e)))?;
