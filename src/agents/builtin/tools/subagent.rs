...
mod tests {
    ...
    async fn test_subagent_worktree_mode() {
        ...
        assert!(msg.contains("[Subagent (Worktree"), "Message should contain success notification");
        assert!(msg.contains("Completed task"), "Message should contain the agent output");
    }
