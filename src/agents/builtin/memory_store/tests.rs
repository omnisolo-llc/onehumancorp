...
use crate::memory_store::core::OHCMemory;
use crate::memory_store::persistent::LongTermMemory;
use ohc_builtin_agent_tools::anthropic_memory::MemoryAccessor;
use crate::memory_store::anthropic_3_tier::Anthropic3TierMemoryStore;
use sqlx::Row;
use chrono::Utc;
mod tests {
    use super::*;
    ...
    fn test_embedding_record_serialization() {
        ...
        let deserialized: crate::memory_store::EmbeddingRecord = serde_json::from_str(&json).unwrap();
    ...
    async fn test_file_based_memory() {
        ...
        let mem = crate::memory_store::FileBasedMemory::new(dir);
    ...
    async fn test_anthropic_3_tier_memory_store() {
        ...
        let topic_content = crate::memory_store::persistent::LongTermMemory::retrieve_topic(&store, "system_architecture").await.unwrap();
        assert_eq!(topic_content, "Detailed DB schema");
        assert!(crate::memory_store::persistent::LongTermMemory::retrieve_topic(&store, "nonexistent").await.is_err());
        ...
        let res = crate::memory_store::persistent::LongTermMemory::search_transcripts(&store, "3-tier is better", 10).await.unwrap();
        assert_eq!(res.len(), 1);
...
pub mod get_conflicts_tests {
    ...
    async fn test_auto_resolve_conflicts_with_override_new() {
        ...
        let repo = crate::memory_store::VectorRepository::new_sqlite(pool.clone());
        let now = chrono::Utc::now();
        let r1 = crate::memory_store::EmbeddingRecord {
            id: "rec1".to_string(),
            tenant_id: "org1".to_string(),
            agent_id: "agent1".to_string(),
            content: "hello world".to_string(),
        ...
        let r2 = crate::memory_store::EmbeddingRecord {
            id: "rec2".to_string(),
            tenant_id: "org1".to_string(),
            agent_id: "agent1".to_string(),
    ...
    async fn test_resolve_conflict_logic() {
        ...
        let winner = crate::memory_store::EmbeddingRecord {
            id: "winner".to_string(),
            tenant_id: "org1".to_string(),
            agent_id: "agent1".to_string(),
        ...
        let loser = crate::memory_store::EmbeddingRecord {
            id: "loser".to_string(),
            tenant_id: "org1".to_string(),
    ...
    async fn test_auto_resolve_conflicts() {
        ...
        let r3 = crate::memory_store::EmbeddingRecord {
            id: "rec2_a".to_string(),
        ...
        let r4 = crate::memory_store::EmbeddingRecord {
            id: "rec2_b".to_string(),
            tenant_id: "org2".to_string(),
            agent_id: "agent1".to_string(),
        ...
        let r5 = crate::memory_store::EmbeddingRecord {
            id: "rec3_a".to_string(),
        ...
        let r6 = crate::memory_store::EmbeddingRecord {
            id: "rec3_b".to_string(),
            tenant_id: "org3".to_string(),
            agent_id: "agent1".to_string(),
    ...
    async fn test_prune_stale_sqlite() {
        ...
        let record3 = crate::memory_store::EmbeddingRecord {
            id: "rec3".to_string(),
            tenant_id: "org1".to_string(),
            agent_id: "agent1".to_string(),
        ...
        let record4 = crate::memory_store::EmbeddingRecord {
            id: "rec4".to_string(),
            tenant_id: "org1".to_string(),
            agent_id: "agent1".to_string(),
    ...
    async fn test_search_cross_department_explicit() {
        ...
        let record_dept_a = crate::memory_store::EmbeddingRecord {
        ...
        let record_dept_b = crate::memory_store::EmbeddingRecord {
        ...
        let record_other_tenant = crate::memory_store::EmbeddingRecord {
    ...
    async fn test_persistent_memory_store_retrieve_store() {
        ...
        let repo = Arc::new(crate::memory_store::VectorRepository::new_sqlite(pool));
        let llm = Arc::new(MockLlm);
        let store = crate::memory_store::PersistentMemoryStore {
            repo: repo.clone(),
...
mod anthropic_memory_tests {
    ...
    async fn test_cross_department_search() {
        ...
        let cs_record = crate::memory_store::EmbeddingRecord {
            id: "cs_1".to_string(),
            tenant_id: "org1".to_string(),
        ...
        let advisory_record = crate::memory_store::EmbeddingRecord {
    ...
    async fn test_prune_stale_retention() {
        ...
        let old_record = crate::memory_store::EmbeddingRecord {
        ...
        let new_record = crate::memory_store::EmbeddingRecord {
...
mod determine_conflict_winner_tests {
    ...
    ) -> crate::memory_store::EmbeddingRecord {
        crate::memory_store::EmbeddingRecord {
            id: id.to_string(),
            tenant_id: "org1".to_string(),
            agent_id: "agent1".to_string(),
    ...
    fn test_winner_owner_override() {
        ...
        let (winner, loser) = crate::memory_store::VectorRepository::determine_conflict_winner(&a, &b);
        assert_eq!(winner.id, "a");
        assert_eq!(loser.id, "b");

        let (winner2, loser2) = crate::memory_store::VectorRepository::determine_conflict_winner(&b, &a);
...
mod e2e_consolidation_tests {
    ...
    async fn setup_sqlite_repo() -> crate::memory_store::VectorRepository {
        let conn_opts = sqlx::sqlite::SqliteConnectOptions::from_str("sqlite::memory:").unwrap();
        ...
        crate::memory_store::VectorRepository::new_sqlite(pool)
    }
    ...
    async fn test_e2e_conflict_resolution() {
        ...
        let record_a = crate::memory_store::EmbeddingRecord {
        ...
        let record_b = crate::memory_store::EmbeddingRecord {
    ...
    async fn test_e2e_tenant_isolation_comprehensive() {
        ...
        let record_maya = crate::memory_store::EmbeddingRecord {
            id: "maya_1".to_string(),
            tenant_id: "org_maya".to_string(),
            agent_id: "sales".to_string(),
        ...
        let record_bob = crate::memory_store::EmbeddingRecord {
            id: "bob_1".to_string(),
    ...
    async fn test_e2e_stale_context_pruning() {
        ...
        let prune_me = crate::memory_store::EmbeddingRecord {
        ...
        let keep_override = crate::memory_store::EmbeddingRecord {
            id: "keep_1".to_string(),
            tenant_id: "org_maya".to_string(),
            agent_id: "test".to_string(),
        ...
        // Newer -> Keep
        let keep_new = crate::memory_store::EmbeddingRecord {
            id: "keep_2".to_string(),
            tenant_id: "org_maya".to_string(),
            agent_id: "test".to_string(),
