...
- Location: src/e2e/onboarding.spec.ts:47:7
...
```ts
  ...
  31  |
  32  |
  33  |     await expect(page.getByText("Review Details")).toBeVisible({ timeout: 15000 });
  ...
  51  |     await expect(page.getByText("10-Minute Setup Wizard")).toBeVisible();
  ...
  65  |
  66  |
> 67  |     await expect(page.getByText("Review Details")).toBeVisible({ timeout: 15000 });
      |                                                    ^ Error: expect(locator).toBeVisible() failed
  ...
  85  |     await expect(page.getByText("10-Minute Setup Wizard")).toBeVisible();
  ...
  99  |
  100 |     await expect(page.locator('input').nth(1)).toBeVisible({ timeout: 15000 });
