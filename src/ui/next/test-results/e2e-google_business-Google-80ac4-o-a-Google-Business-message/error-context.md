...
- Name: e2e/google_business.spec.ts >> Google Business Profile Integration Flow >> 3. Edit and send a reply to a Google Business message
- Location: e2e/google_business.spec.ts:45:7
...
Expected substring: "Hi there! Yes, we are open on Sundays"
Received string:    "< BackCustomer InboxAudit Dashboard📘Facebook User10:00 AMDo you have vegan birthday cake options?AI Draft\"Yes, we have several vegan birthday cake options available! You can order them directly from our website or let me know what flavors you are interested in.\"SendEdit📸Instagram UserYesterdayWhen will my order be shipped?AI Draft\"Your order is currently being prepared and will be shipped within 24 hours. You will receive a tracking link shortly.\"SendEdit💬WhatsApp UserYesterdayCan I change my delivery address?MeJust nowCertainly! Please provide your new delivery address, and we will update your order right away.✨ AI DraftSend✨Ask anything"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('body')
    14 × locator resolved to <body>…</body>
       - unexpected value "< BackCustomer InboxAudit Dashboard📘Facebook User10:00 AMDo you have vegan birthday cake options?AI Draft"Yes, we have several vegan birthday cake options available! You can order them directly from our website or let me know what flavors you are interested in."SendEdit📸Instagram UserYesterdayWhen will my order be shipped?AI Draft"Your order is currently being prepared and will be shipped within 24 hours. You will receive a tracking link shortly."SendEdit💬WhatsApp UserYesterdayCan I change my delivery address?MeJust nowCertainly! Please provide your new delivery address, and we will update your order right away.✨ AI DraftSend✨Ask anything"
