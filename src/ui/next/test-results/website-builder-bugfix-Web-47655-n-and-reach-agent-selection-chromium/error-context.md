...
- Name: website-builder-bugfix.spec.ts >> Website Builder Tool (E2E Validation) >> can skip product addition and reach agent selection
- Location: src/e2e/website-builder-bugfix.spec.ts:61:9
...
Locator: getByPlaceholder('e.g., Coffee Shop, Marketing Agency, Bakery')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 60000ms
  - waiting for getByPlaceholder('e.g., Coffee Shop, Marketing Agency, Bakery')
