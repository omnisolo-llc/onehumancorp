...
- Name: help.spec.ts >> Help Center >> renders help center and navigates to an article
- Location: src/e2e/help.spec.ts:4:9
...
Locator: locator('h2').filter({ hasText: 'Getting Started' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2').filter({ hasText: 'Getting Started' })

```

```yaml
- heading "Help Center" [level=1]
- textbox "Search for help articles and videos..."
- img
- paragraph: No results found matching ""
- paragraph: Try adjusting your search terms or ask our AI assistant for help.
- button "Help":
  - img
