...
- Name: branding-loop.spec.ts >> Branding Growth Loop >> Website Builder also shows Powered by OHC footer
- Location: src/e2e/branding-loop.spec.ts:15:9
...
- link "Powered by OHC":
  - /url: /onboarding?ref=website-builder
- button "Help":
  - img
