...
- Name: e2e/google_business.spec.ts >> Google Business Profile Integration Flow >> 2. Verify Google Business messages appear in the Customer Inbox with AI drafts
- Location: e2e/google_business.spec.ts:29:7
...
Locator: locator('div:has-text("Google Search User")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div:has-text("Google Search User")').first()
...
- link "< Back":
  - /url: /dashboard
- heading "Customer Inbox" [level=1]
- link "Agent Audit Dashboard":
  - /url: /agent-audit-dashboard
  - text: Audit Dashboard
- text: 📘 Facebook User 10:00 AM
- paragraph: Do you have vegan birthday cake options?
- img
- text: AI Draft
- paragraph: "\"Yes, we have several vegan birthday cake options available! You can order them directly from our website or let me know what flavors you are interested in.\""
- button "Send":
  - img
  - text: Send
- button "Edit":
  - img
  - text: Edit
- text: 📸 Instagram User Yesterday
- paragraph: When will my order be shipped?
- img
- text: AI Draft
- paragraph: "\"Your order is currently being prepared and will be shipped within 24 hours. You will receive a tracking link shortly.\""
- button "Send":
  - img
  - text: Send
- button "Edit":
  - img
  - text: Edit
- text: 💬 WhatsApp User Yesterday
- paragraph: Can I change my delivery address?
- img
- text: AI Draft
- paragraph: "\"Certainly! Please provide your new delivery address, and we will update your order right away.\""
- button "Send":
  - img
  - text: Send
- button "Edit":
