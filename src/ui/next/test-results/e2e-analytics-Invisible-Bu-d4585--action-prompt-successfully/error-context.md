...
- Name: e2e/analytics.spec.ts >> Invisible Business Analytics and Growth Engine >> should trigger the proactive action prompt successfully
- Location: e2e/analytics.spec.ts:93:7
