...
- Name: help.spec.ts >> Help Center >> should open help chat and send a message
- Location: src/e2e/help.spec.ts:57:9
...
Call log:
  - waiting for locator('button[aria-label="Open help chat"]')
    - locator resolved to <button aria-label="Open help chat" class="bg-blue-600/95 text-white p-4 rounded-full shadow-2xl hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-2 group backdrop-blur-[20px] saturate-200">…</button>
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - textbox "Search for help articles and videos..." [ref=e6]
    - generic [ref=e7]:
      - img [ref=e8]
      - paragraph [ref=e10]:
