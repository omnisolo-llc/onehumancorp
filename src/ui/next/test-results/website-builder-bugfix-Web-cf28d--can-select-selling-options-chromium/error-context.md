...
- Name: website-builder-bugfix.spec.ts >> Website Builder Tool (E2E Validation) >> can select selling options
- Location: src/e2e/website-builder-bugfix.spec.ts:43:9
