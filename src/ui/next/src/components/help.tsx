            ...
            {tab === "center" && (
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <button onClick={() => { setOpen(false); startWalkthrough([{ targetId: "generate-btn-tooltip", title: "Activate your AI Support Agent", content: "Activate your AI agent." }])}} className="w-full text-left bg-blue-50/80 backdrop-blur-[20px] saturate-200 p-4 rounded-2xl shadow-sm border border-blue-100 hover:bg-blue-100/90 hover:shadow-md transition-all min-h-[44px]">
