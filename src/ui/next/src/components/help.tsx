            ...
            {tab === "center" && (
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <button onClick={() => startWalkthrough([{ targetId: "nav-setup", message: "Go to Setup to configure your business." }, { targetId: "billing-setup-card", message: "Click here to connect Stripe or MercadoPago and start accepting payments." }])} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
                    <span className="font-bold text-blue-800 text-sm block">Tour: Accept your first payment</span>
                  </button>
                  <button onClick={() => startWalkthrough([{ targetId: "nav-agents", message: "Open your AI Agents dashboard." }, { targetId: "hire-agent-btn", message: "Click here to add the AI Support Agent to your team." }, { targetId: "agent-status-toggle", message: "Turn them on to start automatically replying to customers!" }])} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
