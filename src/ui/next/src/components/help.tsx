            ...
            {tab === "center" && (
              <div>
                ...
                <div className="space-y-2">
                  <button onClick={() => startWalkthrough([{ targetId: "setup-store-target", message: "Enter your business description and customize your brand." }])} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
                    <span className="font-bold text-blue-800 text-sm block">Tour: Set up your store</span>
                  </button>
                  <button onClick={() => startWalkthrough([{ targetId: "first-payment-target", message: "Click here to connect Stripe and start accepting payments securely." }])} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
                    <span className="font-bold text-blue-800 text-sm block">Tour: Accept your first payment</span>
                  </button>
                  <button onClick={() => startWalkthrough([{ targetId: "ai-agent-target", message: "Activate your AI agent to let it handle customer questions." }])} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
