            ...
            {tab === "center" && (
              <div>
                ...
                <div className="space-y-2">
                  <button onClick={() => { setOpen(false); router.push("/builder?walkthrough=setup-store"); }} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
                    <span className="font-bold text-blue-800 text-sm block">Tour: Set up your store</span>
                  </button>
                  <button onClick={() => { setOpen(false); router.push("/dashboard?walkthrough=payment"); }} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
                    <span className="font-bold text-blue-800 text-sm block">Tour: Accept your first payment</span>
                  </button>
                  <button onClick={() => { setOpen(false); router.push("/team?walkthrough=activate-agent"); }} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
