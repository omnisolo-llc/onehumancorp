            ...
            {tab === "center" && (
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <button onClick={() => startWalkthrough([{ targetId: "activate-agent-btn", message: "Activate your AI agent." }])} className="w-full text-left bg-blue-50 p-3 rounded-xl shadow-sm border border-blue-100 hover:bg-blue-100 transition-colors">
