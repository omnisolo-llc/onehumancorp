            ...
            {tab === "center" && (
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <button onClick={() => { setOpen(false); startWalkthrough([{ targetId: "bio-input-tooltip", title: "Payment", content: "Click here to accept payment." }])}} className="w-full text-left bg-blue-50/80 backdrop-blur-[20px] saturate-200 p-4 rounded-2xl shadow-sm border border-blue-100 hover:bg-blue-100/90 hover:shadow-md transition-all min-h-[44px]">
                    <span className="font-bold font-outfit text-blue-800 text-base block">Tour: Accept your first payment</span>
                  </button>
                  <button onClick={() => { setOpen(false); startWalkthrough([{ targetId: "generate-btn-tooltip", title: "Activate", content: "Activate your AI agent." }])}} className="w-full text-left bg-blue-50/80 backdrop-blur-[20px] saturate-200 p-4 rounded-2xl shadow-sm border border-blue-100 hover:bg-blue-100/90 hover:shadow-md transition-all min-h-[44px]">
                    <span className="font-bold font-outfit text-blue-800 text-base block">Tour: Activate your AI Support Agent</span>
                  </button>
                  <button onClick={() => { setOpen(false); startWalkthrough([{ targetId: "help-widget-container", title: "Meeting Room", content: "Agents join the Virtual Meeting Room to debate and plan before executing tasks." }, { targetId: "help-widget-container", title: "Meeting Protocol", content: "Phase 1: Brainstorming. Phase 2: Refinement. Phase 3: Consensus (UltraPlan protocol)." }])}} className="w-full text-left bg-blue-50/80 backdrop-blur-[20px] saturate-200 p-4 rounded-2xl shadow-sm border border-blue-100 hover:bg-blue-100/90 hover:shadow-md transition-all min-h-[44px]">
