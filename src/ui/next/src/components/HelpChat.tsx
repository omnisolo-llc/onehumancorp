...
export function HelpChat() {
  ...
  return (
    <div className="help-chat-wrapper pointer-events-none">
      ...
      {/* Chat Interface */}
      {isOpen && (
        <div id="ai-chat-interface" role="dialog" aria-labelledby="ai-chat-header-title" aria-modal="false" className="fixed bottom-24 right-6 z-[10000] w-full max-w-[350px] pointer-events-auto glass-panel rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.08)] flex flex-col overflow-hidden animate-slide-up-chat text-gray-900 dark:text-gray-100">
          {/* Header */}
          <div
            id="ai-chat-header"
