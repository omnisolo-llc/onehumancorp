            ...
            <button
              onClick={() => {
                if (window.confirm("Clear conversation?")) {
                  setMessages([{ id: nextMessageId("agent"), sender: "agent", text: "How can I help you today?" }]);
                }
              }}
              className="text-blue-100 hover:text-white transition-colors bg-white/10 hover:bg-white/20 rounded-full p-1.5 min-h-[44px] mr-2"
