...
export function HelpChat() {
  ...
  return (
    <div className="help-chat-wrapper pointer-events-none">
      ...
      {/* Chat Interface */}
      {isOpen && (
        <div id="ai-chat-interface" role="dialog" aria-labelledby="ai-chat-header-title" aria-modal="false" className="fixed bottom-24 right-6 z-[10000] w-full max-w-[350px] pointer-events-auto bg-white/50 dark:bg-[#16161a]/50 backdrop-blur-xl saturate-[210%] border border-white/20 dark:border-white/10 shadow-xl rounded-[24px] flex flex-col overflow-hidden animate-slide-up-chat text-gray-900 dark:text-gray-100">
          {/* Header */}
          <div
            id="ai-chat-header"
