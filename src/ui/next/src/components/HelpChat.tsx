...
export function HelpChat() {
  ...
  return (
    <div className="help-chat-wrapper pointer-events-none">
      ...
      {/* Chat Interface */}
      {isOpen && (
        <div id="ai-chat-interface" role="dialog" aria-labelledby="ai-chat-header-title" aria-modal="false" className="fixed bottom-24 right-6 z-[9999] w-full max-w-[350px] pointer-events-auto backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border border-white/40 rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.08)] flex flex-col overflow-hidden animate-slide-up-chat text-gray-900 dark:text-gray-100">
          {/* Header */}
          <div
            id="ai-chat-header"
          ...
          <form
            onSubmit={handleSend}
            className="p-3 backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border-t border-white/40 flex gap-2 items-center"
          >
            <input
              ...
              disabled={isLoading}
              className="flex-1 backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border border-white/40 rounded-[24px] px-4 py-3 text-base min-h-[44px] focus:outline-none focus:ring-2 focus:ring-blue-500/50 font-inter shadow-inner disabled:opacity-70 disabled:bg-gray-100/70"
            />
            <button
              type="submit"
