...
export const DEFAULT_TOOLTIPS: Record<string, string> = {
  ...
  "assistant-nav-tooltip": "Talk to your AI Assistant to get things done.",
  "onboarding-nav-tooltip": "Set up your workspace and integrations.",
  "triage-nav-tooltip": "Review incoming requests and items needing your attention.",
  "inbox-nav-tooltip": "Keep track of recent customer messages.",
  "agents-nav-tooltip": "Manage your AI workforce.",
  "business_analytics-nav-tooltip": "View detailed business reports.",
  "dashboardcampaigns-nav-tooltip": "Manage marketing campaigns.",
  "lead_magnet_generator-nav-tooltip": "Generate lead magnets.",
  "settings-nav-tooltip": "Configure your account settings.",
  "ai_usage_paywall-nav-tooltip": "View your AI usage and limits.",
  "calendar-nav-tooltip": "Manage your schedule.",
  "langgraph-nav-tooltip": "View AI workflows.",
  "visual_workflow-nav-tooltip": "Build and manage visual workflows.",
  "agent_protocol-nav-tooltip": "Configure agent protocols.",
  "integrations-nav-tooltip": "Connect external tools.",
  "cost_dashboard-nav-tooltip": "Monitor your spending.",
  "diagnostics-nav-tooltip": "System diagnostics.",
};
