  ...
  return (
    <TooltipContext.Provider value={{ activeTooltip, setActiveTooltip, tooltipRect, setTooltipRect, tooltipText, setTooltipText, getTooltip: (id: string) => tooltips[id] }}>
      ...
      {activeTooltip && tooltipRect && (
        <div
          className="fixed z-[100] bg-white/70 text-[#1D1D1F] text-sm font-inter p-3 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] pointer-events-none w-64 max-w-[calc(100vw-32px)] mx-4 text-center leading-relaxed backdrop-blur-[30px] saturate-[210%] border border-white/30 animate-fade-in-up"
          style={{
