  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-lg glassmorphism shadow-sm hover:bg-white/80 transition-all text-sm font-medium"
      >
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute top-full mt-2 right-0 w-48 rounded-2xl glassmorphism shadow-2xl z-50 p-2 animate-in fade-in zoom-in duration-200">
            <div className="mb-2">
