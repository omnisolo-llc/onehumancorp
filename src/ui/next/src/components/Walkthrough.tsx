  ...
  return (
    <>
      ...
      <div
        ...
        className="ohc-walkthrough-bubble fixed z-[10000] bg-white/80 dark:bg-black/50 backdrop-blur-xl saturate-[210%] border border-white/50 dark:border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.15)] p-6 w-[300px] max-w-[calc(100vw-32px)] font-inter animate-pop-in"
        style={bubbleStyle}
      >
        {targetRect && (
