  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed z-[1000] bg-white/70 backdrop-blur-[30px] saturate-200 border border-white/60 rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.12)] p-6 w-[300px] font-inter animate-pop-in"
        style={bubbleStyle}
      >
        {targetRect && (
