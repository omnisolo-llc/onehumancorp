  ...
  return (
    <>
      ...
      <div
        ...
        className="ohc-walkthrough-bubble fixed z-[10000] backdrop-blur-3xl saturate-[210%] bg-white/70 dark:bg-black/60 border border-white/40 dark:border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.5)] p-6 w-[300px] max-w-[calc(100vw-32px)] font-inter animate-pop-in"
        style={bubbleStyle}
      >
        {targetRect && (
        ...
        <div className="flex justify-between items-start mb-3">
          ...
          <button onClick={handleSkip} id="wt-close" className="wt-close text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 bg-black/10 hover:bg-black/20 dark:bg-white/10 dark:hover:bg-white/20 backdrop-blur-3xl saturate-[210%] rounded-full p-1.5 transition-all flex-shrink-0">
        ...
        <div className="flex justify-between items-center pt-3 border-t border-gray-200/50 dark:border-gray-700/50">
          ...
          <button
            id="wt-next"
            onClick={handleNext}
            className="bg-blue-600/90 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-lg backdrop-blur-3xl saturate-[210%] active:scale-95 transition-all"
          >
