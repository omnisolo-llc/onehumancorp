      ...
      >
        ...
        {accepted ? (
          <div className="p-8 flex flex-col items-center justify-center text-center space-y-4">
            <div className="text-4xl text-[#34C759]">✅</div>
            <h3 className="text-xl font-bold font-outfit text-[#1D1D1F] dark:text-[#F5F5F7]">Proposal Accepted</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Thank you! This quote has been approved.</p>
          </div>
        ) : (
          <>
