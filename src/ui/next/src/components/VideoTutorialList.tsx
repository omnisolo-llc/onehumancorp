  ...
  return (
    <div className="w-full max-w-4xl mx-auto py-8 px-4 font-inter">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {videos.map(video => (
          <div key={video.id} onClick={() => setActiveVideo(video)} className="app-card backdrop-blur-[20px] saturate-200 rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-all cursor-pointer flex flex-col">
