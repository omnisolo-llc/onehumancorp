...
export const ContextCard: React.FC<ContextCardProps> = ({ tenantId, customerId }) => {
  ...
  if (loading) {
    return (
      <div className="w-full h-11 min-h-[44px] backdrop-blur-[30px] backdrop-saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border border-white/40 dark:border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.04)] rounded-lg flex items-center justify-center animate-pulse">
  ...
  return (
    <div className="w-full p-3 backdrop-blur-[30px] backdrop-saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border border-white/40 dark:border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.04)] rounded-xl mb-4 transition-all duration-300">
