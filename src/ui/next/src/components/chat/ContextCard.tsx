...
export const ContextCard: React.FC<ContextCardProps> = ({ tenantId, customerId }) => {
  ...
  if (loading) {
    return (
      <div className="w-full h-11 min-h-[44px] bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] saturate-[210%] border border-white/40 dark:border-white/10 rounded-lg flex items-center justify-center animate-pulse">
  ...
  return (
    <div className="w-full min-h-[44px] p-3 bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] saturate-[210%] border border-white/40 dark:border-white/10 shadow-sm rounded-xl mb-4 transition-all duration-300">
