...
describe("authentication runtime configuration", () => {
  ...
  it.each([
    ...
    [{ ...production, OHC_WEB_LOCAL_DEV: "true", OHC_WEB_CANONICAL_ORIGIN: "http://8.8.8.8:3000" }, "local development canonical origin must be loopback or a private LAN IP"],
    [{ ...production, OHC_WEB_LOCAL_DEV: "true", OHC_WEB_CANONICAL_ORIGIN: "http://devbox.local:3000" }, "local development canonical origin must be loopback or a private LAN IP"],
