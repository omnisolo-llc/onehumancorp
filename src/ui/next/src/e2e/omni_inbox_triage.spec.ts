...
test.describe('Omni Inbox Agentic Triage', () => {
  test('displays unread leads summary and allows inventory deduction approval', async ({ page }) => {
    ...
    await page.evaluate((t) => { Storage.prototype.setItem.bind(window.localStorage)('tenant_id', t); Storage.prototype.setItem.bind(window.localStorage)('tenant', t); }, testTenant);
