...
test.describe('Viral Share Savings Widget Growth Loop', () => {
  test('should display the widget on cost-dashboard and handle the trial extension loop', async ({ page, request, loginAs, adminUser }) => {
    ...
    const widgetHeading = page.getByRole('heading', { name: /Share your success to unlock a 7-Day Pro trial extension!/i });
