...
test.describe('In-App Video Tutorials', () => {
    test('renders videos tab, fetches videos, and opens/closes the modal player', async ({ page }) => {
        ...
        // The videos are rendered with titles, like 'Set up your store'
        const firstVideoTitle = page.locator('p', { hasText: 'Set up your store' });
        ...
        await expect(modalContainer.locator('h3', { hasText: 'Set up your store' })).toBeVisible();
