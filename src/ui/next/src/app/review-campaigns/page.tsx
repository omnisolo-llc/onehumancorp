            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-[8px] focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white"
                >
              ...
              <button
                ...
                className={`w-full py-3 mt-4 text-white font-semibold rounded-[16px] shadow-lg transition-all flex items-center justify-center gap-2 ${isGenerating ? 'bg-indigo-400 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0'}`}
              >
                {isGenerating ? (
                  <>
          ...
          <section className="w-full md:w-1/2 p-6 shadow-md flex flex-col" style={{ background: '#ffffff', border: '1px solid rgba(0, 0, 0, 0.05)', borderRadius: '16px' }}>
            ...
            {generatedDraft ? (
              <div className="flex-1 flex flex-col">
                <div className="flex-1 bg-gray-50 border border-gray-100 rounded-[16px] p-4 mb-4">
                ...
                {isSent ? (
                  <div className="w-full py-3 bg-green-50 text-green-700 font-bold rounded-[16px] text-center border border-green-200">
                    ✅ Campaign sent to {customerSegment === 'recent' ? '48' : customerSegment === 'loyal' ? '12' : '156'} customers!
                  </div>
                ) : (
                  <button
                    onClick={handleSend}
                    className="w-full py-3 bg-gray-900 hover:bg-black text-white font-bold rounded-[16px] shadow-md transition-all flex items-center justify-center gap-2"
                  >
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-gray-400 border-2 border-dashed border-gray-200 rounded-[16px] p-6 text-center">
