          ...
          {activeTab === 'departments' ? (
            <div className="space-y-4">
              {departments.map((dept) => (
                <button
                  key={dept.id}
                  className="w-full text-left bg-white/70 backdrop-blur-[30px] saturate-[210%] border border-white/50 shadow-sm p-4 rounded-[16px] flex items-start gap-4 cursor-pointer hover:shadow-md transition-shadow" aria-label={dept.name}
                >
