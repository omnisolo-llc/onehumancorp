            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(inviteMessage);
                    // Mobile intent fallbacks or just copy
                    alert("Link copied! Open Instagram to paste in your bio or story.");
                  }}
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white p-3 rounded-xl font-semibold text-sm shadow-sm hover:from-purple-600 hover:to-pink-600 transition-all"
                >
