  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-inter">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-4 md:p-8 mt-16 md:mt-0">
        ...
        <div className="app-card glass-card rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 mb-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="app-card glass-card rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
