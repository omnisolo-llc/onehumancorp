            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-pink-600 text-white p-3 rounded-xl font-semibold text-sm shadow-sm hover:bg-pink-700 transition-all"
                >
                  ...
                  {copiedInsta ? 'Copied! Paste in Bio' : 'Share to Instagram'}
                </button>
              </div>
            </div>
          </div>
