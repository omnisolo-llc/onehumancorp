      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-4 md:p-8 mt-16 md:mt-0">
          ...
          <div className="max-w-2xl">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1 bg-gray-50 border border-gray-200 rounded-[16px] px-4 py-3 flex items-center">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-[16px] text-sm font-bold transition-all sm:w-auto w-full ${copied ? 'bg-green-100 text-green-700' : 'bg-gray-900 text-white hover:bg-black'}`}
                >
                  {copied ? 'Copied!' : 'Copy'}
                </button>
              </div>
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-indigo-50 text-indigo-700 p-4 rounded-[16px] font-semibold text-sm hover:bg-indigo-100 transition-colors"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-[#25D366] text-white p-4 rounded-[16px] font-semibold text-sm hover:bg-[#20bd5a] transition-colors"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                ...
                <div className="bg-gray-900 text-gray-300 p-4 rounded-[16px] font-mono text-xs overflow-x-auto mb-4">
                    <pre id="embed-code">
{`<iframe src="https://mybusiness.ohc.store/api/v1/growth/storefront/embed"
  width="100%"
  height="600"
  frameborder="0"
  style="border-radius: 16px; border: 1px solid #eaeaea;">
</iframe>`}
                    </pre>
                </div>
                <button
                  className="w-full bg-gray-100 text-gray-800 font-bold py-3 rounded-[16px] text-sm hover:bg-gray-200 transition-colors"
                  onClick={() => {
                      navigator.clipboard.writeText(`<iframe src="https://mybusiness.ohc.store/api/v1/growth/storefront/embed" width="100%" height="600" frameborder="0" style="border-radius: 16px; border: 1px solid #eaeaea;"></iframe>`);
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
               ...
               <div className="space-y-3">
                   <button className="w-full bg-white border border-gray-200 text-gray-800 font-bold py-3 rounded-[16px] text-sm hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
