    ...
    <AppShell title="Agent Activity">
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
        ...
        <section className="space-y-4">
            <div className="macos-translucent-glass rounded-[16px] p-6 border border-white/40 dark:border-white/10 shadow-sm">
                ...
                <div className="flex flex-col gap-4">
                    {loading ? (
                        ...
                        jobs.map((job) => (
                            <div key={job.id} className={`macos-translucent-glass rounded-[16px] p-4 border ${job.status === 'PROCESSING' ? 'border-blue-200 dark:border-blue-800' : 'border-white/40 dark:border-white/10'} shadow-md flex flex-col sm:flex-row gap-4 items-start sm:items-center relative overflow-hidden transition-shadow`}>
