  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-black text-[#1D1D1F] dark:text-[#F5F5F7] p-4 font-inter">
      <div className="max-w-[375px] mx-auto w-full">
        ...
        {loading ? (
          <div className="glassmorphism rounded-2xl p-6 shadow-sm flex items-center justify-center min-h-[150px]">
            <p className="text-sm text-gray-500">Loading your report...</p>
          </div>
        ) : !reports || reports.length === 0 ? (
          <div className="glassmorphism rounded-2xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            {reports.map((report) => (
              <div key={report.id} className="glassmorphism rounded-2xl p-6 shadow-sm">
