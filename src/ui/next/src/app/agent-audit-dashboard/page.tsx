    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 p-8 font-inter">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <section className="bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg rounded-[16px] p-6">
        ...
        <div className="md:col-span-1">
          <section className="bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg rounded-[16px] p-6 h-full">
