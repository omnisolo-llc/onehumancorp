            ...
            <div className="p-6" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 255, 255, 0.4)', boxShadow: '0 4px 24px rgba(0,0,0,0.04)' }}>
                ...
                <div className="mb-6">
                    ...
                    <input
                        ...
                        placeholder="e.g. 50"
                    />
                    <p className="text-xs text-gray-500 mt-2">Required upfront deposit (e.g. 50 or 50%).</p>
                </div>
                ...
                <div className="mb-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        />
                        <span className="text-sm font-medium text-gray-700">Need Travel Time? (AI Dynamic Buffer)</span>
                    </label>
                </div>
