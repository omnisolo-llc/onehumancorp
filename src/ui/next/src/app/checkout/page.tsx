    ...
    <div className="flex flex-col min-h-screen font-inter" style={{ backgroundColor: '#F5F5F7' }}>
      ...
      <main id="checkout-screen" className="p-6 md:p-8 flex-1 max-w-lg mx-auto w-full flex flex-col gap-6">
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
          <div className="px-4 py-2 bg-white/60 backdrop-blur-xl border border-white/40 shadow-lg rounded-full text-xs font-semibold text-gray-800 flex items-center gap-2">
