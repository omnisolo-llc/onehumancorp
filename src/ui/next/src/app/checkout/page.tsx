  ...
  return (
    ...
    >
      ...
      >
        {tier ? (
          <div
            className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-6"
            style={{
              background: "rgba(255, 255, 255, 0.65)",
              backdropFilter: "blur(30px) saturate(210%)",
              borderRadius: "16px",
          ...
          >
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900">OHC {tier} Plan</h3>
            ...
            >
              <button
                ...
                className={
                  "w-full px-4 py-3 text-white rounded-lg font-medium transition-colors shadow-sm " +
                  (isProcessing
