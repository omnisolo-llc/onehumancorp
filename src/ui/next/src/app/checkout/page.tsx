      ...
      <main id="checkout-screen" className="p-6 md:p-8 flex-1 max-w-lg mx-auto w-full flex flex-col gap-6">
        ...
        <div className="p-6 shadow-sm flex flex-col gap-4" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 255, 255, 0.4)', borderRadius: '16px' }}>
          ...
          <button
            ...
            className={`w-full px-4 py-3 bg-black text-white rounded-lg font-medium transition-colors shadow-sm flex items-center justify-center gap-2 hover:bg-gray-800 ${isProcessing ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
          ...
          <button
            onClick={handlePayment}
            disabled={isProcessing}
            className={`w-full px-4 py-3 bg-white text-gray-800 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors shadow-sm flex items-center justify-center gap-2 ${isProcessing ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
            {isProcessing ? 'Processing...' : <>
          ...
          <button
            ...
            className="w-full px-4 py-3 bg-gray-200 text-gray-800 rounded-lg font-medium hover:bg-gray-300 transition-colors mt-2"
          >
            Cancel
          </button>
        </div>
