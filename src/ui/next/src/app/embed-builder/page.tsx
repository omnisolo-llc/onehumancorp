            ...
            <div className="max-w-6xl mx-auto p-4 md:p-8 font-inter">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-1/3 flex flex-col gap-6">
                        <div className="macos-translucent-glass p-6 rounded-[24px] border border-gray-200 shadow-xl bg-white/80">
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col">
                        <div className="flex-1 macos-translucent-glass rounded-[24px] border border-gray-200 shadow-xl bg-white/80 overflow-hidden flex flex-col relative min-h-[600px]">
