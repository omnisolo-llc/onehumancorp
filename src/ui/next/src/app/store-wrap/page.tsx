    ...
    <div className="flex flex-col min-h-screen font-inter bg-[#1D1D1F] text-white overflow-hidden relative">
      ...
      <header className="px-6 py-4 flex items-center justify-between z-50 absolute w-full top-0">
        ...
        <button
          ...
          className="px-4 py-2 bg-white/10 hover:bg-white/20 backdrop-blur-[20px] saturate-200 border border-white/10 rounded-full text-sm font-medium transition-colors border border-white/10"
        >
          Close
        </button>
      </header>
      ...
      <main className="flex-1 w-full h-screen relative flex items-center justify-center">
        {slides.map((slide, i) => (
          ...
          >
            <div className="max-w-md w-full flex flex-col items-center text-center backdrop-blur-[20px] saturate-200 bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
                ...
                <div className="mt-12 w-full space-y-4 animate-fade-in">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <a
                      ...
                      className="flex items-center justify-center gap-2 bg-black/50 backdrop-blur-[20px] saturate-200 border border-white/10 text-white p-4 rounded-2xl font-bold shadow-lg hover:bg-black transition-all hover:scale-105 active:scale-95"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 bg-[#25D366]/50 backdrop-blur-[20px] saturate-200 border border-white/10 text-white p-4 rounded-2xl font-bold shadow-lg hover:bg-[#25D366] transition-all hover:scale-105 active:scale-95"
                    >
