          ...
          <div className="px-6 space-y-4">
            {phone && (
              <a href={`tel:${phone.replace(/[^\d+]/g, '')}`} className="bg-gray-50 hover:bg-gray-100 p-4 rounded-2xl border border-gray-100 flex items-center gap-4 transition-colors group">
                <div className="w-12 h-12 rounded-full bg-white shadow-sm flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform" style={{ color: themeColor }}>
                  📱
                </div>
