    ...
    >
      <div className="flex-1 max-w-6xl mx-auto w-full flex flex-col gap-8 font-inter">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="app-card glass-card glassmorphism p-5 rounded-2xl shadow-sm border border-white/40 dark:border-white/10 flex flex-col justify-between">
        ...
        <section className="relative">
           ...
           <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-500 ${!hasPro ? 'filter blur-md select-none pointer-events-none opacity-50' : ''}`}>
               <div className="app-card glass-card glassmorphism p-6 rounded-2xl shadow-sm border border-white/40 dark:border-white/10 h-72 flex flex-col">
      ...
      {showSoftPaywall && (
        <div className="fixed inset-0 bg-black/60 z-[60] flex items-center justify-center p-4">
          <div className="app-card glass-card glassmorphism w-full max-w-md rounded-2xl p-8 shadow-2xl relative overflow-hidden font-inter border border-white/40 dark:border-white/10 text-center bg-white/90 dark:bg-zinc-900/90 backdrop-blur-[30px] saturate-[210%]">
