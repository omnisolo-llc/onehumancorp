        ...
        <div id="setup-screen" className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] overflow-hidden mac-glass-container">
          ...
          <div className="px-8 pb-8 pt-12 flex flex-col flex-1 justify-start overflow-y-auto">
            <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
              ...
              {wizardStep === 1 && (
                <>
                  <button onClick={() => setWizardStep(0)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
              ...
              {wizardStep === 2 && (
                <>
                  <button onClick={() => setWizardStep(1)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
              ...
              {wizardStep === 3 && (
                <>
                  <button onClick={() => setWizardStep(2)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
              ...
              {wizardStep === 4 && (
                <>
                  <button onClick={() => setWizardStep(3)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
              ...
              {wizardStep === 5 && (
                <>
                  <button onClick={() => setWizardStep(4)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
              ...
              {wizardStep === 6 && (
                <>
                  <button onClick={() => setWizardStep(5)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
              ...
              {wizardStep === 7 && (
                <>
                  <button onClick={() => setWizardStep(6)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
              ...
              {wizardStep === '7.5' && (
                <>
                  <button onClick={() => setWizardStep(7)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
                  <div className="flex flex-col gap-4 mt-6">
                    <button
              ...
              {wizardStep === 8 && (
                <>
                  <button onClick={() => setWizardStep('7.5')} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
              ...
              {wizardStep === '8.5' && (
                <>
                  <button onClick={() => setWizardStep(8)} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
                  <div className="flex flex-col gap-4 mt-6">
                    <button
              ...
              {wizardStep === 9 && (
                <>
                  <button onClick={() => setWizardStep('8.5')} className="self-start text-[#0066FF] text-sm font-semibold mb-4 flex items-center gap-1 hover:underline">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Back
                  </button>
