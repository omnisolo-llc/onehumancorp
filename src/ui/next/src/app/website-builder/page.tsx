...
export default function WebsiteBuilderPage() {
  ...
  const {
    ...
    setBusinessType,
    hasPhysicalProducts,
    setHasPhysicalProducts,
    hasDigitalProducts,
    setHasDigitalProducts,
    productName,
    setProductName,
    productPrice,
    setProductPrice,
      ...
      .then(([draftData, stateData]) => {
        ...
        if (
          ...
          if (
            ...
            if (data.wizardState.hasPhysicalProducts !== undefined)
              setHasPhysicalProducts(data.wizardState.hasPhysicalProducts);
            if (data.wizardState.hasDigitalProducts !== undefined)
              setHasDigitalProducts(data.wizardState.hasDigitalProducts);
            if (data.wizardState.productName !== undefined)
              setProductName(data.wizardState.productName);
            if (data.wizardState.productPrice !== undefined)
              setProductPrice(data.wizardState.productPrice);
            if (data.wizardState.paymentMethod !== undefined)
              setPaymentMethod(data.wizardState.paymentMethod);
            if (data.wizardState.userName !== undefined)
              setUserName(data.wizardState.userName);
            if (data.wizardState.userEmail !== undefined)
              setUserEmail(data.wizardState.userEmail);
            if (data.wizardState.userPassword !== undefined)
              setUserPassword(data.wizardState.userPassword);
            if (data.wizardState.template !== undefined)
              setTemplate(data.wizardState.template);
  ...
  const updateStatus = (
    newStatus: "idle" | "generating" | "draft" | "live",
  ) => {
    setStatus(newStatus);
  ...
  if (status === "idle") {
    ...
    return (
      <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div
          id="setup-screen"
          className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] overflow-hidden glassmorphism"
        >
          <div className="px-8 pb-8 pt-8 flex flex-col flex-1 justify-start overflow-y-auto relative">
            ...
            <div className="absolute top-6 right-8 flex items-center gap-4 z-10">
              {saveMessage && (
                <span className="text-[#34C759] text-sm font-semibold animate-fade-in">
                  {saveMessage}
                </span>
              )}
            ...
            <div
              className={`animate-fade-in ${wizardStep !== 0 ? "mt-10" : "mt-4"}`}
            ...
            >
              {wizardStep === 0 && (
                <>
                  ...
                  <h2 className="text-xl font-semibold font-outfit text-gray-800 dark:text-[#e5e5e7] mb-2">
                    Your business, live in minutes.
                  </h2>
                  <p className="text-gray-500 dark:text-[#a1a1a6] text-sm mb-8 leading-relaxed">
                    Zero tech skills needed. We do the heavy lifting. Review and
                    add any extra details to help our AI generate the perfect
                    store.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                    ...
                    <button
                      className="w-full min-h-[54px] glassmorphism text-[#0066FF] border border-[#0066FF] p-4 font-bold rounded-[16px] shadow-sm hover:bg-blue-50 transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                      onClick={() => {
                        setBio("");
                        setWizardStep("instant-build");
                      }}
                    >
                      Instant Build
                    </button>
              ...
              {wizardStep === 1 && (
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-6">
                    <button
                      className="w-full min-h-[54px] text-[#1D1D1F] dark:text-[#F5F5F7] glassmorphism p-4 font-bold rounded-[16px] shadow-sm hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-left"
                      onClick={() => {
              ...
              {wizardStep === 2 && (
                <>
                  ...
                  >
                    <input
                      type="text"
                      className="w-full min-h-[54px] glassmorphism p-4 focus:ring-2 focus:ring-[#0066FF] focus:border-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#F5F5F7] bg-white/60 dark:bg-black/60 shadow-inner border border-gray-300/50 dark:border-gray-600/50  rounded-[16px]"
                    ...
                    <button
                      ...
                      className="w-full min-h-[54px] bg-[#0066FF] text-white p-4 font-bold rounded-[16px] shadow-md hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              {wizardStep === 3 && (
                <>
                  ...
                  <div
                    ...
                    className="mt-6 flex flex-col sm:flex-row gap-4 sm:gap-6"
                  >
                    <label className="flex items-center gap-3 p-4 glassmorphism rounded-[16px] cursor-pointer hover:bg-white/60 dark:hover:bg-white/10 text-[#1D1D1F] dark:text-[#F5F5F7]">
                      <input
                        type="checkbox"
                        className="w-5 h-5 accent-[#0066FF]"
                        checked={hasPhysicalProducts}
                        onChange={(e) =>
                          setHasPhysicalProducts(e.target.checked)
                        }
                      />
                    ...
                    <label className="flex items-center gap-3 p-4 glassmorphism rounded-[16px] cursor-pointer hover:bg-white/60 dark:hover:bg-white/10 text-[#1D1D1F] dark:text-[#F5F5F7]">
                      <input
                        ...
                        onChange={(e) =>
                          setHasDigitalProducts(e.target.checked)
                        }
                      />
                      <span className="font-semibold text-gray-800">
                        Digital Products
                    ...
                    <button
                      className="w-full bg-[#0066FF] text-white p-4 font-bold rounded-[16px] shadow-md hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] mt-4"
              ...
              {wizardStep === 6 && (
                <>
                  ...
                  >
                    ...
                    {!userEmail.includes("@") && userEmail.length > 0 && (
                ...
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-6">
                    <textarea
                      value={bio}
                      onChange={(e) => setBio(e.target.value)}
                      className="w-full min-h-[54px] glassmorphism p-4 focus:ring-2 focus:ring-[#0066FF] focus:border-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] resize-none text-[#1D1D1F] dark:text-[#F5F5F7] bg-white/60 dark:bg-black/60 shadow-inner border border-gray-300/50 dark:border-gray-600/50  rounded-[16px]"
                      placeholder="e.g. I run a local bakery"
                      rows={4}
                    />
                    <button
                      className="w-full min-h-[54px] bg-[#0066FF] text-white p-4 font-bold rounded-[16px] shadow-md hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] disabled:opacity-50"
                      disabled={!bio.trim()}
                      onClick={async () => {
                        if (!bio.trim()) return;
                        setStatus("generating");
    ...
    return (
      <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] overflow-hidden text-center p-8 justify-center glassmorphism">
          ...
          <button
            className="w-full bg-[#0066FF] text-white font-bold p-4 active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-[#005bb5] rounded-[16px]"
      ...
      <div className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] overflow-hidden glassmorphism">
        ...
        <div className="absolute bottom-0 w-full p-4 glassmorphism z-50 rounded-b-[16px]">
          ...
          >
            <button
              id="launch-btn"
              className="w-full bg-blue-600 text-white p-4 font-bold shadow-lg hover:bg-blue-700 active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] flex justify-center items-center gap-2 rounded-[16px]"
