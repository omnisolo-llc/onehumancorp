...
export default function WebsiteBuilderPage() {
  ...
  if (status === "idle") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div id="setup-screen" className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] flex flex-col relative rounded-[16px] overflow-hidden mac-glass-container bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg">
  ...
  if (status === "generating") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] flex flex-col relative rounded-[16px] overflow-hidden justify-center items-center mac-glass-container bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg">
  ...
  if (status === "live") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] flex flex-col relative rounded-[16px] overflow-hidden text-center p-8 justify-center mac-glass-container bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
      <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] flex flex-col relative rounded-[16px] overflow-hidden mac-glass-container bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-lg">
