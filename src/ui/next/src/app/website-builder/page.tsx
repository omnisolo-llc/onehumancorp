...
export default function WebsiteBuilderPage() {
  ...
  if (status === "idle") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div className="w-full max-w-[375px] min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative overflow-hidden bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] backdrop-saturate-[210%] border border-white/40 dark:border-white/10 rounded-[16px]">
  ...
  if (status === "generating") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div className="w-full max-w-[375px] min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative justify-center items-center overflow-hidden bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] backdrop-saturate-[210%] border border-white/40 dark:border-white/10 rounded-[16px]">
  ...
  if (status === "live") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div className="w-full max-w-[375px] min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative text-center p-8 justify-center overflow-hidden bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] backdrop-saturate-[210%] border border-white/40 dark:border-white/10 rounded-[16px]">
