        ...
        >
          <div className="px-8 pb-8 pt-12 flex flex-col flex-1 justify-start overflow-y-auto">
            ...
            >
              {wizardStep === 0 && (
                <>
                  <h1 className="text-2xl font-bold font-outfit text-[#1D1D1F] dark:text-[#F5F5F7] dark:text-[#f5f5f7] mb-2">
                    Your business, live in minutes.
                  </h1>
                  <p className="text-[#1D1D1F] dark:text-[#F5F5F7] dark:text-[#a1a1a6] text-sm mb-8 leading-relaxed">
                  ...
                  <div className="flex flex-col gap-4">
                    <button
                      className="w-full bg-[#0066FF] text-white p-4 font-bold rounded-[8px] shadow-md hover:bg-[#0052cc] transition-all"
                    ...
                    <button
                      className="w-full bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] text-[#0066FF] border border-[#0066FF] p-4 font-bold rounded-[8px] shadow-sm hover:bg-blue-50 transition-all"
              ...
              {wizardStep === 1 && (
                <>
                  ...
                  <div className="flex flex-col gap-4 mt-6">
                    <button
                      className="w-full bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] text-[#1D1D1F] dark:text-[#F5F5F7] border border-gray-200 p-4 font-bold rounded-[8px] shadow-sm hover:bg-[#F5F5F7] dark:bg-[#16161a] transition-all text-left"
                      onClick={() => {
              ...
              {wizardStep === 2 && (
                <>
                  ...
                  <div id="step-3" className="mt-6 flex flex-col gap-4">
                    ...
                    />
                    <button
                      className="w-full bg-[#0066FF] text-white p-4 font-bold rounded-[8px] shadow-md hover:bg-[#0052cc] transition-all mt-4"
              ...
              {wizardStep === 3 && (
                <>
                  ...
                  <div id="step-4" className="mt-6 flex flex-col gap-4">
                    <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-[8px] cursor-pointer hover:bg-[#F5F5F7] dark:bg-[#16161a] bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%]">
                      <input
                        type="checkbox"
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter">
        <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] overflow-hidden justify-center items-center mac-glass-container">
          ...
          <p className="text-[#1D1D1F] dark:text-[#F5F5F7] dark:text-[#a1a1a6] font-medium">
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter">
        <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] overflow-hidden text-center p-8 justify-center mac-glass-container">
          ...
          <h1 className="text-3xl font-bold font-outfit text-[#1D1D1F] dark:text-[#F5F5F7] dark:text-[#f5f5f7] mb-2">
            Success! Your business is live!
          </h1>
          <p className="text-[#1D1D1F] dark:text-[#F5F5F7] dark:text-[#a1a1a6] mb-6 text-sm">
          ...
          <button
            className="w-full bg-[#0066FF] text-white font-bold p-4 active:scale-[0.98] transition-all hover:bg-[#0052cc]"
            style={{ borderRadius: "8px" }}
          >
