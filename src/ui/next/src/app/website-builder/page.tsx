  ...
  if (status === "idle") {
    ...
    return (
      ...
      <div className="fixed bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#34C759]/10 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        <div id="setup-screen" className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative overflow-hidden glassmorphism">
              ...
              {wizardStep === 0 && (
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                    <button
                      className="w-full min-h-[54px] bg-[#0066FF] text-white p-4 font-bold shadow-md hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                    ...
                    <button
                      className="w-full min-h-[54px] glassmorphism text-[#0066FF] border border-[#0066FF] p-4 font-bold shadow-sm hover:bg-blue-50 transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
              ...
              {wizardStep === 1 && (
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-6">
                    <button
                      className="w-full min-h-[54px] text-[#1D1D1F] dark:text-[#F5F5F7] glassmorphism p-4 font-bold shadow-sm hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-left"
              ...
              {wizardStep === 2 && (
                <>
                  ...
                  <div id="step-3" className="mt-6 flex flex-col sm:flex-row gap-4 sm:gap-6">
                    <input
                      type="text"
                      className="w-full min-h-[54px] glassmorphism p-4 focus:ring-2 focus:ring-[#0066FF] focus:border-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#F5F5F7] bg-white/60 dark:bg-black/60 shadow-inner border border-gray-300/50 dark:border-gray-600/50 "
                    ...
                    <button
                      ...
                      className="w-full min-h-[54px] bg-[#0066FF] text-white p-4 font-bold shadow-md hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              {wizardStep === 3 && (
                <>
                  ...
                  <div id="step-4" className="mt-6 flex flex-col sm:flex-row gap-4 sm:gap-6">
                    <label className="flex items-center gap-3 p-4 glassmorphism cursor-pointer hover:bg-white/60 dark:hover:bg-white/10 text-[#1D1D1F] dark:text-[#F5F5F7]">
                      <input
                        type="checkbox"
                    ...
                    <button
                      className="w-full min-h-[44px] bg-[#0066FF] text-white p-4 font-bold shadow-md hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] mt-4"
                ...
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-6">
                    <textarea
                      value={bio}
                      onChange={(e) => setBio(e.target.value)}
                      className="w-full min-h-[54px] glassmorphism p-4 focus:ring-2 focus:ring-[#0066FF] focus:border-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] resize-none text-[#1D1D1F] dark:text-[#F5F5F7] bg-white/60 dark:bg-black/60 shadow-inner border border-gray-300/50 dark:border-gray-600/50 "
                      placeholder="e.g. I run a local bakery"
                      rows={4}
                    />
                    <button
                      className="w-full min-h-[54px] bg-[#0066FF] text-white p-4 font-bold shadow-md hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] disabled:opacity-50"
                      disabled={!bio.trim()}
                      onClick={async () => {
                        if (!bio.trim()) return;
                        setStatus('generating');
    ...
    return (
      <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative overflow-hidden text-center p-8 justify-center glassmorphism">
          ...
          <button
            className="w-full min-h-[44px] bg-[#0066FF] text-white font-bold p-4 active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-[#005bb5]"
      ...
      <div className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative overflow-hidden glassmorphism">
        ...
        <div className="absolute bottom-0 w-full p-4 glassmorphism z-50 rounded-b-[16px]">
          <WithTooltip id="launch-btn-tooltip" defaultText="Launch your storefront immediately to a live URL.">
            <button
              id="launch-btn"
              className="w-full bg-blue-600 text-white p-4 font-bold shadow-lg hover:bg-blue-700 active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] flex justify-center items-center gap-2"
