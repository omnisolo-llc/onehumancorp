...
import { ReviewReplyCard } from "../dashboard/ReviewReplyCard";
...
export default function FeedPage() {
  ...
  const startEditing = (item: FeedItem) => {
    ...
    const isReview =
      item.proposed_action?.feature_type === "review_reply" ||
      item.context_payload?.feature_type === "review_reply";
    const isPromoter =
    ...
    >
      ...
      >
        ...
        {!loading && !error && items.length === 0 && (
          <div
            className="glassmorphism flex flex-col items-center justify-center p-12 text-center backdrop-blur-[30px] backdrop-saturate-[210%]"
                    ...
                    : isInvoiceFollowup
                      ...
                      : isInvoiceDraft
                        ...
                        : isAmbassador
                          ...
                          : isReview
                            ? reviewPayload?.rating < 3
                              ? `Action Required: Negative Review on ${reviewPayload?.source || "Yelp"}`
                              : `New Positive Review on ${reviewPayload?.source || "Google"}`
                            : isPromoter
