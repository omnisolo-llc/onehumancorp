  ...
  return (
    <AppShell title="Daily Work" subtitle="Your daily priorities, coordinated by your team.">
      <div className="w-full max-w-[375px] mx-auto p-4 space-y-4" data-testid="agent-feed">
        ...
        {error && (
          <div className="macos-translucent-glass p-4 text-center rounded-[16px] backdrop-blur-[30px] backdrop-saturate-[210%]">
        ...
        {!loading && !error && items.length === 0 && (
          <div className="macos-translucent-glass flex flex-col items-center justify-center p-12 text-center rounded-[16px] backdrop-blur-[30px] backdrop-saturate-[210%]" data-testid="agent-feed-empty">
        ...
        <div className="flex flex-col gap-4">
          {items.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className={`macos-translucent-glass p-5 relative overflow-hidden transition-all duration-300 rounded-[16px] backdrop-blur-[30px] backdrop-saturate-[210%] ${isProcessing ? 'opacity-50 scale-[0.98]' : 'animate-fade-in'}`}
