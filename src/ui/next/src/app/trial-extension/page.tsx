...
export default function TrialExtensionPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-inter bg-[#F5F5F7]">
      <header className="px-4 md:px-6 py-4 flex items-center justify-between border-b sticky top-0 z-50 macos-translucent-glass backdrop-blur-[30px] saturate-[210%] border-white/40">
      ...
      <main className="p-4 md:p-8 flex-1 w-full max-w-4xl mx-auto flex flex-col items-center justify-center">
        <div className="w-full macos-translucent-glass rounded-2xl shadow-xl overflow-hidden border border-white/40 dark:border-white/10 p-8 md:p-12 text-center max-w-2xl relative">
