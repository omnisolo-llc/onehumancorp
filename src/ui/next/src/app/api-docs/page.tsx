...
export default function ApiDocsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-8">
      <div className="bg-yellow-50/80 backdrop-blur-[30px] saturate-[210%] border-l-4 border-yellow-400 p-4 mb-8 rounded-r-xl shadow-sm">
      ...
      {mounted && <div className="bg-white/80 backdrop-blur-[30px] saturate-[210%] p-6 rounded-2xl shadow-xl border border-gray-100/50"><SwaggerUI spec={swaggerSpec} /></div>}
    </div>
  );
}
