...
export default function ApiDocsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-8">
      ...
      {mounted && <div className="bg-white/80 backdrop-blur-[20px] saturate-200 p-6 rounded-2xl shadow-xl border border-gray-100/50 max-w-7xl mx-auto"><SwaggerUI spec={swaggerSpec} /></div>}
    </div>
  );
}
