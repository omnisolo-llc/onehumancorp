...
export default function ApiDocsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-8">
      ...
      {mounted && <div className="bg-white/10 backdrop-blur-md saturate-200 p-6 rounded-2xl shadow-xl border border-white/20 overflow-x-auto"><SwaggerUI spec={swaggerSpec} /></div>}
    </div>
  );
}
