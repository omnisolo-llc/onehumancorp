...
export default function ApiDocsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7]/80 p-8 backdrop-blur-[20px] saturate-200 font-inter">
      <div className="bg-yellow-50/90 backdrop-blur-[30px] saturate-200 border-l-4 border-yellow-400 p-4 mb-8 rounded-r-xl shadow-md font-inter">
      ...
      {mounted && spec && <div className="bg-white/60 backdrop-blur-[20px] saturate-200 p-6 rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_16px_48px_rgba(0,0,0,0.1)] transition-all border border-white/40"><SwaggerUI spec={spec} /></div>}
    </div>
  );
}
