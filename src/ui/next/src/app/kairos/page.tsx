...
function KairosContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-inter" style={{ backgroundColor: '#16161A' }}>
      ...
      <main className="p-4 sm:p-6 md:p-8 flex-1 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">

        {/* 1. Shared Task List (The Brain) */}
        <section id="kairos-brain" className="lg:col-span-2 space-y-6">
            <div className="ohc-hybrid-panel shadow-lg flex flex-col gap-4 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl">
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold font-outfit text-[#F5F5F7]">Shared Task List</h2>
                    <span className="text-xs font-bold px-2 py-1 bg-indigo-100 text-indigo-700 rounded-md shadow-sm">THE BRAIN</span>
                </div>
                ...
                <div className="space-y-3">
                    {activeTasks.map(task => (
                        <div key={task.id} className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-gray-800 shadow-sm transition-all hover:bg-white/10 hover:border-gray-600">
            ...
            <div id="kairos-nerves" className="ohc-hybrid-panel shadow-lg flex flex-col gap-4 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl">
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold font-outfit text-[#F5F5F7]">Teammate Mesh</h2>
                    <span className="text-xs font-bold px-2 py-1 bg-green-100 text-green-700 rounded-md shadow-sm">THE NERVES</span>
                </div>
                <p className="text-sm text-gray-400 leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {meshNodes.map(node => (
                        <div key={node.id} className="p-4 bg-white/5 rounded-xl border border-gray-800 shadow-sm flex flex-col gap-2 transition-colors hover:bg-white/10 hover:border-gray-600">
        ...
        <section id="kairos-memory" className="lg:col-span-1 space-y-6">
            <div className="ohc-hybrid-panel shadow-lg h-full flex flex-col gap-6 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl">
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold font-outfit text-[#F5F5F7]">AutoDream Memory</h2>
                    <span className="text-xs font-bold px-2 py-1 bg-purple-100 text-purple-700 rounded-md shadow-sm">THE MEMORY</span>
                </div>
                ...
                <div className="space-y-4">
                    <div className="p-4 bg-purple-900/20 rounded-xl border border-purple-800 transition-colors hover:bg-purple-900/30 hover:border-purple-600">
                    ...
                    <div className="p-4 bg-indigo-900/20 rounded-xl border border-indigo-800 transition-colors hover:bg-indigo-900/30 hover:border-indigo-600">
