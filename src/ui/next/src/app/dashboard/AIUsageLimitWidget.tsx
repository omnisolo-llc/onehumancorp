...
export function AIUsageLimitWidget() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      fetch(`/api/v1/billing/department-tier-usage?tenant_id=${encodeURIComponent(finalTenant)}`)
        ...
        .catch(err => console.warn("Failed to fetch usage", err));
    }
  }, []);
  ...
  return (
    <div className="mb-6 ohc-growth-card glassmorphism p-6 rounded-[16px] border border-orange-200/60 dark:border-orange-800/60 bg-white/40 dark:bg-black/20 backdrop-blur-md relative overflow-hidden" data-testid="ai-usage-limit-widget">
