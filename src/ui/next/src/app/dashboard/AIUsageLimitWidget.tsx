...
export function AIUsageLimitWidget() {
  ...
  return (
    <div className="mb-6 ohc-growth-card macos-translucent-glass p-6 rounded-[16px] border border-orange-200/60 dark:border-orange-800/60 bg-white/40 dark:bg-black/20 backdrop-blur-[30px] saturate-[210%] relative overflow-hidden" data-testid="ai-usage-limit-widget">
