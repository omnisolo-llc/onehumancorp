...
export default function AffiliateMarketingWidget() {
  ...
  return (
    <div className="glassmorphism app-card glass-card rounded-2xl p-6 shadow-sm border border-indigo-100 bg-gradient-to-br from-white to-indigo-50/30 font-inter">
