...
export default function AffiliateMarketingWidget() {
  ...
  return (
    <div data-voice-assistant-surface="glass" className="glassmorphism rounded-2xl p-6 shadow-sm border border-indigo-100 bg-gradient-to-br from-white to-indigo-50/30 font-inter">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div data-voice-assistant-surface="glass" className="glassmorphism p-4 rounded-xl border border-gray-100 shadow-sm text-center">
