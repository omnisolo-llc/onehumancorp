      ...
      <main id="dashboard-screen" className="app-grid" style={{ gap: 16 }}>
        ...
        <section className="mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/smart-pricing" className="block glassmorphism p-6 min-h-[44px] rounded-[16px] hover:shadow-lg transition-all hover:-translate-y-0.5 group border border-white/40 dark:border-white/10">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-blue-600 dark:text-blue-400 font-semibold text-sm bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full">Pricing</div>
              </div>
              <h3 className="text-xl font-bold font-outfit text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">Smart Pricing</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Let AI automatically adjust your prices to maximize revenue and clear inventory.</p>
            </Link>
