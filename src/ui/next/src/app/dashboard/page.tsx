...
export default function Dashboard() {
  ...
  return (
    ...
    >
      <div className="mb-6 p-6 rounded-[16px] glassmorphism border border-white/40 dark:border-white/10 hidden">
      ...
      <div className="hidden"><NeighborhoodPulseCard tenant={tenantId()} /></div>
      <div className="hidden"><FloatingActionButton /></div>
      ...
      <div className="hidden"><SuccessMilestoneAlert /></div>
      <div className="hidden"><ViralLoopPerformanceWidget /></div>

      <div className="mb-6 hidden">
          <SmartBlock type="PoweredBy" props={{ tenantId: tenantId(), isPremium: false }} />
      </div>

      <section className="app-panel mb-6 hidden">
      ...
      <main id="dashboard-screen" className="app-grid" style={{ gap: 16 }}>
        {activeDepartments.length > 0 && (
          <section className="mb-6 w-full col-span-full hidden">
        ...
        <div className="mb-6 flex gap-4 hidden"><Link href="/assistant" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Open WorkBuddy Assistant</Link></div>
        <UnifiedAgentFeed />
