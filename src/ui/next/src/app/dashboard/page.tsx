          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link href="/link-in-bio-generator" className="block mac-glass-container p-6 rounded-[16px] hover:shadow-lg transition-all hover:-translate-y-0.5 group border border-white/40 dark:border-white/10">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-blue-600 dark:text-blue-400 font-semibold text-sm bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full">Link Page</div>
              </div>
              <h3 className="text-xl font-bold font-outfit text-gray-900 dark:text-white mb-2">Link-in-Bio Generator</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Create Link-in-Bio Page to share across your social media profiles.</p>
            </Link>
