      ...
      <main id="dashboard-screen" className="app-grid" style={{ gap: 16 }}>
        ...
        <section className="mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <WithTooltip id="dashboard-card-viral">
            ...
            <WithTooltip id="dashboard-card-share">
            ...
            <WithTooltip id="dashboard-card-winback">
            ...
            <WithTooltip id="dashboard-card-reviews">
            ...
            <WithTooltip id="dashboard-card-promo">
            ...
            <WithTooltip id="dashboard-card-cart">
            ...
            <WithTooltip id="dashboard-card-flash">
