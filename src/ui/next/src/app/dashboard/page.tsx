      ...
      <main id="dashboard-screen" className="app-grid" style={{ gap: 16 }}>
        <section>
          ...
          <div className="app-grid metrics">
            ...
            <WalkthroughTarget id="upsell-revenue-target" className="app-card relative overflow-hidden bg-gradient-to-br from-green-50 to-white border-green-100">
                <div className="absolute -right-4 -top-4 text-green-100 opacity-50 transform rotate-12 scale-150">
                ...
                <WithTooltip id="upsell-revenue-tooltip" defaultText="Extra revenue generated purely by AI upsell recommendations at checkout.">
                    <div className="app-metric-label flex items-center gap-1 text-green-700 relative z-10">
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
                        AI Upsell Revenue
                    </div>
                </WithTooltip>
                <div className="app-metric-value relative z-10">{money((metrics as any).upsell_revenue || 0)}</div>
                <div className="app-metric-note relative z-10 text-green-600">Generated automatically</div>
            </WalkthroughTarget>
            <div className="app-card">
