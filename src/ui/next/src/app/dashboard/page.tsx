      ...
      <main id="dashboard-screen" className="app-grid" style={{ gap: 16 }}>
        ...
        <section className="mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/reviews" className="block mac-glass-container p-6 rounded-[16px] hover:shadow-lg transition-all hover:-translate-y-0.5 group border border-white/40 dark:border-white/10">
              ...
              <h3 className="text-xl font-bold font-outfit text-gray-900 dark:text-white mb-2">Reputation Inbox</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">1-tap approve AI replies to your public reviews.</p>
            </Link>
