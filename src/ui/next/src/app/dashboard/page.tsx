  ...
  return (
    ...
    >
      ...
      <main id="dashboard-screen" className="app-grid" style={{ gap: 16 }}>
        <div className="mb-6 flex gap-4 col-span-full"><Link href="/assistant" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Open WorkBuddy Assistant</Link></div>
