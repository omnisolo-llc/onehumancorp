        ...
        <section className="app-grid two">
          ...
          <div className="app-panel">
            ...
            <div className="app-list">
                            {(dashboardData?.approvals || []).filter(a => a.payload?.feature_type === 'ambassador_reply').map(approval => (
              ...
              {!loading && metrics.pending_orders === 0 && lowStockCount === 0 && messages.length === 0 && (dashboardData?.approvals || []).filter(a => a.payload?.feature_type === "ambassador_reply").length === 0 && (
