...
export function UnifiedAgentFeed({ initialData }: { initialData?: AgentFeedData }) {
  ...
  return (
    <section
      ...
      className="app-panel mb-6 w-full max-w-full md:max-w-2xl mx-auto overflow-hidden bg-white dark:bg-slate-950 p-4 rounded-[16px] shadow-lg border border-gray-100 dark:border-gray-800"
