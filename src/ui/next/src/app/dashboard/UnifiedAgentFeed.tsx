            ...
            {approvals.map((approval) => (
              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  {(approval.payload?.context || approval.payload?.remaining_stock !== undefined || approval.payload?.feature_type === 'proposal_draft') && (
                    <div className="mt-2 flex flex-col gap-1 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                      {approval.payload?.feature_type === 'proposal_draft' ? (
                        <div className="flex flex-col gap-2">
                          <div className="text-sm text-gray-700 dark:text-gray-300">
                            <span className="font-semibold block mb-1">Customer Request:</span>
                            <span className="text-gray-600 dark:text-gray-400">{approval.payload.customer_inquiry}</span>
                          </div>
                          <div className="border-t border-gray-200 dark:border-gray-700 my-1"></div>
                          <div className="text-sm">
                            <span className="font-semibold block mb-1">Proposed Scope:</span>
                            <span className="text-gray-600 dark:text-gray-400">{approval.payload.scope}</span>
                          </div>
