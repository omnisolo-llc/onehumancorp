...
export function UnifiedAgentFeed({ initialData }: { initialData?: any }) {
    ...
    async function fetchTriage() {
      ...
      try {
        ...
        const res = await fetch(
          `/api/ui/triage?tenant_id=${encodeURIComponent(tenant)}`,
        );
        if (!res.ok)
        ...
        if (mounted)
          setTriageError(e?.message || "Failed to load triage items");
      } finally {
  ...
  return (
    <section
      className="mb-6 w-full w-full overflow-hidden"
          ...
          <>
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h2 className="text-xl font-bold font-outfit text-orange-900 dark:text-orange-100 flex items-center gap-2">
                        <span className="text-2xl">✨</span> Needs Attention
                        Today
                      </h2>
            ...
            {triageItems
              ...
              .map((item) => (
                <div
                  key={item.id}
                  className="mb-6 p-6 rounded-[16px] glassmorphism border border-white/40 dark:border-white/10 shadow-sm overflow-hidden"
                >
                  <div className="flex justify-between items-start mb-3">
                    <div>
                  ...
                  {item.action_type && (
                    <div className="mt-4 mb-4 p-4 rounded-xl border border-blue-200 dark:border-blue-900/30 bg-blue-50/50 dark:bg-blue-900/20">
                      <div className="text-xs uppercase tracking-wider font-semibold text-blue-900 dark:text-blue-300 mb-1">
                        Proposed Action: {item.action_type}
                      </div>
                      <div className="text-sm font-medium text-blue-900 dark:text-blue-100 whitespace-pre-wrap">
                        {item.action_payload}
                      </div>
                    </div>
                  )}
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-2">
                    ...
                    {queuedActionIds.has(approval.id) && (
                      <span
                        className="text-xs font-bold uppercase tracking-wider text-yellow-600 bg-yellow-50 px-2 py-1 rounded-md shadow-sm border border-yellow-200"
                  ...
                  {((approval.proposed_action || approval.context_payload)
                    ...
                    <div className="mt-2 flex flex-col gap-1 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                      {(approval.proposed_action || approval.context_payload)
                        ?.feature_type === "incident_resolution" && (
                        <div
                          className="mb-4 p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 flex flex-col gap-3"
                      ...
                      {(approval.proposed_action || approval.context_payload)
                        ?.feature_type === "instagram_dm" && (
                        <div
                          className="mb-4 p-4 rounded-xl glassmorphism border border-white/40 dark:border-white/10 shadow-sm flex flex-col gap-3"
                          data-testid="instagram-dm-card"
                        >
                          ...
                          <div className="text-sm text-[#1D1D1F] dark:text-[#F5F5F7] font-medium">
                            Customer:{" "}
                            {
                              (
                                approval.proposed_action ||
                          ...
                          <div className="text-sm text-[#1D1D1F] dark:text-[#F5F5F7] italic line-clamp-3 bg-white/50 dark:bg-black/20 p-3 rounded-[8px] break-words border border-white/40 dark:border-white/10">
                            Draft:{" "}
                            {
                              (
                                approval.proposed_action ||
                      ...
                      {(approval.proposed_action || approval.context_payload)
                        ...
                        <div
                          className="mb-4 p-4 rounded-xl glassmorphism border border-white/40 dark:border-white/10 shadow-sm flex flex-col gap-3"
                          data-testid="ambassador-reply-card"
                        >
                          ...
                          <div className="bg-white/50 dark:bg-black/20 p-3 rounded-[8px] text-sm text-[#1D1D1F] dark:text-[#F5F5F7] italic border border-white/40 dark:border-white/10">
                            "
                            {
                              (
                                approval.proposed_action ||
                      ...
                      {(approval.proposed_action || approval.context_payload)
                        ?.feature_type === "quote_draft" && (
                        <div
                          className="mb-4 p-4 rounded-xl glassmorphism  flex flex-col gap-3"
                ...
                <div className="flex flex-col gap-3 w-full mt-2">
                  {(approval.proposed_action || approval.context_payload)
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      <button
                        onClick={() => handleDecision(approval.id, true)}
                        className="w-full flex-1 min-h-[44px] min-w-[44px] px-4 rounded-[8px] bg-pink-600 text-white font-medium hover:bg-pink-700 transition-transform active:scale-[0.98] shadow-md flex items-center justify-center cursor-pointer"
                      ...
                      <button
                        onClick={() => handleDecision(approval.id, false)}
                        className="w-full flex-1 min-h-[44px] min-w-[44px] px-4 rounded-[8px] border border-gray-200 dark:border-white/10 text-[#1D1D1F] dark:text-[#F5F5F7] bg-white/50 dark:bg-black/20 hover:bg-white/80 dark:hover:bg-black/40 font-medium transition-all active:scale-[0.98] flex items-center justify-center cursor-pointer"
                        aria-label="Dismiss"
                    ...
                    editingId === approval.id ? (
                      <div className="flex flex-col gap-3 w-full">
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="w-full flex-1 min-h-[44px] px-4 rounded-[8px] bg-[#0066FF] text-white font-medium hover:bg-[#0052CC] transition-transform active:scale-[0.98] shadow-md flex items-center justify-center cursor-pointer"
                          ...
                          <button
                            ...
                            className="w-full flex-1 min-h-[44px] px-4 rounded-[8px] border border-gray-200 dark:border-white/10 text-[#1D1D1F] dark:text-[#F5F5F7] bg-white/50 dark:bg-black/20 hover:bg-white/80 dark:hover:bg-black/40 font-medium transition-all active:scale-[0.98] flex items-center justify-center cursor-pointer"
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 w-full">
                        <button
                          onClick={() => handleDecision(approval.id, true)}
                          className="w-full flex-1 min-h-[44px] min-w-[44px] px-4 rounded-[8px] bg-[#0066FF] text-white font-medium hover:bg-[#0052CC] transition-transform active:scale-[0.98] shadow-md flex items-center justify-center cursor-pointer"
