                  ...
                  {(approval.payload?.context || approval.payload?.remaining_stock !== undefined || approval.payload?.feature_type === "quote_draft") && (
                    <div className="mt-2 flex flex-col gap-1 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                      ...
                      {approval.payload?.context?.smart_pricing === true ? (
                        ...
                        <div className="flex flex-col gap-2" data-testid="ambassador-reply-card">
                          <div className="bg-white dark:bg-gray-800 p-3 rounded-lg border border-indigo-100 dark:border-indigo-900/50 mb-2 shadow-sm">
                            ...
                            <div className="text-sm font-medium text-gray-900 dark:text-gray-100 italic">
                              "{approval.payload.original_message}"
                            </div>
                          </div>

                          <div className="flex justify-between items-center text-sm mb-1 px-1">
                            <span className="text-gray-500 dark:text-gray-400 font-medium">Context Applied:</span>
                            <span className="font-semibold text-indigo-600 dark:text-indigo-400 text-xs text-right max-w-[60%] truncate" title={approval.payload.context_used}>
                              {approval.payload.context_used}
                            </span>
                          </div>

                          <div className="bg-indigo-50/50 dark:bg-indigo-900/10 p-3 rounded-lg border border-indigo-100/50 dark:border-indigo-900/30">
                            <div className="text-[10px] uppercase font-bold text-indigo-400 dark:text-indigo-500 mb-1">
                              AI Drafted Reply
                            </div>
