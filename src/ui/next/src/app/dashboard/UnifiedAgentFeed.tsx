                      ...
                      {approval.payload?.feature_type === 'social_post_draft' ? (
                        <div className="flex flex-col gap-3">
                          <div className="text-sm font-medium text-gray-800 dark:text-gray-200">
                            Social media posts ready for {approval.payload.product_name || 'your new product'}:
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="app-card dark:bg-gray-800 p-3 rounded-lg border border-indigo-100 dark:border-indigo-900/50">
                              <div className="text-[10px] uppercase font-bold text-gray-500 mb-1 flex items-center gap-1">
                                <svg className="w-3 h-3 text-[#000000] dark:text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04-.1z"/></svg>
                                TikTok
                              </div>
                              <p className="text-xs text-gray-700 dark:text-gray-300 italic">"{approval.payload.tiktok}"</p>
                            </div>
                            <div className="app-card dark:bg-gray-800 p-3 rounded-lg border border-pink-100 dark:border-pink-900/50">
                              <div className="text-[10px] uppercase font-bold text-gray-500 mb-1 flex items-center gap-1">
                                <svg className="w-3 h-3 text-[#E1306C]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
                                Instagram
                              </div>
                              <p className="text-xs text-gray-700 dark:text-gray-300 italic">"{approval.payload.instagram}"</p>
                            </div>
                            <div className="app-card dark:bg-gray-800 p-3 rounded-lg border border-blue-100 dark:border-blue-900/50">
                              <div className="text-[10px] uppercase font-bold text-gray-500 mb-1 flex items-center gap-1">
                              ...
                              <p className="text-xs text-gray-700 dark:text-gray-300 italic">"{approval.payload.facebook}"</p>
                            </div>
                          </div>
                        </div>
