...
export function UnifiedAgentFeed({ initialData }: { initialData?: any }) {
  ...
  if (error) {
    return (
      <div className="w-full mb-6 p-4 glassmorphism translucent-glass-light dark:translucent-glass-dark border border-[#FF3B30] text-[#FF3B30] text-center">
        {error}
      </div>
    );
  }
    ...
    >
      ...
      <div className="flex flex-col gap-4 w-full">
        {activeTab === "proposals" && (
          <>
            {loading && (
              <div className="w-full p-4 glassmorphism translucent-glass-light dark:translucent-glass-dark border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] text-center text-[#1D1D1F] dark:text-[#F5F5F7]">
        ...
        {activeTab === "activity" && (
          <>
            ...
            {!activityLoading && activities.length === 0 && (
              <div className="w-full p-6 glassmorphism translucent-glass-light dark:translucent-glass-dark border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] text-center">
            ...
            <div className="flex flex-col gap-3 ">
              {activities.map((activity) => (
                <div
                  key={activity.id}
                  className="glassmorphism translucent-glass-light dark:translucent-glass-dark border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] p-5 shadow-sm flex flex-col gap-3 opacity-90 min-h-[44px]"
                >
