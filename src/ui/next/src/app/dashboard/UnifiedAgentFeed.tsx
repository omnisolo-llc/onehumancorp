    ...
    <section className="mb-6 w-full max-w-full overflow-hidden sm:max-w-none" aria-label="Unified Agent Feed">
      ...
      <div className="mb-4 flex items-center border-b border-gray-200 dark:border-gray-700">
        <button
          ...
          className={`flex-1 min-h-[48px] min-w-[48px] py-3 text-center text-sm font-semibold transition-all duration-200 ${
            activeTab === "proposals"
          ...
          <>
              ...
              <div key={item.id} className="mb-6 p-6 rounded-[16px] glassmorphism border border-orange-400/50 dark:border-orange-500/30 bg-orange-50/50 dark:bg-orange-900/10 shadow-lg relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-2 w-full">
                  <button
                    ...
                    className="flex-1 px-6 py-2.5 min-h-[48px] min-w-[48px] rounded-[16px] bg-orange-500 hover:bg-orange-600 text-white font-medium shadow-sm transition-colors flex items-center justify-center"
                  ...
                  <button
                    ...
                    className="flex-1 px-6 py-2.5 min-h-[48px] min-w-[48px] rounded-[16px] bg-white/50 dark:bg-black/30 border border-orange-200 dark:border-orange-900/30 hover:bg-white/80 dark:hover:bg-black/50 text-orange-900 dark:text-orange-100 font-medium transition-colors flex items-center justify-center"
            ...
            {triageItems.filter(item => item.source !== "Proactive Context Agent").map((item) => (
              <div key={item.id} className="mb-6 p-6 rounded-[16px] glassmorphism border border-white/40 dark:border-white/10 shadow-sm overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-2 w-full">
                  <button
                    onClick={() => handleTriageDecision(item.id, true)}
                    className="flex-1 px-6 py-2.5 min-h-[48px] min-w-[48px] rounded-[16px] bg-[#0066FF] hover:bg-[#0052CC] text-white font-medium shadow-sm transition-colors flex items-center justify-center"
                    data-testid={`triage-approve-${item.id}`}
                  >
                    Approve
                  </button>
                  <button
                    onClick={() => handleTriageDecision(item.id, false)}
                    className="flex-1 px-6 py-2.5 min-h-[48px] min-w-[48px] rounded-[16px] bg-white/50 dark:bg-black/30 border border-gray-200 dark:border-white/10 hover:bg-white/80 dark:hover:bg-black/50 text-[#1D1D1F] dark:text-[#F5F5F7] font-medium transition-colors flex items-center justify-center"
                    data-testid={`triage-dismiss-${item.id}`}
                  >
                    Dismiss
                  </button>
            ...
            <div className="glassmorphism p-5 rounded-[16px]  shadow-sm flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
                <button
                  className="flex-1 min-h-[48px] min-w-[48px] rounded-lg font-bold text-sm bg-green-500 hover:bg-green-600 text-white shadow-sm transition-transform active:scale-[0.98]"
                >
                  Approve
                </button>
                <button
                  className="flex-1 min-h-[48px] min-w-[48px] rounded-lg font-bold text-sm bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 text-[#1D1D1F] dark:text-[#F5F5F7] transition-transform active:scale-[0.98]"
                >
                  Edit
                </button>
                <button
                  className="flex-1 min-h-[48px] min-w-[48px] rounded-lg font-bold text-sm bg-red-100 hover:bg-red-200 text-red-600 dark:bg-red-900/30 dark:hover:bg-red-900/50 dark:text-red-400 transition-transform active:scale-[0.98]"
                >
                  Deny
                </button>
              </div>
                  ...
                  {(approval.proposed_action || approval.context_payload)?.feature_type === 'incident_resolution' ? (
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      <button
                        ...
                        className="flex-1 min-h-[48px] min-w-[48px] px-4 rounded-[8px] bg-red-600 text-white font-medium hover:bg-red-700 transition-all duration-200 shadow-md flex items-center justify-center"
                      ...
                      <button
                        ...
                        className="flex-1 min-h-[48px] min-w-[48px] px-4 rounded-[8px] border border-gray-300 dark:border-gray-600 text-[#1D1D1F] dark:text-[#F5F5F7] font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 flex items-center justify-center"
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      <button
                        onClick={() => handleDecision(approval.id, true)}
                        className="flex-1 min-h-[48px] min-w-[48px] px-4 rounded-[8px] bg-pink-600 text-white font-medium hover:bg-pink-700 transition-all duration-200 shadow-md flex items-center justify-center"
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      <button
                        onClick={() => handleDecision(approval.id, true)}
                        className="flex-1 min-h-[48px] min-w-[48px] px-4 rounded-[8px] bg-gradient-to-r from-pink-500 to-indigo-500 text-white font-medium hover:from-pink-600 hover:to-indigo-600 transition-all duration-200 shadow-md flex items-center justify-center"
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      <button
                        onClick={() => handleDecision(approval.id, true)}
                        className="flex-1 min-h-[48px] min-w-[48px] px-4 rounded-[8px] bg-green-600 text-white font-medium hover:bg-green-700 transition-all duration-200 shadow-md flex items-center justify-center"
                        aria-label="Approve"
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      <button
                        onClick={() => handleDecision(approval.id, true)}
                        className="flex-1 min-h-[48px] min-w-[48px] px-4 rounded-[8px] bg-[#0066FF] text-white font-medium hover:bg-[#0052CC] transition-all duration-200 shadow-md flex items-center justify-center"
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      <button
                        onClick={() => handleDecision(approval.id, true)}
                        className="flex-1 min-h-[48px] min-w-[48px] px-4 rounded-[8px] bg-amber-500 text-white font-medium hover:bg-amber-600 transition-all duration-200 shadow-md flex items-center justify-center"
                    ...
                    <>
                      <button
                        onClick={() => handleDecision(approval.id, true)}
                        className="w-full min-h-[48px] min-w-[48px] px-4 rounded-[8px] bg-[#0066FF] text-white font-medium hover:bg-[#0052CC] transition-all duration-200 shadow-md flex items-center justify-center mb-3"
                        aria-label="Approve & Send"
        ...
        {activeTab === "activity" && (
          <>
            ...
            {activities.map((activity) => (
              <div
                key={activity.id}
                className="glassmorphism p-5 rounded-[16px]  shadow-sm flex flex-col gap-3 opacity-90 min-h-[48px]"
              >
