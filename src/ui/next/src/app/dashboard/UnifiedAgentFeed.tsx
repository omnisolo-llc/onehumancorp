...
export function UnifiedAgentFeed({ initialData }: { initialData?: any }) {
  ...
  return (
    <section className="mb-6 w-full mx-auto sm:max-w-none" aria-label="Unified Agent Feed">
      {isOffline && (
      ...
      <div className="mb-4 flex items-center border-b border-gray-200 dark:border-gray-700">
        <button
          ...
          className={`flex-1 py-3 min-h-[44px] min-w-[44px] text-center text-sm font-semibold transition-all duration-200 ${
            activeTab === "proposals"
