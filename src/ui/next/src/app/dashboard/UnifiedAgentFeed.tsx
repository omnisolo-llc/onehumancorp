                      ...
                      {approval.payload?.feature_type === 'quote_draft' ? (
                        <div className="flex flex-col gap-2">
                          <div className="text-sm text-gray-700 dark:text-gray-300">
                            <span className="font-semibold">Request:</span> {approval.payload.customer_inquiry}
                          </div>
                          <div className="text-sm text-gray-700 dark:text-gray-300">
                            <span className="font-semibold">Scope:</span> {approval.payload.scope}
                          </div>
                          ...
                          <div className="flex justify-between items-center text-sm">
                            ...
                            <span className="font-bold text-green-600 dark:text-green-400">${Number(approval.payload.suggested_price).toFixed(2)}</span>
                          </div>
                        </div>
