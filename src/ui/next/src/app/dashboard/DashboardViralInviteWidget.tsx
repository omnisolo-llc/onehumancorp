...
export function DashboardViralInviteWidget() {
  ...
  return (
    <div className="mb-6 ohc-growth-card p-6 rounded-[16px] backdrop-blur-md bg-white/30 dark:bg-black/30 border border-white/20 dark:border-white/10 bg-gradient-to-r from-indigo-50/50 to-purple-50/50 dark:from-indigo-900/20 dark:to-purple-900/20 shadow-xl" data-testid="dashboard-viral-invite-widget">
