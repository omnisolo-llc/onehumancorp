        ...
        <div className="flex flex-col gap-3 w-full mt-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full">
            <button
              ...
              className="flex-1 min-h-[44px] min-w-[44px] px-4 rounded-[8px] bg-[#0066FF] text-white font-medium hover:bg-[#0052CC] transition-all duration-200 shadow-md flex items-center justify-center w-full sm:w-auto"
            ...
            <button
              ...
              className="flex-1 min-h-[44px] min-w-[44px] px-4 rounded-[8px] border border-gray-300 dark:border-gray-600 text-[#1D1D1F] dark:text-[#F5F5F7] font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 flex items-center justify-center w-full sm:w-auto"
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
            {onApprove && (
              <button
                ...
                className="flex-[2] min-h-[44px] min-w-[44px] px-4 rounded-[8px] bg-[#0066FF] text-white font-medium hover:bg-[#0052CC] transition-all duration-200 shadow-md flex items-center justify-center w-full sm:w-auto"
