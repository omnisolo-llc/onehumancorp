...
export function AIFeaturePaywallWidget() {
  ...
  return (
    <div className="mb-6 ohc-growth-card glassmorphism p-6 rounded-[16px] border border-indigo-200/60 dark:border-indigo-800/60 bg-white/40 dark:bg-black/20 backdrop-blur-md relative overflow-hidden" data-testid="ai-feature-paywall">
