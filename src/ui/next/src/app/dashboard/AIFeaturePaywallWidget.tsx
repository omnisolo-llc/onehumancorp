...
export function AIFeaturePaywallWidget() {
  ...
  const shareText = `Start your business on OmniSolo OneHumanCorp! Use my link to get $50 off your first month: ${referralLink}`;
