...
export function AIFeaturePaywallWidget() {
  ...
  if (unlocked) {
      return (
          <div className="mb-6 ohc-growth-card macos-translucent-glass p-6 rounded-[16px] border border-green-400/50 dark:border-green-500/30 bg-gradient-to-r from-green-50/80 to-emerald-50/80 dark:from-green-900/20 dark:to-emerald-900/20 shadow-md">
  ...
  return (
    <div className="mb-6 ohc-growth-card macos-translucent-glass p-6 rounded-[16px] border border-indigo-200/60 dark:border-indigo-800/60 bg-white/40 dark:bg-black/20 backdrop-blur-[30px] saturate-[210%] relative overflow-hidden" data-testid="ai-feature-paywall">
