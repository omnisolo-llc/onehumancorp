...
export function CartRecoveryWidget() {
  ...
  return (
    <div className="glass-panel p-6 rounded-[16px] border border-white/40 dark:border-white/10 hover:shadow-xl transition-all h-full flex flex-col justify-between group">
      <div>
