    ...
    <section className="app-panel mb-6 border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-white shadow-lg transform transition-all hover:scale-[1.01]">
      ...
      <div className="app-panel-body pt-5">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            onClick={handleShare}
            className={`flex-1 min-h-[44px] py-3 px-4 rounded-xl font-bold font-outfit text-sm transition-all flex items-center justify-center gap-2 ${
              isShared
          ...
          <a
            ...
            className="flex-1 py-3 px-4 min-h-[44px] rounded-xl font-bold font-outfit text-sm bg-[#1DA1F2] text-white hover:bg-[#1a91da] shadow-md shadow-blue-200 transition-all flex items-center justify-center gap-2"
          >
            🐦 Share on X
          </a>
        </div>
