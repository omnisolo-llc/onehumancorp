    ...
    <section className="glassmorphism p-6 rounded-[16px] border border-white/40 dark:border-white/10 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 mb-6">
      ...
      <div>
        ...
        <div className="mt-6 flex justify-end">
            <a href="/referrals" className="app-button bg-indigo-600 hover:bg-indigo-700 text-white border-none py-2 px-6 rounded-lg text-sm font-semibold transition-colors min-h-[44px] flex items-center justify-center">View Referral Details</a>
        </div>
      </div>
    </section>
  );
