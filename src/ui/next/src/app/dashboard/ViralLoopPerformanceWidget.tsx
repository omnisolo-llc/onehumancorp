    ...
    <section className="glassmorphism p-6 rounded-[16px] border border-white/40 dark:border-white/10 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 mb-6">
      ...
      <div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="app-card glass-card bg-white/40 dark:bg-black/20 backdrop-blur-[30px] saturate-[210%] border border-white/30 dark:border-white/5 flex flex-col justify-between p-5 rounded-[12px] shadow-sm hover:shadow-md transition-shadow">
