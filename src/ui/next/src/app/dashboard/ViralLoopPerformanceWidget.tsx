...
export function ViralLoopPerformanceWidget() {
  ...
  return (
    <section data-voice-assistant-surface="glass" className="glassmorphism p-6 border border-white/40 dark:border-white/10 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 mb-6">
