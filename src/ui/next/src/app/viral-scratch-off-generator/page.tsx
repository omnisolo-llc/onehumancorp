  ...
  (function() {
    ...
    container.innerHTML = \`
      <div style="font-family: sans-serif; max-width: 300px; margin: 0 auto; text-align: center; padding: 20px; border: 1px solid #e5e7eb; border-radius: 12px; background: #fff; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
        ...
        <p style="color: #6b7280; font-size: 14px; margin-bottom: 16px;">Enter your email to scratch the card.</p>
        ...
        <button style="background: #0066ff; color: white; border: none; padding: 10px 16px; border-radius: 6px; font-weight: bold; cursor: pointer; width: 100%;">SCRATCH NOW</button>\`;`;
  ...
  return (
    <div className="min-h-screen flex flex-col font-inter" style={{ backgroundColor: '#F5F5F7' }}>
      <header className="px-6 py-4 flex items-center justify-between border-b" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', borderBottom: '1px solid rgba(255, 255, 255, 0.4)', position: 'sticky', top: 0, zIndex: 50 }}>
         <h1 className="text-2xl font-bold font-outfit" style={{ color: '#1D1D1F', letterSpacing: '-0.02em' }}>scratch off Generator 🎡</h1>
      ...
      <main className="p-6 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-1/2 flex flex-col gap-6">
            <div className="app-card p-6 shadow-sm border border-gray-100 bg-white">
                <h2 className="text-xl font-bold font-outfit mb-4 text-gray-900">Configure Scratch Off</h2>
        ...
        <div className="w-full md:w-1/2">
            <div className="p-8 h-full flex flex-col items-center justify-center relative overflow-hidden bg-white border border-gray-200 shadow-sm">
                ...
                <div className="w-full max-w-sm border border-dashed border-gray-300 p-6 rounded-xl text-center bg-gray-50">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">scratch off!</h3>
                    <p className="text-sm text-gray-600 mb-4">Enter your email to scratch the card.</p>
                    ...
                    <button className="w-full py-2 bg-[#0071E3] text-white font-bold rounded-lg shadow-sm" disabled>SCRATCH NOW</button>
                </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-[30px] saturate-[210%]">
            <div className="app-card p-8 max-w-xl w-full shadow-2xl relative animate-in fade-in bg-white">
                ...
                <h2 className="text-2xl font-bold font-outfit mb-2 text-gray-900">Embed scratch off</h2>
