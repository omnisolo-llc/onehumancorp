                ...
                {predictions.map((prediction) => (
                  <div key={prediction.id} className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between p-4 border border-[var(--border-subtle)] rounded-xl bg-white/40" data-testid={`prep-card-${prediction.id}`}>
                    ...
                    <div className="flex items-center gap-4 w-full sm:w-auto mt-2 sm:mt-0">
                      <div className="flex items-center border border-[var(--border-subtle)] rounded-[8px] overflow-hidden bg-white/80 w-full sm:w-auto">
                        <button
                      ...
                      <button
                        className="app-btn primary min-h-[44px] rounded-[8px] px-6 font-semibold bg-[#0066FF] hover:bg-[#0052cc] text-white transition-colors cursor-pointer w-full sm:w-auto"
