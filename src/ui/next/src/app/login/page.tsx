...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4 font-outfit">
      <div className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto overflow-hidden flex flex-col p-8 sm:p-12 relative rounded-[24px] macos-translucent-glass border border-white/20 shadow-2xl">
        ...
        <div className="flex flex-col gap-4 mb-8">
          <input
            ...
            className="w-full p-4 rounded-[8px] focus:border-[#0066FF] outline-none macos-translucent-glass text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all shadow-inner"
          />
          <input
            type="password"
