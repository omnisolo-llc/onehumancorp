    ...
    <div className="flex flex-col min-h-screen font-inter" style={{ backgroundColor: '#F5F5F7' }}>
      ...
      <main className="p-6 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button onClick={() => router.push('/cost-dashboard')} className="p-4 mac-glass-container border border-gray-200 rounded-xl hover:bg-gray-50 text-left transition-colors">
            ...
            <button onClick={() => router.push('/pricing')} className="p-4 mac-glass-container border border-gray-200 rounded-xl hover:bg-gray-50 text-left transition-colors">
            ...
            <button className="p-4 mac-glass-container border border-gray-200 rounded-xl hover:bg-gray-50 text-left transition-colors">
