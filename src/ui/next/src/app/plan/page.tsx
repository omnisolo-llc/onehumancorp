  ...
  return (
    <div className="flex flex-col min-h-screen font-inter" style={{ backgroundColor: '#F5F5F7' }}>
      ...
      <main id="my-plan-screen" className="p-6 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        {/* Status Snapshot */}
        <section className="p-8 shadow-sm flex flex-col md:flex-row gap-6" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(20px) saturate(200%)', border: '1px solid rgba(255, 255, 255, 0.2)', borderRadius: '16px', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.05)' }}>
            ...
            <div className="flex flex-col justify-center w-full md:w-auto">
                <button onClick={() => router.push('/pricing')} className="w-full md:w-48 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors shadow-sm" style={{ backdropFilter: 'blur(20px)' }}>
                    Upgrade Plan
                </button>
            </div>
        </section>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button onClick={() => router.push('/cost-dashboard')} className="p-4 border border-gray-200 rounded-xl hover:bg-white/80 text-left transition-colors shadow-sm" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(20px) saturate(200%)' }}>
            ...
            <button onClick={() => router.push('/pricing')} className="p-4 border border-gray-200 rounded-xl hover:bg-white/80 text-left transition-colors shadow-sm" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(20px) saturate(200%)' }}>
            ...
            <button className="p-4 border border-gray-200 rounded-xl hover:bg-white/80 text-left transition-colors shadow-sm" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(20px) saturate(200%)' }}>
