...
export default function MyPlanPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-inter bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900">
      <header className="px-4 md:px-6 py-4 flex flex-col md:flex-row items-center justify-between border-b gap-4 sticky top-0 z-50 shadow-sm" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', borderBottom: '1px solid rgba(255, 255, 255, 0.4)' }}>
        ...
        <div className="flex flex-wrap justify-center gap-2">
            <button onClick={() => router.push('/dashboard')} className="min-w-[44px] min-h-[44px] px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-xl text-sm font-medium transition-colors shadow-sm flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1">
            Back to Dashboard
            </button>
            <button onClick={() => router.push('/pricing')} className="min-w-[44px] min-h-[44px] px-4 py-2 bg-indigo-600 text-white rounded-xl text-sm font-medium hover:bg-indigo-700 transition-colors shadow-sm flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            View Upgrade Plans
            </button>
        </div>
      </header>
      ...
      <main id="my-plan-screen" className="p-4 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        <section className="app-panel w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col justify-center">
                    <button onClick={() => router.push('/pricing')} className="w-full min-h-[44px] py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors shadow-sm flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        Upgrade Plan
                    </button>
                </div>
            </div>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            <button onClick={() => router.push('/cost-dashboard')} className="p-4 min-h-[44px] rounded-xl hover:-translate-y-1 hover:shadow-md text-left transition-all duration-300" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 255, 255, 0.4)' }}>
            ...
            <button onClick={() => router.push('/pricing')} className="p-4 min-h-[44px] rounded-xl hover:-translate-y-1 hover:shadow-md text-left transition-all duration-300" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 255, 255, 0.4)' }}>
            ...
            <button
                ...
                className="p-4 min-h-[44px] rounded-xl shadow-sm hover:-translate-y-1 hover:shadow-md text-left transition-all duration-300" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 255, 255, 0.4)' }}
            >
            ...
            <button
                ...
                className="p-4 min-h-[44px] rounded-xl shadow-sm hover:-translate-y-1 hover:shadow-md text-left transition-all duration-300" style={{ background: 'rgba(255, 240, 240, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 200, 200, 0.4)' }}
            >
