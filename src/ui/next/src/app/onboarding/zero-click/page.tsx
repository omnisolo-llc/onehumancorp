    ...
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8 font-outfit selection:bg-indigo-100 selection:text-indigo-900">
      <div className="w-full max-w-2xl">
        ...
        {!generatedStore ? (
          ...
          <div className="glassmorphism translucent-glass-light dark:translucent-glass-dark  p-8 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-6">
              <div className="w-full h-[500px] translucent-glass-light dark:translucent-glass-dark overflow-hidden relative">
                <iframe
