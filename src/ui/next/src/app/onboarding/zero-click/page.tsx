    ...
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8 font-outfit selection:bg-indigo-100 selection:text-indigo-900">
      <div className="w-full max-w-2xl">
        ...
        {!generatedStore ? (
          ...
          <div className=" bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] backdrop-saturate-[210%] border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] p-8 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500 rounded-[16px]">
