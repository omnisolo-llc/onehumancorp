                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none glass-control translucent-glass-light dark:translucent-glass-dark rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === "Business Name must be at least 3 characters." ? "border-[#FF3B30]" : "border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] focus:ring-4 focus:ring-[#0066FF]/20"} min-h-[44px]`}
                        inputMode="text"
                        enterKeyHint="next"
                      />
                    </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none glass-control translucent-glass-light dark:translucent-glass-dark rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === "Please tell us your location." ? "border-[#FF3B30]" : "border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] focus:ring-4 focus:ring-[#0066FF]/20"} min-h-[44px]`}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none glass-control translucent-glass-light dark:translucent-glass-dark rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === "Please tell us your target audience." ? "border-[#FF3B30]" : "border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] focus:ring-4 focus:ring-[#0066FF]/20"} min-h-[44px]`}
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 border ${validationErrors.businessName ? "border-[#FF3B30]" : "border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] focus:ring-4 focus:ring-[#0066FF]/20"} outline-none glass-control translucent-glass-light dark:translucent-glass-dark rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                  />
                  {validationErrors.businessName && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 sm:p-4 border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] focus:ring-4 focus:ring-[#0066FF]/20 outline-none glass-control translucent-glass-light dark:translucent-glass-dark rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 sm:p-4 border ${validationErrors.firstProductPrice ? "border-[#FF3B30]" : "border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] focus:ring-4 focus:ring-[#0066FF]/20"} outline-none glass-control translucent-glass-light dark:translucent-glass-dark rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                    />
