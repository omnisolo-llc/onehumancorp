                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] backdrop-saturate-[210%] border border-white/40 dark:border-white/10 rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === "Business Name must be at least 3 characters." || validationErrors.businessName ? "border-[#FF3B30]" : "border-white/40 dark:border-white/10 focus:border-[#0066FF]"} min-h-[44px]`}
                        inputMode="text"
                        enterKeyHint="next"
                      />
                    </div>
                    ...
                    <button
                      onClick={() => {
                        if (!whatYouSell.trim()) {
                          ...
                          setValidationErrors((prev) => ({
                            ...prev,
                            whatYouSell: "Please tell us what you sell.",
                          }));
                          return;
                        }
                        setValidationError("");
                        setValidationErrors((prev) => {
                          const { whatYouSell, ...rest } = prev;
                          return rest;
                        });
                        updateState({ chatStep: 3 });
                        syncStateToBackend({ chatStep: 3 });
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] backdrop-saturate-[210%] border border-white/40 dark:border-white/10 rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === "Please tell us your location." || validationErrors.location ? "border-[#FF3B30]" : "border-white/40 dark:border-white/10 focus:border-[#0066FF]"} min-h-[44px]`}
                      />
                    </div>
                  </div>
                    ...
                    <button
                      onClick={() => {
                        if (!location.trim()) {
                          ...
                          setValidationErrors((prev) => ({
                            ...prev,
                            location: "Please tell us your location.",
                          }));
                          return;
                        }
                        setValidationError("");
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none bg-white/65 dark:bg-[#16161a]/70 backdrop-blur-[30px] backdrop-saturate-[210%] rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === "Please tell us your target audience." || validationErrors.targetAudience ? "border-[#FF3B30]" : "border-white/40 dark:border-white/10 focus:border-[#0066FF]"} min-h-[44px]`}
                      />
                    </div>
                  </div>
