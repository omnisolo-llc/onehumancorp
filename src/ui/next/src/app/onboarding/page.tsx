...
export default function OnboardingWizard() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-fixed">
      ...
      <div id="setup-screen" className="w-full sm:max-w-[414px] mx-auto mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 sm:rounded-[16px] shadow-2xl overflow-hidden flex flex-col h-[100dvh] sm:h-[700px] relative border border-white/40 dark:border-white/10 transition-all duration-500">
        {/* Progress Bar */}
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className="w-full p-3 sm:p-4 rounded-[8px] border border-white/50 dark:border-white/10 focus:border-[#0066FF] outline-none mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all shadow-inner"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <textarea
                        ...
                        className="w-full p-3 sm:p-4 rounded-[8px] border border-white/50 dark:border-white/10 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-[#F5F5F7] h-32 resize-none transition-all shadow-inner"
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.businessName ? 'border-red-500' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.businessType ? 'border-red-500' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 sm:p-4 rounded-[8px] border border-white/50 dark:border-white/10 focus:border-[#0066FF] outline-none mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-[#F5F5F7]"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2">
                   ...
                   <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.firstProductPrice ? 'border-red-500' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
          ...
          {step === 3 && (
            <div className="flex flex-col flex-1 animate-fade-in">
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2 hide-scrollbar">
                    ...
                    {['Sales Agent', 'Support Agent', 'Marketing Agent'].map(agent => {
                       ...
                       return (
                         <div
                           ...
                           className={`p-3 rounded-[8px] border cursor-pointer flex items-center justify-between transition-all ${isSelected ? 'border-[#0066FF] bg-[#0066FF]/10 text-[#0066FF]' : 'border-white/50 dark:border-white/10 mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-white'}`}
                         >
                ...
                <div className="pt-2">
                  <label className="flex items-center justify-between cursor-pointer p-3 rounded-[8px] border border-white/50 dark:border-white/10 mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-white">
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                <div className="p-3 mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 rounded-[8px] border border-white/50 dark:border-white/10 flex flex-col items-center mb-6">
                ...
                <a
                  href="/builder"
                  className="block w-full mac-glass-container backdrop-blur-[20px] saturate-[200%] bg-white/70 text-[#1D1D1F] dark:text-[#F5F5F7] border border-white/50 dark:border-white/10 p-4 rounded-[8px] font-bold shadow-sm  active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
                  Preview Storefront
                </a>
              </div>
