...
export default function OnboardingWizard() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-[#000] font-inter">
      ...
      `}} />
      <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] sm:rounded-[16px] overflow-hidden glass-container">
        {/* Header */}
        ...
        <div className="flex-1 p-6 overflow-y-auto z-10 flex flex-col">
          ...
          {step === 3 && intakeData && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <div className="bg-white/80 p-5 rounded-[8px] border border-gray-100 shadow-sm mb-6 space-y-3">
                <div>
