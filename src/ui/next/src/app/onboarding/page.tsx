    ...
    Promise.all([
      ...
      .then(([draftData, stateData]) => {
        ...
        if (data && data.wizardState) {
          ...
          if (data.wizardState.targetAudience)
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (err.message === "Failed to fetch") {
                        ...
                        setError(
                          err.message || "Failed to launch. Please try again.",
                        );
                      }
                    } finally {
                      setIsLoading(false);
                ...
                >
                  {isLoading ? (
                    <span className="flex items-center justify-center gap-2">
                      <svg
                        className="animate-spin h-5 w-5 text-white backdrop-filter backdrop-blur-md rounded-full shadow-[0_0_10px_rgba(255,255,255,0.5)]"
                        fill="none"
                        viewBox="0 0 24 24"
                      >
                        <circle
