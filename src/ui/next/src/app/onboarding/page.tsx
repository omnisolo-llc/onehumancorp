...
export default function OnboardingWizard() {
  ...
  return (
    <div className="setup-page min-h-screen w-full bg-[#F5F5F7] dark:bg-[#16161a] flex items-center justify-center p-4 font-inter">
      <div id="setup-screen" className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto overflow-hidden flex flex-col min-h-[100vh] sm:min-h-[812px] relative glass-vibrant shadow-[0_18px_44px_rgba(15,23,42,0.12)]">
        ...
        <div className="p-6 flex-1 flex flex-col overflow-y-auto custom-scrollbar">
          ...
          {step === 0 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                <button
                  type="button"
                  className="w-full glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] p-4 font-bold shadow-sm active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] rounded-[8px]"
          ...
          {step === -2 && (
            <div className="flex flex-col flex-1 animate-fade-in w-full h-full max-h-full">
              ...
              <div className="flex flex-col flex-1 gap-4 overflow-hidden w-full max-w-full">
                <div id="chat-messages" className="glass-control rounded-[8px] flex-1 overflow-y-auto p-4 text-[#1D1D1F] dark:text-[#F5F5F7] text-left space-y-4">
                ...
                <div className="flex flex-col gap-2 shrink-0">
                  <input
                    ...
                    className="glass-control rounded-[8px] w-full p-3 text-[#1D1D1F] dark:text-[#F5F5F7] outline-none transition-all duration-[250ms] border border-white/20 focus:border-[#0066FF] min-h-[44px]"
                  ...
                  <div className="flex gap-2 w-full">
                    <input
                      ...
                      className="glass-control rounded-[8px] w-full p-3 text-[#1D1D1F] dark:text-[#F5F5F7] outline-none flex-1 transition-all duration-[250ms] border border-white/20 focus:border-[#0066FF] min-h-[44px]"
            ...
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex flex-col gap-4 w-full">
                <textarea
                  ...
                  className={`glass-control rounded-[8px] w-full p-4 text-[#1D1D1F] dark:text-[#F5F5F7] outline-none transition-all duration-[250ms] ${error === "Please tell us about your business." || error ? "border border-[#FF3B30]" : "border border-white/20 focus:border-[#0066FF]"}`}
                ...
                <input
                  ...
                  type="url"
                  className="glass-control rounded-[8px] w-full p-4 text-[#1D1D1F] dark:text-[#F5F5F7] outline-none border border-white/20 focus:border-[#0066FF] transition-all duration-[250ms] rounded-[8px] min-h-[44px]"
                  placeholder="Image URL (Optional)"
                  value={instantImageUrl}
                  onChange={(e) => updateState({ instantImageUrl: e.target.value })}
                  inputMode="url"
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === 'Business Name must be at least 3 characters.' ? 'border-[#FF3B30]' : 'border-white/40 dark:border-white/10 focus:border-[#0066FF]'} min-h-[44px]`}
                        inputMode="text"
                        enterKeyHint="next"
                      />
                    </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === 'Please tell us your location.' ? 'border-[#FF3B30]' : 'border-white/40 dark:border-white/10 focus:border-[#0066FF]'} min-h-[44px]`}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === 'Please tell us your target audience.' ? 'border-[#FF3B30]' : 'border-white/40 dark:border-white/10 focus:border-[#0066FF]'} min-h-[44px]`}
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 border ${validationErrors.businessName ? 'border-[#FF3B30]' : 'border-white/40 dark:border-white/10 focus:border-[#0066FF]'} outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 border ${validationErrors.businessType ? 'border-[#FF3B30]' : 'border-white/40 dark:border-white/10 focus:border-[#0066FF]'} outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 sm:p-4 border border-white/40 dark:border-white/10 focus:border-[#0066FF] outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2">
                   ...
                   <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border ${validationErrors.firstProductPrice ? 'border-[#FF3B30]' : 'border-white/40 dark:border-white/10 focus:border-[#0066FF]'} outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                      />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['Modern', 'Minimal', 'Bold', 'Classic'].map(template => (
                      <div
                        ...
                        className={`p-3 border cursor-pointer transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${websiteTemplate === template ? 'border-[#0066FF] bg-[#0066FF]/10 text-[#0066FF]' : 'border-white/50 dark:border-white/10 glass-control rounded-[8px] hover:border-gray-400 dark:hover:border-gray-500 text-[#1D1D1F] dark:text-white'}`}
                      >
                  ...
                  <div className="space-y-3 mb-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 border ${validationErrors.adminName ? "border-[#FF3B30]" : "border-white/40 dark:border-white/10 focus:border-[#0066FF]"} outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                        inputMode="text"
                        enterKeyHint="next"
                      />
                    ...
                    className={`w-full p-3 sm:p-4 border ${validationErrors.adminEmail ? "border-[#FF3B30]" : "border-white/40 dark:border-white/10 focus:border-[#0066FF]"} outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                  />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                        className={`w-full p-3 sm:p-4 border ${validationErrors.adminPassword ? "border-[#FF3B30]" : "border-white/40 dark:border-white/10 focus:border-[#0066FF]"} outline-none glass-control rounded-[8px] text-[#1D1D1F] dark:text-[#F5F5F7] min-h-[44px]`}
                      />
          ...
          {step === 4 && (
             <div aria-live="polite" className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in glass-control shadow-2xl p-8">
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                <div className="p-3 glass-control rounded-[8px] flex flex-col items-center mb-6">
