...
export default function OnboardingWizard() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-[#000] font-inter">
      ...
      `}} />
      <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] sm:min-h-[812px] shadow-2xl flex flex-col relative rounded-[16px] overflow-hidden glass-container">
        {/* Header */}
          ...
          {step === 1 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <input
                ...
                className="w-full p-4 rounded-[8px] border border-white/50 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-lg mb-4 bg-white/40 backdrop-blur-md shadow-sm"
                autoFocus
                enterKeyHint="next"
                autoComplete="off"
              />
              <button
                onClick={handleNext}
                className="w-full bg-gradient-to-r from-[#0066FF] to-[#0052cc] text-white p-4 rounded-[8px] font-bold shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
              >
                Next
              </button>
            </div>
          ...
          {step === 2 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setStep(1)}
                  className="px-6 py-4 rounded-[8px] font-bold bg-white/50 backdrop-blur-sm text-gray-700 hover:bg-white/70 shadow-sm border border-white/40 transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
                  Back
                </button>
                <button
                  onClick={handleNext}
                  className="flex-1 bg-gradient-to-r from-[#0066FF] to-[#0052cc] text-white p-4 rounded-[8px] font-bold shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
                  Next
                </button>
              </div>
            ...
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-gradient-to-r from-[#0066FF] to-[#0052cc] text-white p-4 rounded-[8px] font-bold shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] disabled:opacity-70 flex justify-center items-center"
                >
                  {isLoading ? (
            ...
            <div className="flex flex-col flex-1 justify-start animate-fade-in pb-8">
                   ...
                   <div className="flex gap-3">
                     <div className="flex-1">
                       ...
                       <input
                         ...
                         className="w-full p-3 rounded-[8px] border border-white/50 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none bg-white/60 backdrop-blur-sm text-gray-900 shadow-inner transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                   ...
                   <div className="grid grid-cols-2 gap-3">
                     {['Modern', 'Elegant', 'Playful', 'Minimal'].map((t) => (
                       <button
                         ...
                         className={`p-3 rounded-[8px] border ${template === t ? 'border-[#0066FF] bg-white/70 backdrop-blur-md text-[#0066FF] font-bold shadow-sm' : 'border-white/50 bg-white/40 backdrop-blur-md text-gray-700 hover:border-white/80'} transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-sm`}
                       >
                         {t}
                       </button>
                     ))}
                ...
                <div className="space-y-3">
                   ...
                   <div className="flex flex-col gap-3">
                     <button
                       ...
                       className={`p-4 rounded-[8px] border flex justify-between items-center ${domain === 'free' ? 'border-[#0066FF] bg-white/70 backdrop-blur-md text-[#0066FF] font-bold shadow-sm' : 'border-white/50 bg-white/40 backdrop-blur-md text-gray-700 hover:border-white/80'} transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-sm`}
                     >
                     ...
                     <button
                       ...
                       className={`p-4 rounded-[8px] border flex justify-between items-center ${domain === 'custom' ? 'border-[#0066FF] bg-white/70 backdrop-blur-md text-[#0066FF] font-bold shadow-sm' : 'border-white/50 bg-white/40 backdrop-blur-md text-gray-700 hover:border-white/80'} transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-sm`}
                     >
              ...
              <div className="flex gap-3 mt-auto">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-gradient-to-r from-[#34C759] to-[#2eb350] text-white p-4 rounded-[8px] font-bold shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] disabled:opacity-70 flex justify-center items-center"
                >
                  {isLoading ? (
                    <span className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></span>
                  ) : (
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                ...
                <a
                  href="/builder"
                  className="block w-full bg-white/70 backdrop-blur-md text-[#1D1D1F] border border-white/50 p-4 rounded-[8px] font-bold shadow-sm hover:bg-white/90 active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
                  Preview Storefront
                </a>
              </div>
