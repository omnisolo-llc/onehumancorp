...
export default function OnboardingWizard() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] dark:from-[#000000] dark:to-[#1a1a1a] flex items-center justify-center p-4">
      <div id="setup-screen" className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto overflow-hidden flex flex-col min-h-[640px] sm:min-h-[812px] relative rounded-[24px] bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 border border-white/20 shadow-2xl">
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className="w-full p-3 sm:p-4 rounded-[8px] focus:border-[#0066FF] outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all shadow-inner"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <textarea
                        ...
                        className="w-full p-3 sm:p-4 rounded-[8px] focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7] h-32 resize-none transition-all shadow-inner"
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.businessName ? 'border-red-500' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.businessType ? 'border-red-500' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 sm:p-4 rounded-[8px] focus:border-[#0066FF] outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7]"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2">
                   ...
                   <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.firstProductPrice ? 'border-red-500' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
          ...
          {step === 3 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2 hide-scrollbar">
                  ...
                  <div className="space-y-3 mb-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.adminName ? "border-red-500" : "border-white/50 dark:border-white/10 focus:border-[#0066FF]"} outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.adminEmail ? "border-red-500" : "border-white/50 dark:border-white/10 focus:border-[#0066FF]"} outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.adminPassword ? "border-red-500" : "border-white/50 dark:border-white/10 focus:border-[#0066FF]"} outline-none bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
                    ...
                    {['Sales Agent', 'Support Agent', 'Marketing Agent'].map(agent => {
                       ...
                       return (
                         <div
                           ...
                           className={`p-3 rounded-[8px] border cursor-pointer flex items-center justify-between transition-all ${isSelected ? 'border-[#0066FF] bg-[#0066FF]/10 text-[#0066FF]' : 'border-white/50 dark:border-white/10 bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-white'}`}
                         >
                ...
                <div className="pt-2">
                  <label className="flex items-center justify-between cursor-pointer p-3 rounded-[8px] bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-white">
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                <div className="p-3 bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 rounded-[8px] flex flex-col items-center mb-6">
                ...
                <a
                  href="/builder"
                  className="flex w-full items-center justify-center bg-white/40 dark:bg-black/40 backdrop-filter backdrop-blur-xl backdrop-saturate-200 text-[#1D1D1F] dark:text-[#F5F5F7] p-4 rounded-[8px] font-bold shadow-sm active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
