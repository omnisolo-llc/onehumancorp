                ...
                <div className="space-y-4 flex-1">
                  <div>
                    <textarea
                      ...
                      placeholder="e.g. I bake custom vegan cakes for weddings and parties. My business is called Maya's Custom Cakes and I am located in Portland, OR."
                      className="w-full p-4 rounded-[12px] border border-white/50 dark:border-white/10 focus:border-[#0066FF] outline-none mac-glass-container text-[#1D1D1F] dark:text-[#F5F5F7] h-48 resize-none transition-all shadow-inner"
                    />
                  </div>
                </div>
