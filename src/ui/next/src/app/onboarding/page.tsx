          ...
          <div className="setup-header-main">
            {showIntroBack ? (
              <button
                ...
                className="min-h-[44px] min-w-[44px] setup-nav-button"
              >
                Back
              </button>
            ) : (
          ...
          {step === -2 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex flex-col gap-4 w-full">
                <button
                  className="min-h-[44px] min-w-[44px] w-full bg-[#0066FF] text-white p-4 font-bold shadow-[0_4px_14px_0_rgba(0,102,255,0.39)] hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] rounded-[8px]"
                  onClick={() => {
                    updateState({ step: 1 });
                    syncStateToBackend({ step: 1 });
                  }}
          ...
          {step === 0 && (
            <div className="flex flex-col flex-1 animate-fade-in w-full h-full max-h-full">
              ...
              <div className="flex flex-col flex-1 gap-4 overflow-hidden w-full max-w-full">
                <div
                  id="chat-messages"
                  className="bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] backdrop-saturate-[210%] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] rounded-[16px] flex-1 overflow-y-auto p-4 text-[#1D1D1F] dark:text-[#F5F5F7] text-left space-y-4"
                >
                ...
                <div className="flex flex-col gap-2 shrink-0">
                  ...
                  <div className="flex gap-2 w-full">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="min-h-[44px] min-w-[44px] bg-[#0066FF] text-white font-bold shadow-[0_4px_14px_0_rgba(0,102,255,0.39)] hover:bg-[#005bb5] active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] px-4 shrink-0 disabled:opacity-50 rounded-[8px]"
                    >
                      Send
                    </button>
                  </div>
            ...
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                <input
                  ...
                  type="url"
                  className="bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] backdrop-saturate-[210%] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] rounded-[8px] min-h-[44px] min-w-[44px]"
                  placeholder="Image URL (Optional)"
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="min-h-[44px] min-w-[44px] w-full bg-[#0066FF] text-white p-4 font-bold shadow-[0_4px_14px_0_rgba(0,102,255,0.39)] hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] disabled:opacity-50 disabled:cursor-not-allowed rounded-[8px]"
                  >
                    Next
                  </button>
                </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2 hide-scrollbar">
                ...
                <div className="pt-2">
                  <label className="flex items-center justify-between cursor-pointer p-3 bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] backdrop-saturate-[210%] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] rounded-[8px] text-[#1D1D1F] dark:text-white">
                    ...
                    <input
                      type="checkbox"
                      className="min-h-[44px] min-w-[44px] sr-only"
