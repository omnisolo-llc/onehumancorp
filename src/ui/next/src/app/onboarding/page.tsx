...
export default function OnboardingWizard() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F5F5F7] dark:bg-[#16161a] flex items-center justify-center p-4">
      <div id="setup-screen" className="w-full sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto overflow-hidden flex flex-col min-h-[640px] sm:min-h-[812px] relative rounded-[16px] glass-panel border border-white/20 shadow-2xl">
        ...
        <div className="p-6 flex-1 flex flex-col overflow-y-auto custom-scrollbar">
          ...
          {step === 0 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                <button
                  className="w-full glass-panel text-[#0066FF] border border-[#0066FF] p-4 font-bold rounded-[8px] shadow-sm hover:bg-blue-50 transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === 'Business Name must be at least 3 characters.' ? 'border-[#FF3B30]' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'}`}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === 'Please tell us your location.' ? 'border-[#FF3B30]' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'}`}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] shadow-inner ${validationError === 'Please tell us your target audience.' ? 'border-[#FF3B30]' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'}`}
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.businessName ? 'border-[#FF3B30]' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.businessType ? 'border-[#FF3B30]' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7]`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 sm:p-4 rounded-[8px] focus:border-[#0066FF] outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7]"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2">
                   ...
                   <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.firstProductPrice ? 'border-[#FF3B30]' : 'border-white/50 dark:border-white/10 focus:border-[#0066FF]'} outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
          ...
          {step === 3 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2 hide-scrollbar">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['Modern', 'Minimal', 'Bold', 'Classic'].map(template => (
                      <div
                        ...
                        className={`p-3 rounded-[8px] border cursor-pointer transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${websiteTemplate === template ? 'border-[#0066FF] bg-[#0066FF]/10 text-[#0066FF]' : 'border-white/50 dark:border-white/10 glass-panel hover:border-gray-400 dark:hover:border-gray-500 text-[#1D1D1F] dark:text-white'}`}
                      >
                  ...
                  <div className="space-y-3 mb-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.adminName ? "border-[#FF3B30]" : "border-white/50 dark:border-white/10 focus:border-[#0066FF]"} outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        inputMode="email"
                        enterKeyHint="next"
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.adminEmail ? "border-[#FF3B30]" : "border-white/50 dark:border-white/10 focus:border-[#0066FF]"} outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                        className={`w-full p-3 sm:p-4 rounded-[8px] border ${validationErrors.adminPassword ? "border-[#FF3B30]" : "border-white/50 dark:border-white/10 focus:border-[#0066FF]"} outline-none glass-panel min-h-[44px] min-w-[44px] text-[#1D1D1F] dark:text-[#F5F5F7]`}
                      />
                ...
                <div className="pt-2">
                  <label className="flex items-center justify-between cursor-pointer p-3 rounded-[8px] glass-panel text-[#1D1D1F] dark:text-white">
          ...
          {step === 4 && (
             <div aria-live="polite" className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in glass-panel rounded-[16px] shadow-2xl p-8">
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                <div className="p-3 glass-panel rounded-[8px] flex flex-col items-center mb-6">
                ...
                <a
                  href="/assistant"
                  className="flex w-full items-center justify-center glass-panel text-[#1D1D1F] dark:text-[#F5F5F7] p-4 rounded-[8px] font-bold shadow-md hover:border-gray-400 dark:hover:border-gray-500 active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
                  <IconLabel icon="sparkles">Open Assistant</IconLabel>
                </a>
                <a
                  href="/builder"
                  className="flex w-full items-center justify-center glass-panel text-[#1D1D1F] dark:text-[#F5F5F7] p-4 rounded-[8px] font-bold shadow-sm active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
