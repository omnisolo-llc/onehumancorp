    ...
    try {
      ...
      const startRes = await fetch('/api/onboarding/start', {
        ...
        body: JSON.stringify({
          ...
          selling_categories: intakeData.categories || ['products'],
          payment_pref: 'online',
          admin_email: adminEmail || `admin-${Math.random().toString(36).substring(2, 8)}@ohc.app`,
          admin_name: (intakeData.business_name || 'My Business') + ' Admin',
          admin_password: adminPassword || Math.random().toString(36).slice(-8) + Math.random().toString(36).slice(-8) + '!',
        ...
        <div className="p-6 flex-1 flex flex-col overflow-y-auto custom-scrollbar">
          ...
          {step === 1 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in w-full">
              ...
              <h2 className="text-3xl font-bold font-outfit text-[#1D1D1F] dark:text-[#F5F5F7] mb-2 text-center">Tell us about your business</h2>
              <p className="text-gray-500 dark:text-[#A1A1A6] text-sm mb-8 text-center">
