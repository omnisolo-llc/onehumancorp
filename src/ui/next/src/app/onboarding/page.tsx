...
export default function OnboardingWizard() {
  ...
  const handleIntakeClick = () => {
    if (!businessDescription || businessDescription.trim().length === 0) return;
    handleIntake();
  };
            ...
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <div className="space-y-4 flex-1">
                <textarea
                  ...
                  className="w-full p-4 rounded-[8px] border border-[rgba(255,255,255,0.4)] dark:border-white/10 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none bg-white/60 dark:bg-black/30 backdrop-blur-sm text-[#1D1D1F] dark:text-[#F5F5F7] h-32 resize-none transition-all shadow-inner"
                />
              </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 rounded-[8px] border border-[rgba(255,255,255,0.4)] dark:border-white/10 focus:border-[#0066FF] outline-none bg-white/60 dark:bg-black/30 backdrop-blur-sm text-[#1D1D1F] dark:text-[#F5F5F7]"
                  />
                </div>
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['Modern', 'Minimal', 'Bold', 'Classic'].map(template => (
                      <div
                        ...
                        className={`p-3 rounded-[8px] border cursor-pointer transition-all ${websiteTemplate === template ? 'border-[#0066FF] bg-[#0066FF]/10 text-[#0066FF]' : 'border-[rgba(255,255,255,0.4)] dark:border-white/10 bg-white/60 dark:bg-black/30 hover:border-gray-400 dark:hover:border-gray-500 text-[#1D1D1F] dark:text-white'}`}
                      >
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                <div className="p-3 bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-[8px] border border-[rgba(255,255,255,0.4)] dark:border-white/10 flex flex-col items-center mb-6">
                ...
                <a
                  href="/builder"
                  className="block w-full bg-white/70 dark:bg-white/10 backdrop-blur-md text-[#1D1D1F] dark:text-[#F5F5F7] border border-[rgba(255,255,255,0.4)] dark:border-white/10 p-4 rounded-[8px] font-bold shadow-sm hover:bg-white/90 dark:hover:bg-white/20 active:scale-[0.98] transition-all"
                >
                  Preview Storefront
                </a>
              </div>
