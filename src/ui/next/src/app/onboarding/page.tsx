  ...
  return (
    <div className="setup-page min-h-screen w-full bg-[#F5F5F7] dark:bg-[#16161a] flex items-center justify-center sm:p-4 font-inter overflow-x-hidden">
      ...
      >
        ...
        {error && (
          <div className="absolute top-4 left-4 right-4 z-[9999] glassmorphism border border-[#FF3B30]/50 text-[#FF3B30] p-3 rounded-[8px] text-sm font-semibold shadow-lg flex items-center gap-2 animate-shake">
            <svg
          ...
          {step === 0 && (
            <div className="flex flex-col flex-1 animate-fade-in w-full h-full max-h-full glassmorphism  p-4">
              ...
              <div className="flex flex-col flex-1 gap-4 overflow-hidden w-full max-w-full">
                <div
                  id="chat-messages"
                  className="glassmorphism border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] flex-1 overflow-y-auto p-4 text-[#1D1D1F] dark:text-[#F5F5F7] text-left space-y-4"
                >
