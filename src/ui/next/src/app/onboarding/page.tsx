          ...
          {step === 1 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <input
                ...
                className="w-full p-4 rounded-[12px] border border-white/50 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none transition-all text-lg mb-4 bg-white/30 backdrop-blur-xl border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] shadow-sm"
                autoFocus
                enterKeyHint="next"
                autoComplete="off"
              />
          ...
          {step === 4 && intakeData && (
            <div className="flex flex-col flex-1 justify-start animate-fade-in pb-8">
              ...
              <div className="space-y-6 flex-1 overflow-visible">
                {/* Product Section */}
                <div className="bg-white/30 backdrop-blur-xl border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] p-5 rounded-[16px] border border-white/50 shadow-sm space-y-3">
                   ...
                   <div className="flex gap-3">
                     <div className="flex-1">
                       ...
                       <input
                         ...
                         className="w-full p-3 rounded-[10px] border border-white/50 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none bg-white/30 backdrop-blur-xl border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] text-gray-900 shadow-inner transition-all"
                   ...
                   <div className="grid grid-cols-2 gap-3">
                     {['Modern', 'Elegant', 'Playful', 'Minimal'].map((t) => (
                       <button
                         ...
                         className={`p-3 rounded-[12px] border ${template === t ? 'border-[#0066FF] bg-white/70 backdrop-blur-md text-[#0066FF] font-bold shadow-sm' : 'border-white/50 bg-white/30 backdrop-blur-xl border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] text-gray-700 hover:border-white/80'} transition-all text-sm`}
                       >
                         {t}
                       </button>
                     ))}
                ...
                <div className="space-y-3">
                   ...
                   <div className="flex flex-col gap-3">
                     <button
                       ...
                       className={`p-4 rounded-[12px] border flex justify-between items-center ${domain === 'free' ? 'border-[#0066FF] bg-white/70 backdrop-blur-md text-[#0066FF] font-bold shadow-sm' : 'border-white/50 bg-white/30 backdrop-blur-xl border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] text-gray-700 hover:border-white/80'} transition-all text-sm`}
                     >
                     ...
                     <button
                       ...
                       className={`p-4 rounded-[12px] border flex justify-between items-center ${domain === 'custom' ? 'border-[#0066FF] bg-white/70 backdrop-blur-md text-[#0066FF] font-bold shadow-sm' : 'border-white/50 bg-white/30 backdrop-blur-xl border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] text-gray-700 hover:border-white/80'} transition-all text-sm`}
                     >
