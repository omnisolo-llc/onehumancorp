            ...
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex items-center justify-between mb-6 w-full">
                <p className="text-gray-500 dark:text-[#A1A1A6] text-sm text-center">
                  Tell us about your business, and our AI will instantly generate your storefront, products, and back-office agents in 30 seconds.
                </p>
              </div>
              ...
              <div className="space-y-4 flex-1 w-full">
                <textarea
                  ...
                  className={`w-full glassmorphism min-h-[44px] min-w-[44px] p-4 border outline-none transition-all resize-none text-gray-800 dark:text-[#f5f5f7] shadow-inner rounded-[8px] ${error ? 'border-[#FF3B30] focus:ring-2 focus:ring-[#FF3B30] focus:border-[#FF3B30]' : 'border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-[#0066FF] focus:border-[#0066FF]'}`}
                  placeholder="e.g. I run a local bakery that sells custom vegan cakes in Austin."
                  rows={6}
                />
              </div>
              ...
              <div className="mt-auto pt-6 w-full flex flex-col gap-2">
                <button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      const res = await fetch('/api/onboarding/zero_click', {
                        method: 'POST',
                        headers: {
                          'Content-Type': 'application/json',
                ...
                <button
                  onClick={() => setStep(1)}
                  className="w-full bg-transparent text-[#0066FF] min-h-[44px] p-2 text-sm font-semibold hover:underline"
                >
