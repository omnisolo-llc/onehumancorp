          ...
          {step === 1 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <input
                ...
                className="w-full p-4 rounded-[8px] border border-white/30 dark:border-white/10 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none transition-all text-lg mb-4 bg-white/20 dark:bg-black/30 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]"
                autoFocus
                enterKeyHint="next"
                autoComplete="off"
              />
          ...
          {step === 4 && intakeData && (
            <div className="flex flex-col flex-1 justify-start animate-fade-in pb-8">
              ...
              <div className="space-y-6 flex-1 overflow-visible">
                {/* Product Section */}
                <div className="bg-white/20 dark:bg-black/30 backdrop-blur-xl p-5 rounded-[16px] border border-white/30 dark:border-white/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] space-y-3">
                   ...
                   <div className="flex gap-3">
                     <div className="flex-1">
                       ...
                       <input
                         ...
                         className="w-full p-3 rounded-[8px] border border-white/30 dark:border-white/10 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none bg-white/40 dark:bg-black/40 backdrop-blur-md text-[#1D1D1F] dark:text-[#F5F5F7] shadow-inner transition-all"
                   ...
                   <div className="grid grid-cols-2 gap-3">
                     {['Modern', 'Elegant', 'Playful', 'Minimal'].map((t) => (
                       <button
                         ...
                         className={`p-3 rounded-[8px] border transition-all text-sm ${template === t ? 'border-[#0066FF] bg-white/40 dark:bg-white/10 backdrop-blur-xl text-[#0066FF] font-bold shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]' : 'border-white/30 dark:border-white/10 bg-white/20 dark:bg-black/30 backdrop-blur-md text-gray-700 hover:scale-[1.02] active:scale-[0.98]'}`}
                       >
                         {t}
                       </button>
                     ))}
                ...
                <div className="space-y-3">
                   ...
                   <div className="flex flex-col gap-3">
                     <button
                       ...
                       className={`p-4 rounded-[8px] border flex justify-between items-center transition-all text-sm ${domain === 'free' ? 'border-[#0066FF] bg-white/40 dark:bg-white/10 backdrop-blur-xl text-[#0066FF] font-bold shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]' : 'border-white/30 dark:border-white/10 bg-white/20 dark:bg-black/30 backdrop-blur-md text-gray-700 hover:scale-[1.02] active:scale-[0.98]'}`}
                     >
                     ...
                     <button
                       ...
                       className={`p-4 rounded-[8px] border flex justify-between items-center transition-all text-sm ${domain === 'custom' ? 'border-[#0066FF] bg-white/40 dark:bg-white/10 backdrop-blur-xl text-[#0066FF] font-bold shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]' : 'border-white/30 dark:border-white/10 bg-white/20 dark:bg-black/30 backdrop-blur-md text-gray-700 hover:scale-[1.02] active:scale-[0.98]'}`}
                     >
