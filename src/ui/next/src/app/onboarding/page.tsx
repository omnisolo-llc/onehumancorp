...
export default function OnboardingWizard() {
  ...
  useEffect(() => {
    ...
    if (step === 1 && chatStep === 1 && !businessDescription) return;
                ...
                <div className="space-y-4 flex-1">
                  <div>
                    <textarea
                      ...
                      className="w-full p-4 rounded-[12px] border border-white/50 dark:border-white/10 focus:border-[#0066FF] outline-none bg-white/60 dark:bg-black/30 backdrop-blur-sm text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all shadow-inner h-48 resize-none"
                    />
                  </div>
                </div>
