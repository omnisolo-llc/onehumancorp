        ...
        <div className="p-6 flex-1 flex flex-col overflow-y-auto custom-scrollbar">
          ...
          {step === 0 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <h2 className="text-3xl font-bold font-outfit text-[#1D1D1F] dark:text-[#F5F5F7] mb-2 text-center">Hi, I'm your OHC assistant.</h2>
              <p className="text-gray-500 dark:text-[#A1A1A6] text-sm text-center mb-8 leading-relaxed max-w-sm">
                Tell me about your business, and I'll build it for you in seconds.
              </p>
              ...
              <div className="flex flex-col gap-4 w-full">
                <textarea
                  ...
                  placeholder="e.g. I'm Carlos, I fix plumbing..."
                  rows={6}
                  style={{ resize: 'none' }}
                  value={bio}
                  onChange={(e) => {
