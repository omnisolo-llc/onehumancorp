    ...
    const syncState = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.error("Failed to sync onboarding state, response not ok:", response.status);
        }
      } catch (err) {
        ...
        <div className="flex-1 p-6 overflow-y-auto z-10 flex flex-col">
          ...
          {step === 1 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <button
                onClick={handleNext}
                className="w-full bg-[#0066FF] text-white p-4 rounded-[8px] font-bold shadow-md hover:bg-[#0052cc] hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
                Next
              </button>
            </div>
          ...
          {step === 2 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleNext}
                  className="flex-1 bg-[#0066FF] text-white p-4 rounded-[8px] font-bold shadow-md hover:bg-[#0052cc] hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
                  Next
                </button>
              </div>
            ...
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-[#0066FF] text-white p-4 rounded-[8px] font-bold shadow-md hover:bg-[#0052cc] hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-70 flex justify-center items-center"
                >
                  {isLoading ? (
            ...
            <div className="flex flex-col flex-1 justify-start animate-fade-in pb-8">
              ...
              <div className="flex gap-3 mt-auto">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-[#34C759] text-white p-4 rounded-[8px] font-bold shadow-md hover:bg-[#2eb350] hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-70 flex justify-center items-center"
                >
                  {isLoading ? (
                    <span className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></span>
                  ) : (
