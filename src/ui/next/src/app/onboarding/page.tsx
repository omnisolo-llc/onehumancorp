...
export default function OnboardingWizard() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter antialiased antialiased flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8">
      <div id="setup-screen" className="w-full max-w-[375px] mx-auto rounded-[24px] shadow-2xl overflow-hidden flex flex-col h-[700px] relative backdrop-blur-[20px] saturate-[200%] bg-white/10 dark:bg-black/20 border border-white/20">
        <div className="p-6 flex-1 flex flex-col overflow-y-auto">
          ...
          {step === 1 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
              ...
              <h2 className="text-3xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">Tell us about your business</h2>
              ...
              {chatStep === 1 && (
                <div className="flex flex-col flex-1 animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
                  <h2 className="text-3xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">What's the name of your business?</h2>
              ...
              {chatStep === 2 && (
                <div className="flex flex-col flex-1 animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
                  ...
                  <h2 className="text-3xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">What do you sell?</h2>
                  <p className="text-gray-500 dark:text-[#A1A1A6] text-sm mb-6">
              ...
              {chatStep === 3 && (
                <div className="flex flex-col flex-1 animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
                  ...
                  <h2 className="text-3xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">Where are you located?</h2>
                  <p className="text-gray-500 dark:text-[#A1A1A6] text-sm mb-6">
          ...
          {step === 2 && (
            <div className="flex flex-col flex-1 animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
              ...
              <h2 className="text-3xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">Review Details</h2>
              <p className="text-gray-500 dark:text-[#A1A1A6] text-sm mb-6">
          ...
          {step === 3 && (
            <div className="flex flex-col flex-1 animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
              ...
              <h2 className="text-3xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">Style & Team</h2>
              <p className="text-gray-500 dark:text-[#A1A1A6] text-sm mb-6">
          ...
          {step === 4 && (
             <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
               ...
               <h2 className="text-2xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-4">Building Your Business...</h2>
               <div className="space-y-2">
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in transform-gpu transition-all duration-500 ease-out transform-gpu transition-all duration-500 ease-out">
              ...
              <h2 className="text-2xl font-bold font-outfit tracking-tight tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] mb-2">You're Live!</h2>
