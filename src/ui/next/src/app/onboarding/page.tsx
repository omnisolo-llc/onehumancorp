          ...
          {step === 0 && (
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex flex-col gap-4 w-full">
                <button
                  className="w-full bg-[#0066FF] text-white p-4 font-bold shadow-[0_4px_14px_0_rgba(0,102,255,0.39)] hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] min-h-[44px]"
                ...
                <button
                  type="button"
                  className="w-full glassmorphism text-[#1D1D1F] dark:text-[#F5F5F7] p-4 font-bold shadow-sm active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] min-h-[44px]"
                  onClick={() => { setStep(-1); syncStateToBackend({ step: -1 }); }}
                >
                  Instant Build
                </button>
          ...
          {step === -2 && (
            <div className="flex flex-col flex-1 animate-fade-in w-full h-full max-h-full">
              ...
              <div className="flex flex-col flex-1 gap-4 overflow-hidden w-full max-w-full">
                <div id="chat-messages" className="glassmorphism flex-1 overflow-y-auto p-4 text-[#1D1D1F] dark:text-[#F5F5F7] text-left space-y-4">
            ...
            <div className="flex flex-col justify-center items-center gap-4 flex-1 animate-fade-in">
              ...
              <div className="flex flex-col gap-4 w-full">
                <textarea
                  ...
                  className={`glassmorphism w-full p-4 text-[#1D1D1F] dark:text-[#F5F5F7] outline-none min-h-[44px] transition-all duration-[250ms] ${error === "Please tell us about your business." || error ? "border border-[#FF3B30]" : "border border-white/20 focus:border-[#0066FF]"}`}
                ...
                <input
                  ...
                  type="url"
                  className="glassmorphism w-full p-4 text-[#1D1D1F] dark:text-[#F5F5F7] outline-none min-h-[44px] border border-white/20 focus:border-[#0066FF] transition-all duration-[250ms]"
                  placeholder="Image URL (Optional)"
                  value={instantImageUrl}
                  onChange={(e) => setInstantImageUrl(e.target.value)}
                />
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="w-full bg-[#0066FF] text-white p-4 font-bold shadow-[0_4px_14px_0_rgba(0,102,255,0.39)] hover:bg-[#005bb5] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]"
                  >
                    Next
                  </button>
                </div>
