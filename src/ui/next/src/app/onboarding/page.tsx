    ...
    <div className="setup-page min-h-screen w-full bg-[#F5F5F7] dark:bg-[#16161a] flex items-center justify-center sm:p-4 font-inter overflow-x-hidden">
      ...
      >
        ...
        <div className="p-6 flex-1 flex flex-col overflow-y-auto custom-scrollbar relative">
          ...
          {step === 0 && (
            <div className="flex flex-col flex-1 animate-fade-in w-full h-full max-h-full glassmorphism translucent-glass-light dark:translucent-glass-dark p-4 rounded-[16px]">
              <button
                onClick={() => {
                  updateState({ step: -2 });
                  syncStateToBackend({ step: -2 });
          ...
          {step === 4 && (
            <div
              aria-live="polite"
              className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in glassmorphism translucent-glass-light dark:translucent-glass-dark shadow-2xl p-4 sm:p-8 rounded-[16px]"
            >
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                <div className="p-3 glassmorphism translucent-glass-light dark:translucent-glass-dark flex flex-col items-center mb-6 rounded-[16px]">
