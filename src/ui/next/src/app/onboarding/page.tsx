                ...
                <div className="flex flex-col flex-1 animate-fade-in">
                  <div className="flex items-center justify-between mb-6">
                    <button
                      ...
                      className="text-sm font-semibold text-[#0066FF] hover:underline whitespace-nowrap shrink-0"
                    >
                      Save Draft
                    </button>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <textarea
                        ...
                        placeholder="e.g. Maya Bakery that bakes custom vegan cakes in Portland, OR"
                    ...
                    <button
                      onClick={() => {
                        if (businessDescription.trim().length < 10) {
                          setValidationError('Please provide a little more detail about your business.');
                          return;
                        }
                        setValidationError('');
                        handleIntake();
