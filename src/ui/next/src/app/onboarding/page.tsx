...
export default function OnboardingWizard() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-[#16161a] font-inter flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8">
      <div
        id="setup-screen"
        className="w-full max-w-[375px] mx-auto bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] rounded-[16px] shadow-lg overflow-hidden flex flex-col h-[650px] relative"
      >
          ...
          {step === 1 && (
            <div className="flex flex-col flex-1 justify-center animate-fade-in">
              ...
              <p className="text-gray-500 dark:text-[#A1A1A6] text-sm mb-8">
                Describe what you do, or paste your Instagram link. Our AI will
                set up your store automatically.
              </p>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <input
                        ...
                        enterKeyHint="next"
                        className="w-full p-4 rounded-[12px] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] outline-none bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] text-[#1D1D1F] dark:text-[#F5F5F7] text-lg transition-all shadow-inner"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <textarea
                        ...
                        enterKeyHint="next"
                        className="w-full p-4 rounded-[8px] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] text-[#1D1D1F] dark:text-[#F5F5F7] h-32 resize-none transition-all shadow-inner"
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <input
                    ...
                    autoCapitalize="words"
                    enterKeyHint="next"
                    className="w-full p-3 rounded-[8px] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] focus:border-[#0066FF] outline-none bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] text-[#1D1D1F] dark:text-[#F5F5F7]"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wide mb-1">
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2 hide-scrollbar">
                ...
                <div className="pt-2 border-t border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)]">
                  ...
                  <div className="space-y-2">
                    {["Sales Agent", "Support Agent", "Marketing Agent"].map(
                      (agent) => {
                        ...
                        return (
                          <div
                            ...
                            onClick={() => {
                              if (isSelected) {
                                setAiAgents(
                                  aiAgents.filter((a) => a !== agent),
                                );
                              } else {
                                setAiAgents([...aiAgents, agent]);
                              }
                            }}
                            className={`p-3 rounded-[8px] border cursor-pointer flex items-center justify-between transition-all ${isSelected ? "border-[#0066FF] bg-[#0066FF]/10 text-[#0066FF]" : "border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] text-[#1D1D1F] dark:text-white"}`}
                          >
                            <span className="font-semibold text-sm">
                              {agent}
                            </span>
                            <div
                              className={`w-4 h-4 rounded-full border flex items-center justify-center ${isSelected ? "border-[#0066FF] bg-[#0066FF]" : "border-gray-400"}`}
                            >
                              {isSelected && (
                                <svg
                ...
                <div className="pt-2">
                  <label className="flex items-center justify-between cursor-pointer p-3 rounded-[8px] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%] text-[#1D1D1F] dark:text-white">
                    <span className="font-semibold text-sm">
          ...
          {step === 5 && startResult && (
            <div className="flex flex-col flex-1 justify-center items-center text-center animate-fade-in">
              ...
              <div className="w-full space-y-3 mt-auto">
                <div className="p-3 bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%]  rounded-[8px] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] flex flex-col items-center mb-6">
                ...
                <a
                  href="/builder"
                  className="block w-full bg-[rgba(255,255,255,0.65)] dark:bg-[rgba(22,22,26,0.7)] backdrop-blur-[30px] saturate-[210%]  text-[#1D1D1F] dark:text-[#F5F5F7] border border-[rgba(255,255,255,0.4)] dark:border-[rgba(255,255,255,0.1)] p-4 rounded-[8px] font-bold shadow-sm hover:bg-[rgba(255,255,255,0.85)] dark:hover:bg-[rgba(22,22,26,0.9)] active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
                >
                  Preview Storefront
                </a>
              </div>
