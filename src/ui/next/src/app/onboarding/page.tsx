...
export default function OnboardingWizard() {
  ...
  useEffect(() => {
    ...
    step, businessDescription, businessName,
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      <textarea
                        ...
                        className="w-full p-4 rounded-[8px] border border-white/50 dark:border-white/10 focus:border-[#0066FF] focus:ring-2 focus:ring-[#0066FF]/30 outline-none mac-glass-container text-[#1D1D1F] dark:text-[#F5F5F7] h-40 resize-none transition-all shadow-inner"
                      />
                    </div>
                  </div>
          ...
          {step === 2 && (
            <div className="flex flex-col flex-1 animate-fade-in">
              ...
              <p className="text-gray-500 dark:text-[#A1A1A6] text-sm mb-6">
                Here's what our AI figured out. We are ready to launch.
              </p>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-2">
                <div>
                  ...
                  <p className="w-full p-3 rounded-[8px] border border-white/50 dark:border-white/10 mac-glass-container text-[#1D1D1F] dark:text-[#F5F5F7]">
                    {businessName}
                  </p>
                </div>
                <div>
              ...
              <div className="mt-auto pt-6">
                <button
                  ...
                  disabled={isLoading || !businessName.trim() || !businessType.trim() || categories.length === 0 || !firstProductName.trim() || !firstProductPrice.trim()}
                  className="w-full bg-[#0066FF] text-white p-4 rounded-[8px] font-bold shadow-md hover:bg-[#0052cc] active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Approve & Launch
                </button>
