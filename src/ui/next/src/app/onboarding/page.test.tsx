...
describe('OnboardingWizard', () => {
  ...
  it.skip('Step 2: Displays validation error when product price is invalid', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 2: Displays validation error when business type is empty', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 2: Proceeds to Step 3 when validation passes', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 3: Can select Web Address, AI agents and toggle auto-respond', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 5: Shows Live Screen with correct links', async () => {
    act(() => {
      useOnboardingStore.setState({
        step: 5,
  ...
  it.skip('retries handleSaveDraft on network failure', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 4: Target audience saves and navigates to launch correctly', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Save Draft button triggers draft API and shows success message', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 3: Shows inline validation errors for admin fields', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Handles Save Draft button functionality', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('offers a global back control on later wizard steps', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('can go back from the first question to the intro screen', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 3: Passes initial_products from localStorage to /api/onboarding/start', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 1: shows validation error when location is empty', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 1: shows validation error when target audience is empty', async () => {
    const user = userEvent.setup({ delay: null });
  ...
  it.skip('Step 1: shows validation error when what you sell is empty', async () => {
    const user = userEvent.setup({ delay: null });
