...
describe('OnboardingWizard', () => {
  ...
  it('Handles multi-step successful onboarding flow', async () => {
    ...
    // Mock initial fetch state, intake success, syncs, then start success
    ...
    await userEvent.type(locInput, 'NYO'); // Make it >= 3 to be enabled
  ...
  it('Step 1: Handles intake API failure', async () => {
    ...
    // Chat Step 3
    const locInput = screen.getByPlaceholderText(/Portland, OR/i);
    await userEvent.type(locInput, 'NYO');
