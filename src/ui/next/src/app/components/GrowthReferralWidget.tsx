...
export default function GrowthReferralWidget() {
  ...
  return (
    <div className="ohc-growth-card flex flex-col gap-8">
      <div className="p-6 rounded-[16px] backdrop-blur-[30px] saturate-[210%] bg-white/30 dark:bg-black/30 border border-white/20 dark:border-white/10 shadow-xl mb-6">
      ...
      <div className="p-6 rounded-[16px] backdrop-blur-[30px] saturate-[210%] bg-white/30 dark:bg-black/30 border border-white/20 dark:border-white/10 shadow-xl">
        <div className="flex flex-col md:flex-row gap-6 items-center">
          <div className="flex-1">
