...
export default function GrowthReferralWidget() {
  ...
  return (
    <div className="ohc-growth-card flex flex-col gap-8">
      <div className="glass-panel p-6 rounded-[16px] border border-white/40 dark:border-white/10 shadow-lg mb-6">
      ...
      <div className="glass-panel p-6 rounded-[16px] border border-white/40 dark:border-white/10 shadow-lg">
        <div className="flex flex-col md:flex-row gap-6 items-center">
          <div className="flex-1">
