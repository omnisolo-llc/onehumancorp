...
const routeMetadata: Record<string, { title: string; subtitle?: string }> = {
  ...
  "/perplexity-harness": { title: "Perplexity-style Agent Harness" },
  ...
  "/hybrid-landing": { title: "Your Business. Your AI. Your Rules." },
  "/hybrid_landing": { title: "Your Business. Your AI. Your Rules." },
