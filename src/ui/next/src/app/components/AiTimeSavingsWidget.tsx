...
export default function AiTimeSavingsWidget() {
  ...
  if (hasClaimed) {
    return (
      <div className="macos-translucent-glass p-6 rounded-[16px] border border-green-200 dark:border-green-900/30 shadow-lg mb-6 flex items-center justify-between bg-green-50/50 dark:bg-green-900/10">
  ...
  return (
    <div className="macos-translucent-glass p-6 rounded-[16px] border border-indigo-200 dark:border-indigo-900/30 shadow-lg mb-6 relative overflow-hidden group">
