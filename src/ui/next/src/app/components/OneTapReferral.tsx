  ...
  return (
    <div className="one-tap-referral p-4 bg-indigo-50/50 backdrop-blur-sm border border-indigo-100 rounded-xl shadow-sm text-center">
      ...
      <div className="flex gap-2 justify-center">
         <button onClick={copyToClipboard} className={`flex-1 py-2 px-3 rounded-lg text-sm font-semibold transition-all ${copied ? 'bg-green-100 text-green-700' : 'glassmorphism text-indigo-700 border border-indigo-200 hover:bg-indigo-50'}`}>
