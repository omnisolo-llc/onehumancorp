  ...
  return (
    <AppShell title="Operations Copilot">
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
        ...
        <section className="macos-translucent-glass rounded-[16px] p-6 border border-white/40 dark:border-white/10 shadow-sm relative overflow-hidden">
        ...
        <section className="space-y-4">
            <div className="flex flex-col gap-4">
                {/* Past Appointment */}
                <div className="macos-translucent-glass rounded-[16px] p-4 border border-white/40 dark:border-white/10 shadow-sm flex flex-col sm:flex-row gap-4 items-start sm:items-center opacity-60">
                ...
                {/* Current Appointment */}
                <div className="macos-translucent-glass rounded-[16px] p-4 border border-blue-200 dark:border-blue-800 shadow-md flex flex-col sm:flex-row gap-4 items-start sm:items-center relative overflow-hidden">
                 ...
                 {/* Future Appointment */}
                 <div className="macos-translucent-glass rounded-[16px] p-4 border border-white/40 dark:border-white/10 shadow-sm flex flex-col sm:flex-row gap-4 items-start sm:items-center hover:shadow-md transition-shadow">
                    <div className="w-16 flex flex-col items-center justify-center shrink-0">
