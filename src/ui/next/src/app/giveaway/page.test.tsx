...
describe('GiveawayPage', () => {
  ...
  it('renders correctly', async () => {
    await act(async () => { render(<GiveawayPage />); });
  ...
  it('updates preview when inputs change', async () => {
    ...
    await act(async () => { fireEvent.change(titleInput, { target: { value: 'Win a New Car!' } }); });
  ...
  it('shows paywall when removing branding without pro', async () => {
    ...
    await act(async () => { fireEvent.click(removeBrandingCheckbox); });
