  ...
  return (
    ...
    >
      ...
      <main className="p-6 max-w-5xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-lg font-bold font-outfit text-gray-900 mb-4">
              Items
            </h2>
            ...
            {status === "shipped" ? (
              <div className="bg-green-50 border border-green-100 rounded-xl p-4">
                ...
                <div className="mt-4 pt-3 border-t border-green-200/50 flex items-center gap-2 text-sm text-green-700">
                  ...
                  Customer automatically notified with tracking info by The
                  Ambassador AI.
                </div>
              </div>
            ) : (
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                Est. delivery in {rate.days} days
                              </p>
                            </div>
                          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <h3 className="text-xs font-semibold text-gray-500 uppercase mt-4 mb-2">
              Shipping Address
            </h3>
      ...
      <div className="mt-8 text-center pb-8">
        <a
          href="https://ohc.store/join?ref=my-store"
          target="_blank"
          rel="noopener noreferrer"
          className="text-xs font-semibold tracking-wider uppercase text-gray-500 opacity-70 hover:opacity-100 transition-opacity"
        >
          ⚡ Powered by OHC - Start your business today
        </a>
      </div>
