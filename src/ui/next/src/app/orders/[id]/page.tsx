  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        {status === "ready" && order && (
          <>
            <section className="app-card translucent-glass-light rounded-2xl border border-gray-200 bg-white/70 p-6 shadow-sm">
            ...
            <section className="app-card translucent-glass-light rounded-2xl border border-gray-200 bg-white/70 p-6 shadow-sm">
              ...
              <button onClick={fetchRates} disabled={shippingPending} className="glass-control mt-4 rounded-lg bg-gray-900 px-4 py-2 text-white disabled:opacity-50">Get Shipping Rates</button>
              ...
              ))}<button onClick={buyLabel} disabled={!selectedRate || shippingPending} className="glass-control rounded-lg bg-indigo-600 px-4 py-2 text-white disabled:opacity-50">Ship Order</button></div>}
              {label && <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-4"><p>{label.carrier} tracking: <strong>{label.trackingNumber}</strong></p><a href={label.url} target="_blank" rel="noopener noreferrer" className="glass-control mt-2 inline-block rounded-lg bg-indigo-600 px-4 py-2 text-white text-center">Print Label</a></div>}
            </section>
          </>
        )}
      </div>
