        ...
        {status === "ready" && order && (
          <>
            ...
            <section className="app-card rounded-2xl border border-gray-200 bg-white/70 p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-500 mb-4">Powered by Shippo</p>
              ...
              {rates.length > 0 && <div className="mt-4 space-y-2"><p className="text-sm font-medium text-gray-900">Select a Service</p>{rates.map((rate) => (
              ...
              {label && <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-4"><p className="font-bold text-green-800">Label Purchased Successfully</p><p>Shipped</p><p>{label.carrier} tracking: <strong>{label.trackingNumber}</strong></p><a href={label.url} target="_blank" rel="noopener noreferrer" className="text-indigo-700 underline font-medium">Print Label</a></div>}
            </section>
          </>
        )}
      </div>
