        ...
        {status === "ready" && order && (
          <>
            ...
            <section className="app-card rounded-2xl border border-gray-200 bg-white/70 p-6 shadow-sm">
              ...
              {label && <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-4"><p>{label.carrier} tracking: <strong>{label.trackingNumber}</strong></p><p className="font-bold text-green-700">Label Purchased Successfully</p><a href={label.url} target="_blank" rel="noopener noreferrer" className="text-indigo-700 underline">Print Label</a></div>}
            </section>
          </>
        )}
      </div>
