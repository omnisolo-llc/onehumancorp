          ...
          <>
            ...
            <section className="app-card rounded-2xl border border-gray-200 bg-white/70 p-6 shadow-sm">
              ...
              {rates.length > 0 && <div className="mt-4 space-y-2">
                <h3 className="text-sm font-bold text-gray-900">Select a Service</h3>
                {rates.map((rate) => (
              ...
              {label && (
                <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-4">
                  <h3 className="text-sm font-bold text-green-900">Label Purchased Successfully</h3>
                  <p className="text-sm text-green-800">Shipped</p>
                  <p className="mt-2 text-sm">{label.carrier} tracking: <strong>{label.trackingNumber}</strong></p>
                  <a href={label.url} target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-sm text-indigo-700 underline">Print Label</a>
                </div>
              )}
            </section>
          </>
