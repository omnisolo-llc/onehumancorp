...
export default function StorefrontBuilderPage() {
  ...
  return (
    <div className="p-8 font-inter">
      ...
      <div id="builder-actions" className="flex gap-2">
        <button id="publish-btn" onClick={() => setShowPublish(true)} className="bg-blue-600 text-white px-4 py-2 rounded">Publish Changes</button>
        <button id="embed-btn" onClick={() => setShowEmbed(true)} className="bg-gray-800 text-white px-4 py-2 rounded">Embed</button>
      </div>

      <div id="store-preview-container" className="mt-8 border p-4 rounded bg-gray-50">
