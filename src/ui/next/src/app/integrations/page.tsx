...
export default function Integrations() {
  ...
  const integrations = [
    { id: "manychat", name: "Manychat", category: "marketing", status: "disconnected", icon: "💬", description: "Unified Customer Inbox. Manage all your messages and posts from one place." },
    ...
    { id: "mailchimp", name: "Mailchimp", category: "marketing", status: "disconnected", icon: "📧", description: "Trigger email campaigns based on customer purchase behavior." },
      ...
      <main className="p-6 md:p-8 flex-1 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredIntegrations.map(integration => (
            <div key={integration.id} className="bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 rounded-[16px] shadow-sm flex flex-col transition-shadow hover:shadow-md p-6">
              ...
              <button className={`w-full py-3 rounded-[8px] font-semibold text-sm transition-transform active:scale-[0.98] ${
                integration.status === 'connected'
                  ...
                  : "bg-[#0066FF] text-white shadow-sm hover:bg-[#0055DD]"
              }`}>
