...
export default function Integrations() {
  ...
  const integrations = [
    { id: "meta", name: "Meta", category: "marketing", status: "disconnected", icon: "💬", description: "Unified Customer Inbox. Manage all your messages and posts from one place." },
    { id: "cal_com", name: "Cal.com", category: "operations", status: "disconnected", icon: "📅", description: "Automated Booking. Let customers schedule appointments 24/7." },
    { id: "resend", name: "Resend", category: "marketing", status: "disconnected", icon: "✉️", description: "Automated Newsletters. Keep your customers engaged easily." },
    ...
    { id: "shippo", name: "Shippo", category: "operations", status: "disconnected", icon: "📦", description: "Automated Labels & Tracking. Save time on fulfilling orders." },
