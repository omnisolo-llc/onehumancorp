...
export default function Integrations() {
  ...
  const [integrations, setIntegrations] = useState([
    { id: "google_calendar", name: "Google Calendar", category: "operations", status: "disconnected", icon: "📅", description: "Zero-configuration booking and calendar sync." },
    { id: "meta_graph", name: "Meta Graph API", category: "marketing", status: "disconnected", icon: "💬", description: "Unified inbox for Instagram, Facebook, and WhatsApp." },
    { id: "email_manager", name: "Email Campaigns", category: "marketing", status: "disconnected", icon: "📨", description: "Automated customer outreach and email marketing." },
    { id: "mercadopago", name: "Mercado Pago", category: "finance", status: "disconnected", icon: "🌎", description: "Accept credit cards and local payment methods." },
    { id: "shippo", name: "Shippo", category: "operations", status: "disconnected", icon: "📦", description: "Compare rates, purchase, and print shipping labels." },
    { id: "twilio", name: "Twilio Conversations", category: "operations", status: "disconnected", icon: "🔔", description: "Reliable SMS and text message alerts for new orders." },
    { id: "zoom", name: "Zoom", category: "operations", status: "disconnected", icon: "📹", description: "Automated video meeting links for online services." }
  ]);
  ...
  const handleConnect = (id: string) => {
    if (id === 'google_calendar') {
      alert("Connecting Google Calendar via OAuth...");
    ...
    if (id === 'meta_graph') {
      alert("Connecting Meta Graph API via OAuth...");
      setIntegrations(prev => prev.map(integration =>
        integration.id === id ? { ...integration, status: "connected" } : integration
      ));
      router.push('/inbox');
