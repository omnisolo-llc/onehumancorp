  ...
  const integrations = [
    {
      ...
      icon: "📱",
      description:
        "Unified Native Social Media Inbox for Instagram, Facebook, and WhatsApp.",
    },
    {
      id: "cal_com",
      name: "Cal.com",
      ...
      status: "disconnected",
      icon: "📅",
      description: "Zero-Config Booking & Calendar Sync.",
    },
    {
      id: "listmonk",
      name: "Listmonk",
      ...
      status: "disconnected",
      icon: "📨",
      description: "Open Source Newsletter & Mailing List Manager.",
    },
    {
      id: "mercadopago",
      name: "Mercado Pago",
      ...
      icon: "🌎",
      description:
        "Accept credit cards and local payment methods in Latin America.",
    },
    {
      id: "karrio",
      name: "Karrio",
      ...
      status: "disconnected",
      icon: "📦",
      description: "Open-Source Multi-Carrier Shipping API.",
    },
    {
      id: "twilio",
      name: "Twilio",
      ...
      icon: "🔔",
      description:
        "Reliable SMS alerts for new orders and customer notifications.",
    },
    {
      id: "jitsi",
      name: "Jitsi Meet",
      ...
      status: "disconnected",
      icon: "📹",
      description: "Open-source WebRTC video consultations.",
    },
  ];
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-gradient-to-r from-yellow-300 to-yellow-500 text-black text-xs font-bold px-2 py-0.5 rounded uppercase tracking-wide">
                Premium
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredIntegrations.map((integration) => (
            ...
            >
              ...
              <h3 className="font-bold font-outfit text-gray-900 text-lg mb-2">
                {integration.name}
              </h3>
