...
export default function Integrations() {
  ...
  const integrations = [
    ...
    { id: "mailerlite", name: "MailerLite", category: "marketing", status: "disconnected", icon: "📧", description: "Easy drag-and-drop builder for newsletters and simple automations." },
    ...
    { id: "respondio", name: "Respond.io", category: "marketing", status: "disconnected", icon: "💬", description: "Unified inbox combining all major social channels." },
