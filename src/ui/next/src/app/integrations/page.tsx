...
export default function Integrations() {
  ...
  const integrations = [
    ...
    { id: "stripe_terminal", name: "Stripe Terminal", category: "finance", status: "disconnected", icon: "💳", description: "Accept in-person payments with physical hardware." },
    ...
    { id: "google_calendar", name: "Google Calendar Sync", category: "operations", status: "disconnected", icon: "📅", description: "Two-way calendar sync for tutors and service businesses." },
