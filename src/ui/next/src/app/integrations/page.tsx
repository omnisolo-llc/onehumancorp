...
export default function Integrations() {
  const [activeTab, setActiveTab] = useState("all");
    ...
    const integrations = [
    { id: "meta", name: "Meta", category: "marketing", status: "disconnected", icon: "💬", description: "Unified inbox for Instagram, Facebook, and WhatsApp." },
    { id: "google_calendar", name: "Google Calendar", category: "operations", status: "disconnected", icon: "📅", description: "Two-way sync for seamless appointment booking." },
    { id: "resend", name: "Resend", category: "marketing", status: "disconnected", icon: "📨", description: "Native Email Campaign Manager." },
    ...
    { id: "shippo", name: "Shippo", category: "operations", status: "disconnected", icon: "📦", description: "Native Shipping Rate Calculation and Label Generation." },
    ...
    { id: "zoom", name: "Zoom", category: "operations", status: "disconnected", icon: "📹", description: "Native Zoom Link Generation for Appointments." }
  ];
