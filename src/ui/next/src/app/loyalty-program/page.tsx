      ...
      <main className="p-6 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/3 flex flex-col gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-white/40">
          ...
          <div className="w-full md:w-2/3 flex flex-col gap-4">
             ...
             {generatedDraft ? (
               <div className="bg-white rounded-2xl shadow-sm border border-white/40 overflow-hidden flex flex-col h-full min-h-[400px]">
               ...
               <div className="bg-white rounded-2xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 min-h-[400px]">
