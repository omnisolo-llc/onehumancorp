        ...
        <div className="flex-1 min-w-0 p-8">
          ...
          <div className="space-y-4">
             ...
             <div>
                ...
                <select id="themeSelect" value={theme} onChange={(e) => setTheme(e.target.value as Parameters<typeof setTheme>[0])} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white text-black">
        ...
        <div className="fixed inset-0 bg-black/60 z-[60] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md p-8 shadow-2xl relative overflow-hidden font-inter border border-blue-100 text-center">
             ...
             <p className="text-gray-600 mb-6 text-sm leading-relaxed">
               Make the Insight Widget 100% yours. Upgrade to Pro to remove the "Powered by OmniSolo" watermark.
             </p>
             <button
