  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F5F5F7] dark:bg-[#000000] font-inter">
      ...
      <main className="p-4 md:p-8 flex-1 w-full max-w-3xl mx-auto">
        <div className="macos-translucent-glass p-6 md:p-8 rounded-[16px] border border-white/40 dark:border-white/10 shadow-lg mb-8 bg-white/50 dark:bg-black/30">
          <div className="mb-6">
        ...
        {menuLink && (
          <div className="macos-translucent-glass p-6 rounded-[16px] border border-green-200 dark:border-green-900/30 shadow-lg bg-green-50/50 dark:bg-green-900/10 animate-fade-in">
