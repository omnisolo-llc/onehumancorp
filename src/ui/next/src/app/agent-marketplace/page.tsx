...
export default function AgentMarketplacePage() {
 ...
 className="w-full p-4 pl-12 text-lg rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all glassmorphism/65 backdrop-blur-[30px] saturate-[210%] border border-white/40"
 />
 ...
 <div
 key={agent.id}
 className="p-6 rounded-2xl shadow-sm hover:shadow-md transition-all flex flex-col glassmorphism/65 backdrop-blur-[30px] saturate-[210%] border border-white/40"
>
...
>
 ...
 {agents.length === 0 && (
 <div className="col-span-full flex flex-col items-center justify-center p-12 rounded-2xl border border-dashed text-gray-500 glassmorphism/65 backdrop-blur-[30px] saturate-[210%] border-white/40">
