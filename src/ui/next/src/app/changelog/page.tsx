...
export default function ChangelogPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 backdrop-blur-[20px] saturate-200 py-12 px-4 sm:px-6 lg:px-8 font-inter">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 font-outfit">Release Notes & Changelog</h1>
        <div className="space-y-8">
          {sections.map((section, idx) => (
            <div key={idx} className="bg-white/70 backdrop-blur-[20px] saturate-200 p-6 rounded-xl shadow-sm border border-white/50">
