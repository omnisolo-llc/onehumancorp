      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          {loading ? (
            ...
            <p className="text-center text-gray-500 font-medium py-8 backdrop-blur-[40px] saturate-[210%] bg-white/70 dark:bg-[#1C1C1E]/70 border border-white/40 dark:border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.04)] rounded-2xl">
            ...
            sections.map((section, idx) => (
              <motion.div
                ...
                className="backdrop-blur-[40px] saturate-[210%] bg-white/70 dark:bg-[#1C1C1E]/70 border border-white/40 dark:border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.04)] p-6 sm:p-8 rounded-2xl transition-all hover:-translate-y-1 hover:shadow-[0_4px_24px_rgba(0,0,0,0.04)] hover:border-blue-300 dark:hover:border-blue-700"
              >
