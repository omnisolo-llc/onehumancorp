...
export default function ChangelogPage() {
  ...
  return (
    <div className="min-h-screen bg-white/40 backdrop-blur-md rounded-xl shadow-lg border border-white/20 p-8 bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-inter">
