      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          {loading ? (
            ...
            <p className="text-center text-gray-500 font-medium py-8 backdrop-blur-md bg-white/30 border border-white/20 shadow-lg saturate-[150%] dark:bg-[#1C1C1E]/70 dark:border-white/10 rounded-3xl">
            ...
            sections.map((section, idx) => (
              <motion.div
                ...
                className="backdrop-blur-md bg-white/30 border border-white/20 shadow-lg saturate-[150%] dark:bg-[#1C1C1E]/70 dark:border-white/10 p-6 sm:p-8 rounded-3xl transition-all hover:-translate-y-1 hover:border-blue-300 dark:hover:border-blue-700"
              >
