        ...
        <div className="w-full md:w-1/3 flex flex-col gap-6">
            <div className="p-6 rounded-[16px] bg-white border border-gray-200 shadow-sm">
                ...
                <div className="mb-4">
                    ...
                    <input
                        type="text"
                        className="w-full px-3 py-2 border border-gray-300 rounded-[8px] min-h-[44px] focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <div className="mb-4">
                    ...
                    <textarea
                        className="w-full px-3 py-2 border border-gray-300 rounded-[8px] min-h-[80px] resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <div className="mb-6">
                    ...
                    <div className="flex gap-2 p-1 bg-gray-100 rounded-lg">
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-medium rounded-[8px] min-h-[44px] transition-all ${theme === 'light' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            Light
                        </button>
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-medium rounded-[8px] min-h-[44px] transition-all ${theme === 'dark' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            Dark
                        </button>
                    </div>
                ...
                <button
                    ...
                    className="w-full py-3 bg-indigo-600 text-white font-medium rounded-[8px] min-h-[44px] hover:bg-indigo-700 transition-colors shadow-sm"
                >
                    Get Widget Code
                </button>
            </div>
            ...
            <div className="bg-white rounded-[16px] p-8 max-w-xl w-full shadow-2xl relative animate-fade-in-up">
                ...
                <div className="relative group">
                    <textarea
                        readOnly
                        value={embedCode}
                        className="w-full h-32 p-4 bg-gray-50 border border-gray-200 rounded-[8px] font-mono text-sm text-gray-800 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                    />
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                    <button
                        onClick={handleCopy}
                        className="flex-1 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-[8px] min-h-[44px] transition-colors shadow-sm flex items-center justify-center gap-2"
                    >
                        {copied ? 'Copied!' : 'Copy Code'}
                    </button>
                    <button
                        onClick={() => setShowModal(false)}
                        className="flex-1 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium rounded-[8px] min-h-[44px] transition-colors"
                    >
                        Close
                    </button>
                </div>
        ...
        <div className="fixed inset-0 bg-black/60 z-[9999] flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-[16px] p-8 shadow-2xl relative overflow-hidden font-inter text-center">
            ...
            <button
              ...
              className="w-full py-4 rounded-[8px] font-bold text-white mb-4 transition-all shadow-md hover:shadow-lg hover:opacity-90 bg-indigo-600 hover:bg-indigo-700"
            >
              Upgrade to Pro
            </button>
          </div>
