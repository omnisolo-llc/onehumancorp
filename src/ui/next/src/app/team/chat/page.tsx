          ...
          {messages.map((msg) => (
            <div key={msg.id} className={`flex gap-2 ${msg.role === 'user' ? 'flex-row-reverse' : 'flex-row'}`}>
              ...
              <div className="flex flex-col gap-2 max-w-[80%]">
                ...
                {msg.card && (
                  <div className="app-card glass-card backdrop-blur-[30px] saturate-[210%] border border-gray-200 rounded-xl p-4 shadow-sm relative overflow-hidden" data-testid="action-card">
