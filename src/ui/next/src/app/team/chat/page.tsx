  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 font-inter py-10">
      <div className="w-[375px] min-h-[812px] glassmorphism rounded-[16px] shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200">
        ...
        {/* Header */}
        <div className="pt-12 pb-4 px-6 glassmorphism/65 backdrop-blur-[30px] border-b border-white/40 sticky top-0 z-10 flex items-center gap-4">
        ...
        {/* Input */}
        <div className="p-4 glassmorphism/65 backdrop-blur-[30px] border-t border-white/40 sticky bottom-0 z-10">
