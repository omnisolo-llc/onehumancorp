    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 font-inter py-10">
      <div className="w-[375px] max-w-[375px] min-h-[812px] bg-gradient-to-br from-gray-50 to-gray-100 shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 pb-24 hide-scrollbar">
          <a href="/team/voice-receptionist" className="block mb-6 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-5 shadow-md hover:shadow-lg transition-all active:scale-[0.98]">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 text-sm mt-1">Configure your 24/7 AI Receptionist</p>
              </div>
