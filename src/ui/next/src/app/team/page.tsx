...
import CloudBridgeInviteModal from './components/CloudBridgeInviteModal';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 font-inter py-10">
      <div className="w-[375px] max-w-[375px] min-h-[812px] bg-gradient-to-br from-gray-50 to-gray-100 shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 pb-24 hide-scrollbar">
          ...
          {/* Growth / Referral Loop Section */}
          <div className="mt-8 bg-white/5 backdrop-blur-[20px] saturate-[200%] border border-gray-200/50 rounded-xl p-5 shadow-sm">
            ...
            <button
              ...
              className="w-full py-3 bg-white border border-gray-200 hover:bg-gray-50 text-gray-800 rounded-lg font-medium shadow-sm transition-all active:scale-[0.98] flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" /></svg>
      ...
      {isInviteModalOpen && (
        <CloudBridgeInviteModal onClose={() => setIsInviteModalOpen(false)} />
      )}
