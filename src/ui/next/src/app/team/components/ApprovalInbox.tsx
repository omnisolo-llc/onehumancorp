              ...
              return (
                ...
                >
                  ...
                  {req.payload?.feature_type === "social_post" && (
                    <div className="mb-6 p-4 rounded-xl bg-sky-50 border border-sky-100 flex flex-col gap-3 backdrop-blur-xl bg-opacity-70 shadow-sm relative overflow-hidden">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] uppercase font-bold text-sky-600 bg-sky-100/50 px-2 py-1 rounded-full">
                          AI Generated
                        </span>
                      </div>

                      <div className="text-xs text-sky-700 font-medium">
                        New post for {req.payload.product_name} ready to schedule.
                      </div>

                      <div className="bg-white rounded-xl border border-sky-100 overflow-hidden shadow-sm flex flex-col sm:flex-row">
                        <div className="w-full sm:w-1/3 bg-gray-100 relative min-h-[120px]">
