            ...
            approvals.map((req) => {
              ...
              return (
                ...
                >
                  ...
                  {req.payload?.feature_type === "review_response" && (
                    <div className="mb-6 p-4 rounded-xl bg-purple-50 border border-purple-100 flex flex-col gap-3">
                      ...
                      <div className="text-xs text-purple-700 font-medium">
                        A customer just left a review! The Ambassador drafted a polite reply for your approval.
                      </div>

                      <div className="app-card p-3 rounded-lg border border-purple-100 relative">
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={() => {
                        if (payload && (payload.original_message || payload.feature_type === "quote_draft" || payload.feature_type === "review_response")) {
                    ...
                    >
                      {payload && (payload.original_message || payload.feature_type === "quote_draft" || payload.feature_type === "review_response")
                        ? "Review"
                        : "Reject / Edit"}
                    </button>
                    <button
