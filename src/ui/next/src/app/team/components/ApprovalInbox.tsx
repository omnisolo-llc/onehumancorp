...
export default function ApprovalInbox({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50/50 backdrop-blur-md font-inter py-10">
      <div className="w-full sm:w-[375px] max-w-[375px] min-h-[812px] bg-white/60 backdrop-blur-xl shadow-2xl overflow-hidden flex flex-col relative border border-white/40 rounded-3xl glass-panel">
        {/* Header */}
          ...
          {approvals.length === 0 ? (
            ...
            approvals.map((req) => {
              ...
              return (
                <div
                  key={req.id}
                  className="glass-panel rounded-2xl p-5 border border-white/40 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-all duration-300"
                >
                  ...
                  {req.payload?.feature_type === "ambassador_reply" && (
                    <div className="mb-6 p-4 rounded-xl glass-panel border border-blue-100 flex flex-col gap-3">
                  ...
                  {req.payload?.feature_type === "quote_draft" && (
                    <div className="mb-6 p-4 rounded-xl glass-panel border border-white/40 flex flex-col gap-3 max-w-full break-words" data-testid="quote-draft-card">
                      ...
                      <div className="glass-panel p-3 rounded-lg border border-white/40 relative mt-2">
          ...
          <div className="absolute inset-0 bg-black/40 z-50 flex flex-col justify-end">
            ...
            >
              ...
              <div className="mb-6">
                ...
                <div className="glass-panel p-3 rounded-xl border border-blue-100 text-sm text-gray-800 italic relative">
                  {extractPayload(selectedReview.description).payload
