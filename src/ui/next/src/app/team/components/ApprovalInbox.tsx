...
export default function ApprovalInbox({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 font-inter py-10">
      <div className="w-full sm:w-[375px] max-w-[375px] min-h-[812px] bg-white/65 backdrop-blur-[30px] saturate-[210%] shadow-2xl overflow-hidden flex flex-col relative border border-white/40 rounded-3xl macos-translucent-glass">
        {/* Header */}
          ...
          {approvals.length === 0 ? (
            ...
            approvals.map((req) => {
              ...
              return (
                <div
                  key={req.id}
                  className="macos-translucent-glass rounded-2xl p-5 border border-white/40 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-all duration-300"
                >
                  ...
                  {req.payload?.feature_type === "ambassador_reply" && (
                    <div className="mb-6 p-4 rounded-xl macos-translucent-glass border border-blue-100 flex flex-col gap-3">
                  ...
                  {req.payload?.feature_type === "quote_draft" && (
                    <div className="mb-6 p-4 rounded-xl macos-translucent-glass border border-white/40 flex flex-col gap-3 max-w-full break-words" data-testid="quote-draft-card">
                      ...
                      <div className="macos-translucent-glass p-3 rounded-lg border border-white/40 relative mt-2">
            ...
            >
              ...
              {extractPayload(selectedReview.description).payload?.feature_type === "quote_draft" ? (
                ...
                <div className="mb-6">
                  ...
                  <div className="macos-translucent-glass p-3 rounded-xl border border-blue-100 text-sm text-gray-800 italic relative">
                    {extractPayload(selectedReview.description).payload
