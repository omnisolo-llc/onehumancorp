...
export default function ApprovalInbox({
  ...
  const [editedProposal, setEditedProposal] = useState<{ suggested_price: string, scope: string } | null>(null);
              ...
              return (
                ...
                >
                  ...
                  {req.payload?.feature_type === "proposal_draft" && (
                    <div className="mb-6 p-4 rounded-xl glassmorphism border border-white/40 flex flex-col gap-3 max-w-full break-words" data-testid="proposal-draft-card">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() => {
                        if (req.payload?.feature_type === "proposal_draft" && editedProposal) {
                           onApprove(req.id, {
                             ...req.payload,
                             suggested_price: parseFloat(editedProposal.suggested_price) || 0,
                             scope: editedProposal.scope
                           });
                        } else {
                           onApprove(req.id);
                        }
          ...
          <div className="absolute inset-0 bg-black/40 z-50 flex flex-col justify-end">
            ...
            >
              ...
              {extractPayload(selectedReview.description).payload?.feature_type === "proposal_draft" ? (
                <div className="mb-6 space-y-4">
                  <div>
                    ...
                    <input
                      type="number"
                      value={editedProposal?.suggested_price || ''}
                      onChange={(e) => setEditedProposal(prev => prev ? { ...prev, suggested_price: e.target.value } : null)}
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => {
                    if (extractPayload(selectedReview.description).payload?.feature_type === "proposal_draft" && editedProposal) {
