            ...
            approvals.map((req) => {
              ...
              return (
                ...
                >
                  ...
                  {req.payload?.feature_type === "automated_review_request" && (
                    <div className="mb-6 p-4 rounded-xl bg-green-50 border border-green-100 flex flex-col gap-3">
                      ...
                      <div className="text-xs text-green-700 font-medium">
                        {req.payload.count} customers haven't reviewed their orders. Request reviews?
                      </div>

                      <div className="bg-white p-3 rounded-lg border border-green-100 relative">
                        <div className="text-[10px] uppercase font-bold text-gray-400 mb-1 absolute top-2 right-2">
                          Target
                        </div>
                        <p className="text-xs text-gray-700 italic">
                          Targeting: {req.payload.target.split("_").join(" ")}
                        </p>
                      </div>
                    </div>
                  )}
