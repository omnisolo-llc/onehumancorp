...
export default function ApprovalInbox({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 font-inter py-10">
      <div className="w-[375px] max-w-[375px] min-h-[812px] bg-gradient-to-br from-gray-50 to-gray-100 shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200 dark:from-gray-900 dark:to-black dark:border-gray-800">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 pb-24 space-y-4 hide-scrollbar">
          {approvals.length === 0 ? (
            ...
            approvals.map((req) => {
              ...
              <div
                key={req.id}
                className="bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 dark:bg-[#16161a]/70 dark:border-white/10 rounded-2xl p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-all duration-300"
              >
