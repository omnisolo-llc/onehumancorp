...
export default function DepartmentCard({ name, pendingCount, onClick }: Props) {
  ...
  return (
    ...
    <button
      ...
      className={`w-full text-left translucent-glass-light dark:translucent-glass-dark border border-white/40 rounded-2xl p-5 flex items-center justify-between group mb-4 ${
        disabled
