    ...
    <div className="mb-6">
       ...
       {loading ? (
         ...
         <div className="space-y-3">
           {staff.map(member => (
             <div key={member.id} className="bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 rounded-2xl p-4 shadow-sm flex items-center justify-between">
               <div>
