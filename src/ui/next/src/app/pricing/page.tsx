    ...
    <div className="flex flex-col min-h-screen font-inter bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900 w-full overflow-x-hidden">
      ...
      <main id="pricing-screen" className="p-4 md:p-8 flex-1 max-w-6xl mx-auto w-full flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 w-full">
          {/* Free Tier */}
          <div className="p-6 flex flex-col justify-between app-card hover:shadow-xl hover:-translate-y-1 transition-all duration-300 w-full">
            <div>
          ...
          {/* Starter Tier */}
          <div className="p-6 flex flex-col justify-between relative app-card border border-indigo-200 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 w-full">
        ...
        <div className="p-6 app-card w-full mt-2">
