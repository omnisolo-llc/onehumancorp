  ...
  return (
    <div className="flex flex-col min-h-screen font-inter bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900 w-full overflow-x-hidden max-w-[100vw]">
      ...
      <main id="pricing-screen" className="p-4 md:p-8 flex-1 max-w-6xl mx-auto w-full flex flex-col gap-6">
        ...
        {/* My Plan Section */}
        <div className="mb-8 p-6 app-card ohc-growth-card glassmorphism glass-card backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-black/40 border border-white/40 dark:border-white/10 shadow-xl rounded-2xl w-full">
        ...
        <div className="p-6 app-card ohc-growth-card glassmorphism glass-panel backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-black/40 border border-white/40 dark:border-white/10 w-full mt-2 rounded-2xl">
