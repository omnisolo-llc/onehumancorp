...
export const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    <div className={`p-6 flex flex-col justify-between ${isRecommended ? 'relative shadow-xl' : 'shadow-lg'} app-card ohc-growth-card glass-card backdrop-blur-[40px] bg-white/60 border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.08)] rounded-2xl hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 w-full`}>
      {isRecommended && (
