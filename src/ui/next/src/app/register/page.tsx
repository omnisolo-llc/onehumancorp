            ...
            <form className="flex flex-col gap-5" onSubmit={submit}>
              <label className="flex flex-col gap-2 text-sm font-semibold text-gray-700 dark:text-gray-200">
                ...
                <input
                  autoComplete="email"
                  autoFocus
                  className="glassmorphism min-h-[52px] rounded-lg px-4 text-base"
              ...
              <button className="min-h-[54px] rounded-lg bg-[#1D1D1F] p-4 font-bold text-white disabled:opacity-60" disabled={pending || !settings.registration_available} type="submit">
