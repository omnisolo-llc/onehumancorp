...
export default function CostDashboardPage() {
  ...
  const [myPlanData, setMyPlanData] = useState<import('@/lib/business-records').BillingPlan | null>(null);
  ...
  return (
    ...
    >
      <div className="flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6 font-inter">
          ...
          <div className="app-panel-body p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  {myPlanData?.storage_used_bytes != null && (
                      <div className="p-4 app-card omnisolo-growth-card md:col-span-2 lg:col-span-4">
        ...
        <section className="app-panel glass-panel hover:shadow-xl transition-shadow duration-300">
            <div className="app-panel-header glass-panel px-6 py-4">
               <div className="flex justify-between items-center">
                   <div>
                       <h2 className="app-panel-title text-xl font-bold font-outfit text-gray-900 ">Cost Transparency Dashboard</h2>
            ...
            <div className="app-panel-body p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="app-card omnisolo-growth-card glass-card shadow-lg hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 rounded-2xl group">
        ...
        {/* Budget Health Alert */}
        {data && (data.budget_health_alert || (data.department_tier_usage?.departments?.some((d) => d.soft_limit_reached))) && (
        ...
        <section className="app-panel glass-panel backdrop-blur-2xl bg-white/40 border border-white/40 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-2xl overflow-hidden">
            ...
            <div className="app-panel-body p-6 space-y-4">
                <div className="flex flex-col app-card omnisolo-growth-card glass-card shadow-lg hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 rounded-2xl p-5 border border-white/30 backdrop-blur-md bg-white/50">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card omnisolo-growth-card glass-card shadow-lg hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 rounded-2xl p-5 border border-white/30 backdrop-blur-md bg-white/50">
                    <div>
        ...
        <section className="app-card omnisolo-growth-card glass-card shadow-lg rounded-2xl hover:shadow-2xl transition-shadow duration-300 p-6 md:p-8">
            ...
            {data?.department_tier_usage?.departments?.length ? (
                <div className="space-y-4" id="department-tier-usage-list">
                    {data.department_tier_usage.departments.map((department) => (
                        <div key={department.id} className="p-5 app-card omnisolo-growth-card">
