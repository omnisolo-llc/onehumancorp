  ...
  return (
    <div className="flex flex-col min-h-screen font-inter bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900">
      ...
      <main id="cost-dashboard-screen" className="p-4 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        <section className="app-panel glassmorphism shadow-lg rounded-[24px] hover:shadow-xl transition-shadow duration-300">
        ...
        <section className="p-6 md:p-8 shadow-lg glassmorphism rounded-2xl md:rounded-[24px] hover:shadow-xl transition-shadow duration-300">
