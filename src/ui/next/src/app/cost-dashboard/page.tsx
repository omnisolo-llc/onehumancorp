  ...
  return (
    <div className="flex flex-col min-h-screen font-inter bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900">
      ...
      <main id="cost-dashboard-screen" className="p-4 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        <section className="app-panel app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm hover:shadow-xl transition-shadow duration-300">
        ...
        <section className="app-panel app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="app-panel-body p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 group">
        ...
        <section className="app-panel app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="app-panel-body p-6 space-y-4">
                <div className="flex flex-col app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                    <div>
        ...
        <section className="p-6 md:p-8 app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm hover:shadow-xl transition-shadow duration-300">
            ...
            {data?.department_tier_usage?.departments?.length ? (
                <div className="space-y-4" id="department-tier-usage-list">
                    {data.department_tier_usage.departments.map((department) => (
                        <div key={department.id} className="p-5 rounded-2xl app-card bg-white/70 backdrop-blur-xl saturate-200 border border-white/40 shadow-sm">
