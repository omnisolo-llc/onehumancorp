      ...
      <main className="p-6 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        <section className="p-6 shadow-sm" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(20px) saturate(200%)', border: '1px solid rgba(255, 255, 255, 0.4)', borderRadius: '16px' }}>
            ...
            <div className="grid grid-cols-1 gap-6">
                <div className="p-4  rounded-xl border border-gray-100 shadow-sm" style={{ background: "rgba(255, 255, 255, 0.65)", backdropFilter: "blur(20px) saturate(200%)" }}>
        ...
        <section className="p-6 shadow-sm" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(20px) saturate(200%)', border: '1px solid rgba(255, 255, 255, 0.4)', borderRadius: '16px' }}>
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center p-4  rounded-xl border border-gray-100 shadow-sm" style={{ background: "rgba(255, 255, 255, 0.65)", backdropFilter: "blur(20px) saturate(200%)" }}>
                    <div>
