  ...
  return (
    ...
    >
      <div className="flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6 font-inter">
        <section className="app-panel glass-panel backdrop-blur-xl bg-white/10 dark:bg-black/10 border border-white/20 shadow-xl hover:shadow-xl transition-shadow duration-300 rounded-2xl overflow-hidden">
        ...
        {/* My Plan Section */}
        <section id="my-plan-section" className="app-panel glass-panel backdrop-blur-xl bg-white/10 dark:bg-black/10 border border-white/20 shadow-xl rounded-2xl overflow-hidden">
        ...
        <section className="app-panel glass-panel backdrop-blur-xl bg-white/10 dark:bg-black/10 border border-white/20 shadow-xl hover:shadow-xl transition-shadow duration-300 rounded-2xl overflow-hidden">
            ...
            <div className="app-panel-body p-6 space-y-4">
                <div className="flex flex-col app-card ohc-growth-card glass-card shadow-lg hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 rounded-2xl p-5 border border-white/20 dark:border-white/10 backdrop-blur-xl bg-white/40 dark:bg-black/40">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card ohc-growth-card glass-card shadow-lg hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 rounded-2xl p-5 border border-white/20 dark:border-white/10 backdrop-blur-xl bg-white/40 dark:bg-black/40">
                    <div>
        ...
        <section className="app-card ohc-growth-card glass-card shadow-xl rounded-2xl backdrop-blur-xl bg-white/10 border-white/20 hover:shadow-2xl transition-shadow duration-300 p-6 md:p-8">
