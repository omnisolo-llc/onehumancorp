...
export default function CostDashboardPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-inter bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900 w-full overflow-x-hidden">
      ...
      <main
        id="cost-dashboard-screen"
        className="p-4 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6"
      >
        <section className="app-panel hover:shadow-xl transition-shadow duration-300 rounded-2xl">
          ...
          <div className="app-panel-body p-6">
            <p className="text-gray-700 font-medium leading-relaxed">
              Cost and tier usage are based on connected backend billing,
              storage, network, and agent department usage signals.
            </p>
          </div>
        </section>
        ...
        <section
          id="my-plan-section"
          className="app-panel rounded-2xl shadow-sm"
        >
          ...
          <div className="app-panel-body p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-4 rounded-xl app-card">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">
                  {myPlanData?.ai_actions_used || 0}{" "}
                  <span className="text-sm text-gray-500 font-normal">
                    {myPlanData?.ai_actions_limit != null
                      ? `/ ${myPlanData.ai_actions_limit}`
                      : "/ Unlimited"}
                  </span>
                </p>
              </div>
              <div className="p-4 rounded-xl app-card">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">
                  {formatStorage(myPlanData?.storage_used_bytes || 0)}{" "}
                  <span className="text-sm text-gray-500 font-normal">
                    {myPlanData?.storage_limit_bytes != null
                      ? `/ ${formatStorage(myPlanData.storage_limit_bytes)}`
                      : "/ Unlimited"}
                  </span>
                </p>
              </div>
              <div className="p-4 rounded-xl app-card">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">
                  {formatCurrency(myPlanData?.next_bill_estimated || 0)}
                </p>
              </div>
            </div>
          ...
          <div className="app-panel-body p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 group p-6">
                ...
                <p
                  id="cost-dashboard-total"
                  className="text-3xl font-bold font-outfit text-gray-900"
                >
              ...
              <div className="app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 group p-6">
                ...
                <p
                  id="cost-dashboard-projected"
                  className="text-3xl font-bold font-outfit text-indigo-600"
                >
              ...
              <div className="app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 group p-6">
                ...
                <p
                  id="cost-dashboard-revenue"
                  className="text-3xl font-bold font-outfit text-green-600"
                >
              ...
              <div className="app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 group p-6">
                ...
                <p
                  id="cost-dashboard-total-savings"
                  className="text-3xl font-bold font-outfit text-green-700"
                >
                  {formatCurrency(data?.bandwidth_savings || 0)}
                </p>
                <p className="text-xs text-green-600 mt-2">
                  Saved via auto-compression
                </p>
              </div>
            </div>
          </div>
        ...
        {data && data.projected_monthly_cost > 10000 && (
          <div
            id="budget-health-alert"
            className="p-4 bg-amber-50/70 border border-amber-200 backdrop-blur-xl saturate-200 rounded-xl flex items-start gap-3"
          >
            <svg
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">
                ...
                {formatCurrency(data.projected_monthly_cost)}) is exceeding your
                typical baseline. Consider reviewing your agent usage or
                upgrading your tier for better bulk rates.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="app-panel-body p-6 space-y-4">
            <div className="flex flex-col app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              ...
              {data?.trend && data.trend.length > 0 ? (
                <div
                  className="flex items-end h-32 gap-2 mt-4"
                  id="cost-dashboard-trend"
                >
                  {data.trend.map((daily, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="w-full bg-indigo-50/50 rounded-t-md relative flex items-end justify-center group-hover:bg-indigo-100 transition-colors"
                          style={{ height: "100px" }}
                        >
                          <div
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Cost of AI agent actions and interactions.
                </p>
              </div>
              <div className="text-left sm:text-right w-full sm:w-auto">
                <span
                  id="cost-dashboard-llm"
                  className="text-lg font-semibold text-gray-900 block"
                >
                  {formatCurrency(data?.llm_cost || 0)}
                </span>
                <span className="text-xs text-gray-500 font-medium">
                  Efficiency: {data?.cache_hit_rate}% cache hit rate, $
                  {data?.cost_per_1k_tokens?.toFixed(4) || "0.0000"}/1k tokens
                </span>
              </div>
            </div>
                  ...
                  {data.agent_costs.map((agent, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium text-gray-900">
                        {formatCurrency(agent.cost_cents)}
                      </span>
                    </li>
                  ))}
                </ul>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Cost of cloud storage and file hosting.
                </p>
              </div>
              <span
                id="cost-dashboard-storage"
                className="text-lg font-semibold text-gray-900"
              >
                {formatCurrency(data?.storage_cost || 0)}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Stripe transaction fees on processed revenue.
                </p>
              </div>
              <span
                id="cost-dashboard-payment-fees"
                className="text-lg font-semibold text-gray-900"
              >
                {formatCurrency(data?.payment_fees || 0)}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Cost of container execution and background processing.
                </p>
              </div>
              <span
                id="cost-dashboard-compute"
                className="text-lg font-semibold text-gray-900"
              >
                {formatCurrency(data?.compute_cost || 0)}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Cost of CDN delivery and outbound traffic.
                </p>
              </div>
              <span
                id="cost-dashboard-network"
                className="text-lg font-semibold text-gray-900"
              >
                {formatCurrency(data?.network_cost || 0)}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Cost of transactional and marketing email delivery.
                </p>
              </div>
              <span
                id="cost-dashboard-email"
                className="text-lg font-semibold text-gray-900"
              >
                {formatCurrency(data?.email_cost || 0)}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Cost of third-party integration usage.
                </p>
              </div>
              <span
                id="cost-dashboard-api"
                className="text-lg font-semibold text-gray-900"
              >
                {formatCurrency(data?.api_cost || 0)}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card rounded-xl hover:-translate-y-1 hover:shadow-md transition-all duration-300 p-6">
              <div>
                ...
                <p className="text-sm text-green-600 mt-1">
                  Savings from automated WebP compression and minification.
                </p>
              </div>
              <span
                id="cost-dashboard-bandwidth-savings"
        ...
        <section className="p-6 md:p-8 app-card hover:shadow-xl transition-shadow duration-300 rounded-2xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6">
            <h2 className="text-xl font-bold font-outfit text-gray-900">
              Department Tier Usage
            </h2>
            <span className="text-sm text-gray-500 font-medium">
              {data?.department_tier_usage?.current_plan
                ? `${data.department_tier_usage.current_plan} plan`
                : "Loading..."}{" "}
              ·{" "}
              {data?.department_tier_usage?.period ||
          ...
          {data?.department_tier_usage?.departments?.length ? (
            <div className="space-y-4" id="department-tier-usage-list">
              {data.department_tier_usage.departments.map((department) => (
                <div key={department.id} className="p-5 rounded-2xl app-card">
                  ...
                  {department.usage_percent !== null ? (
                    <div
                      ...
                      aria-label={`${department.department_type} usage`}
                    >
                      <div
                        className={
                          department.soft_limit_reached
            ...
            <p
              ...
              id="department-tier-usage-empty"
            >
              No department usage recorded for this period.
            </p>
          )}
        </section>
      </main>
