      ...
      <main id="cost-dashboard-screen" className="p-4 md:p-8 flex-1 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        <section className="app-panel glassmorphism">
            ...
            <div className="app-panel-body space-y-4">
                <div className="flex flex-col app-card glassmorphism">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 app-card glassmorphism">
                    <div>
