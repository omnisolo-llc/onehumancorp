  ...
  return (
     <div className="flex flex-col items-center justify-center min-h-screen bg-[#F5F5F7] font-inter md:py-10 w-full overflow-x-hidden">
      <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] md:h-[812px] md:min-h-0 bg-white md:shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200 mobile-pos-container">
        ...
        {/* Header */}
        <div className="pt-12 pb-6 px-6 glassmorphism border-b sticky top-0 z-10 flex justify-between items-center">
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 bg-[#F5F5F7]">
           ...
           <div className="app-card rounded-2xl p-6 shadow-lg mb-6 text-center glassmorphism">
           ...
           <div className="grid grid-cols-2 gap-4 mb-8">
             <button
                ...
                disabled={reserving}
                className={`charge-btn min-h-[44px] min-w-[44px] p-4 rounded-[8px] text-left shadow-lg glassmorphism ${reserving ? 'opacity-50' : 'active:scale-[0.98]'}`}
             >
             ...
             <button className="min-h-[44px] min-w-[44px] p-4 rounded-[8px] text-left shadow-lg active:scale-[0.98] glassmorphism">
