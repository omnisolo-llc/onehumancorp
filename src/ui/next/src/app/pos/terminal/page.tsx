    ...
    if (isOffline) {
      ...
      try {
        const reserveRes = await fetch('/api/v1/payments/terminal/reserve', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ product_id: 'e2e-product-cake', quantity: 1, ttl_seconds: 15 })
        });
        ...
        await fetch('/api/v1/payments/terminal/commit', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ product_id: 'e2e-product-cake', quantity: 1, lock_id: reserveData.lock_id })
        });
