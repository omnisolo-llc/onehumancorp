        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 bg-gray-50">
           ...
           <div className="grid grid-cols-2 gap-4 mb-8">
             <button
                ...
                disabled={reserving}
                className={`bg-white p-4 min-h-[44px] rounded-2xl shadow-sm border border-gray-100 text-left ${reserving ? 'opacity-50' : 'active:scale-[0.98]'}`}
             >
             ...
             <button className="app-card p-4 min-h-[44px] rounded-2xl shadow-sm border border-gray-100 text-left active:scale-[0.98]">
