     ...
     <div className="flex flex-col items-center justify-center min-h-screen bg-[#F5F5F7] font-inter md:py-10 w-full overflow-x-hidden">
      <div className="w-full max-w-[375px] mx-auto min-h-[100dvh] md:h-[812px] md:min-h-0 bg-white md:shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200 mobile-pos-container">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 bg-[#F5F5F7]">
           ...
           <div className="app-card rounded-2xl p-6 shadow-lg mb-6 text-center ">
           ...
           <div className="grid grid-cols-2 gap-4 mb-8">
             <button
                ...
                disabled={reserving}
                className={`charge-btn min-h-[44px] min-w-[44px] glass-control  ${reserving ? 'opacity-50' : 'active:scale-[0.98]'}`}
             >
             ...
             <button className="min-h-[44px] min-w-[44px] glass-control active:scale-[0.98] ">
               ...
               <div className="grid grid-cols-1 gap-3 mb-8">
                  {inventory.length === 0 ? (
                    ...
                    <button
                      ...
                      className={`glass-control ${selectedProduct?.id === product.id ? 'bg-[rgba(255,255,255,0.65)] ring-1 ring-[#0066FF] border border-[#0066FF]' : 'bg-[rgba(255,255,255,0.65)] border border-[rgba(255,255,255,0.4)]'}`}
                    >
           ...
           {(isCartOpen || showPaymentSheet) && !checkoutComplete && (
             <div className="fixed inset-0 z-50 flex flex-col justify-end">
               ...
               <div className="relative translucent-glass-light rounded-t-3xl p-6 shadow-2xl animate-in slide-in-from-bottom max-h-[90vh] overflow-y-auto">
