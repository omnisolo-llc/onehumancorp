  ...
  return (
     <div className="flex flex-col items-center justify-center min-h-screen bg-[#F5F5F7] font-inter md:py-10 w-full overflow-hidden">
      <div className="w-full max-w-[375px] min-h-[100dvh] md:h-[812px] md:min-h-0 bg-white md:shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200">
        ...
        {/* Header */}
        <div className="pt-12 pb-6 px-6 bg-white/60 backdrop-blur-md border-b border-gray-200 sticky top-0 z-10 flex justify-between items-center">
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 bg-[#F5F5F7]">
           ...
           <div className="grid grid-cols-2 gap-4 mb-8">
             <button
                ...
                disabled={reserving}
                className={`charge-btn p-4 rounded-[16px] text-left bg-white/60 backdrop-blur-md border border-white/40 shadow-sm ${reserving ? 'opacity-50' : 'active:scale-[0.98]'}`}
             >
             ...
             <button className="p-4 rounded-[16px] text-left bg-white/60 backdrop-blur-md border border-white/40 shadow-sm active:scale-[0.98]">
           ...
           <div className="grid grid-cols-1 gap-3 mb-8">
              {inventory.length === 0 ? (
                ...
                <button
                  ...
                  className={`p-4 rounded-[16px] text-left transition-all active:scale-[0.98] min-h-[64px] min-w-[44px] ${selectedProduct?.id === product.id ? 'bg-white/80 border-[#0066FF] ring-1 ring-[#0066FF]' : 'bg-white/60 border-white/40'} backdrop-blur-md border shadow-sm`}
                >
