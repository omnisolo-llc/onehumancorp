...
export default function TerminalPage() {
  ...
  const handleNewOrder = () => {
    ...
    setCheckoutAmount(converted.amount);
  };
     ...
     <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 font-inter py-10">
      <div className="w-[375px] h-[812px] bg-white shadow-2xl overflow-hidden flex flex-col relative border-x border-gray-200">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 bg-gray-50">
           ...
           {checkoutAmount > 0 ? (
             <div className="mb-6">
               <StripeTerminalClient amount={checkoutAmount} onSuccess={handlePaymentSuccess} />
               <button
                 onClick={() => setCheckoutAmount(0)}
                 className="w-full mt-4 py-3 rounded-xl bg-gray-200 text-gray-700 font-bold hover:bg-gray-300 transition-colors"
               >
                 Cancel Checkout
               </button>
             </div>
