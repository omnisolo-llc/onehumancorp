          ...
          return (
            <div key={stage} className="min-w-[300px] flex-1 snap-center flex flex-col">
              ...
              <div className="flex flex-col gap-3 min-h-[200px] p-2 bg-gray-50/50 dark:bg-gray-900/20 rounded-xl border border-gray-200/50 dark:border-gray-800/50">
                ...
                {stageOpps.map(opp => (
                  <div key={opp.id} className="p-4 rounded-[12px] macos-translucent-glass border border-white/60 dark:border-white/10 shadow-sm flex flex-col gap-2 relative group cursor-pointer hover:shadow-md transition-shadow">
