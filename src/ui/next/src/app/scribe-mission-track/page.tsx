  ...
  return (
    <div className="min-h-screen bg-gray-50 flex justify-center font-inter">
      <div className="w-full max-w-[375px] bg-[#F5F5F7] min-h-screen shadow-xl relative flex flex-col">
        {/* Header */}
        <header className="px-5 pt-10 pb-4 bg-white/70 backdrop-blur-[20px] saturate-200 sticky top-0 z-20 border-b border-gray-200">
        ...
        <main className="flex-1 p-5 overflow-y-auto pb-24 space-y-4">
          {filteredMissions.map(mission => (
            <div key={mission.id} className="bg-white/80 backdrop-blur-[20px] saturate-200 border border-white/60 shadow-sm p-4 rounded-2xl hover:shadow-md transition-all active:scale-[0.98] cursor-pointer">
