...
const MISSIONS: Mission[] = [
  { id: '1', title: 'Convention Audit & Identity', status: 'active', progress: 50, agent: 'Scribe', department: 'Documentation' },
  { id: '2', title: 'README Overhaul', status: 'pending', progress: 0, agent: 'Scribe', department: 'Documentation' },
  { id: '3', title: 'Public Interface Documentation', status: 'pending', progress: 0, agent: 'Scribe', department: 'Documentation' },
];

export default function ScribeMissionTrackPage() {
      ...
      <div className="w-full max-w-[375px] bg-[#F5F5F7] min-h-screen shadow-xl relative flex flex-col">
        ...
        <header className="px-5 pt-10 pb-4 bg-white/70 backdrop-blur-[30px] saturate-[210%] sticky top-0 z-20 border-b border-gray-200">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="text-xs font-bold text-indigo-600 uppercase tracking-widest bg-indigo-50 px-2.5 py-1 rounded-full">Scribe Track</span>
          </div>
          <h1 className="text-3xl font-extrabold font-outfit text-gray-900 tracking-tight">Mission Control</h1>
          <p className="text-sm text-gray-500 mt-1 font-medium">Tracking your documentation progress.</p>
        </header>
