...
describe("ExitIntentBuilder", () => {
  ...
  it('encodes hostile editor text as inert JavaScript strings without innerHTML', async () => {
    await act(async () => { render(<ExitIntentBuilder />); });
  ...
  it('renders the builder and preview properly', async () => {
    await act(async () => { render(<ExitIntentBuilder />); });
