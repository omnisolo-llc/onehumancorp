  ...
  return (
    ...
    >
      <section id="scaling-screen" className="">
        ...
        <div className="glass-panel glass-card bg-[rgba(255,255,255,0.65)] backdrop-blur-[30px] saturate-[210%] border border-[rgba(255,255,255,0.4)] p-6 mt-4">
          <div className="glass-card bg-[rgba(255,255,255,0.65)] backdrop-blur-[30px] saturate-[210%] border border-[rgba(255,255,255,0.4)] p-6 mb-6">
          ...
          {results.length > 0 && (
            <div className="glass-card bg-[rgba(255,255,255,0.65)] backdrop-blur-[30px] saturate-[210%] border border-[rgba(255,255,255,0.4)] p-6">
