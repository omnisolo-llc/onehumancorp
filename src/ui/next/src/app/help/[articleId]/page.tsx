  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] py-12 px-4 sm:px-6 lg:px-8 font-inter">
      <div className="max-w-3xl mx-auto">
        ...
        <article className="app-card backdrop-blur-[30px] saturate-[210%] bg-white dark:bg-[#16161a]/70 border border-white/40 dark:border-white/10 shadow-2xl rounded-[32px] p-8 sm:p-12">
