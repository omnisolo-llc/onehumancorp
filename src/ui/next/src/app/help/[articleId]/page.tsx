...
export default function HelpArticlePage() {
  ...
  const articleData = articleId && typeof articleId === 'string' && articles[articleId] ? articles[articleId] : { title: "Article Not Found", content: <p>We couldn't find the article you're looking for.</p> };
