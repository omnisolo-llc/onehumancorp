    ...
    return (
      <div className="min-h-screen bg-[#F5F5F7] py-12 px-4 sm:px-6 lg:px-8 font-inter">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-4 font-outfit">
            Oops!
          </h1>
    ...
    <div className="min-h-screen bg-[#F5F5F7] py-12 px-4 sm:px-6 lg:px-8 font-inter">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <Link
            href="/help"
            className="text-[#0071E3] font-medium hover:underline inline-flex items-center"
          >
            <svg
        ...
        <article className="app-card backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border border-white/40 dark:border-white/10 shadow-2xl rounded-[32px] p-8 sm:p-12">
          <h1 className="text-3xl sm:text-4xl font-extrabold font-outfit text-gray-900 dark:text-gray-100 mb-8 tracking-tight">
            {article.title}
          </h1>
          <div
