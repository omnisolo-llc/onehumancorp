      ...
      <div className="max-w-4xl mx-auto">
        <div className="app-card backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border border-white/40 dark:border-white/10 p-8 sm:p-12 rounded-3xl shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-8">
            Welcome to OmniSolo OneHumanCorp! Let's get your business online in
            under 10 minutes.
          </p>
          ...
          <div className="space-y-6 mb-10">
            ...
            <div className="p-6 bg-blue-50/50 rounded-2xl border border-blue-100/50">
              ...
              <p className="text-blue-800/80">
                Upload a photo, set a price, and describe what you're selling.
              </p>
            </div>
            ...
            <div className="p-6 bg-blue-50/50 rounded-2xl border border-blue-100/50">
              ...
              <p className="text-blue-800/80">
                Connect your bank securely to get paid directly when customers
                buy.
              </p>
            </div>
          </div>
