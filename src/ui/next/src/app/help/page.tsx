      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 w-full sm:w-3/4 mx-auto">
          <input
            ...
            className="w-full p-4 rounded-2xl border border-white/50 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-[0_8px_32px_rgba(0,0,0,0.05)] text-gray-900 backdrop-blur-[20px] saturate-200 glassmorphism/70 hover:glassmorphism/80 min-h-[44px] text-base placeholder:text-gray-500 transition-all"
          />
        </div>

        {filteredArticles.length === 0 && filteredVideos.length === 0 ? (
          <div className="flex flex-col items-center justify-center glassmorphism/40 backdrop-blur-[20px] saturate-200 py-16 px-4 rounded-2xl border border-white/30 shadow-[0_4px_16px_rgba(0,0,0,0.02)]">
          ...
          <div className="relative w-full max-w-4xl bg-black rounded-2xl overflow-hidden shadow-2xl">
            <div className="absolute top-4 right-4 z-10 flex space-x-2">
              <button
                ...
                className="glassmorphism/10 hover:glassmorphism/20 text-white rounded-full p-2 backdrop-blur-md transition-all font-inter text-sm px-4 flex items-center gap-2 border border-white/20 shadow-lg"
              >
                Close video
              </button>
            </div>
