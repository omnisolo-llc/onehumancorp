      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 w-full sm:w-3/4 mx-auto">
          <input
            ...
            className="w-full p-4 rounded-2xl border border-white/40 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-[0_8px_32px_rgba(0,0,0,0.05)] text-gray-900 backdrop-blur-[30px] saturate-[210%] bg-white/65 hover:bg-white/75 min-h-[44px] text-base placeholder:text-gray-500 transition-all"
          />
        </div>

        {filteredArticles.length === 0 && filteredVideos.length === 0 ? (
          <div className="flex flex-col items-center justify-center bg-white/40 backdrop-blur-[30px] saturate-[210%] py-16 px-4 rounded-2xl border border-white/30 shadow-[0_4px_16px_rgba(0,0,0,0.02)]">
          ...
          <div className="space-y-12">
            ...
            <section className="mt-12 pt-8 border-t border-gray-200/50">
              <div className="bg-yellow-50/50 backdrop-blur-md rounded-2xl p-6 border border-yellow-200/50 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
