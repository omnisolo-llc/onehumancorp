          ...
          <div className="w-full block">
            <WithTooltip id="help-search-tooltip">
              <input
                ...
                className="w-full p-4 focus:outline-none focus:ring-2 focus:ring-blue-600 text-gray-900 backdrop-blur-[30px] saturate-[210%] bg-white/65 dark:bg-[#16161a]/70 border border-white/40 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.08)] hover:bg-white/90 min-h-[50px] text-base placeholder:text-gray-500 transition-all rounded-[24px]"
              />
            </WithTooltip>
          </div>
        </div>
