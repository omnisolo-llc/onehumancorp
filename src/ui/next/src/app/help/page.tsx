            ...
            {advancedArticles.length > 0 && (
              <div className="pt-8">
                <div className="border-t border-gray-200/50 pt-8 mt-4">
                  ...
                  <AnimatePresence>
                    {isAdvancedOpen && (<motion.div className="pt-6" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.3 }}><ArticleSections articles={advancedArticles} hoverBg="hover:bg-white/80" /></motion.div>)}
                  </AnimatePresence>
                </div>
              </div>
            )}
