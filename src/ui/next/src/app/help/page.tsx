      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 w-full sm:w-3/4 mx-auto">
          <input
            ...
            className="w-full p-4 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-[0_8px_32px_rgba(0,0,0,0.05)] text-gray-900 glassmorphism bg-white/60 backdrop-blur-[30px] saturate-[210%] border border-white/20 hover:bg-white/75 min-h-[44px] text-base placeholder:text-gray-500 transition-all rounded-xl"
          />
        </div>

        {filteredArticles.length === 0 && filteredVideos.length === 0 ? (
          <div className="flex flex-col items-center justify-center glassmorphism bg-white/60 backdrop-blur-[30px] saturate-[210%] border border-white/20 py-16 px-4 shadow-[0_4px_16px_rgba(0,0,0,0.02)] rounded-2xl">
          ...
          <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      {filteredArticles.filter(a => (a.category || "General") === category).map((article, idx) => (
                        <Link key={idx} href={article.link} className="block group">
                          <div className="glassmorphism bg-white/60 backdrop-blur-[30px] saturate-[210%] border border-white/20 p-6 shadow-[0_4px_16px_rgba(0,0,0,0.04)] rounded-2xl group-hover:border-blue-300 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.5)] group-hover:-translate-y-1 hover:bg-white/75 transition-all duration-300 cursor-pointer h-full flex flex-col min-h-[140px]">
            ...
            <section className="mt-12 pt-8 border-t border-gray-200/50">
              <div className="bg-yellow-50/60 glassmorphism backdrop-blur-[30px] saturate-[210%] rounded-2xl p-6 border border-yellow-200/50 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
