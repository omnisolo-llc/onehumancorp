                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {filteredArticles.map((article, idx) => (
                    <Link key={idx} href={article.link} className="block group">
                      <div className="bg-white/70 backdrop-blur-[24px] saturate-200 p-6 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.06)] border border-white/60 group-hover:bg-white/80 group-hover:border-blue-400 group-hover:shadow-[0_16px_48px_rgba(37,99,235,0.12)] group-hover:-translate-y-1 transition-all duration-300 ease-out cursor-pointer h-full flex flex-col min-h-[140px] ring-1 ring-black/5">
