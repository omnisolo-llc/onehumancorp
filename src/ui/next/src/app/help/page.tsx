          ...
          <div className="w-full relative block">
            <WithTooltip id="help-search-tooltip">
              ...
              {searchQuery.length > 0 && (
                <WithTooltip id="clear-search-tooltip" defaultText="Clear the search input">
                  <button aria-label="Clear search" onClick={() => setSearchQuery('')} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700">Clear</button>
                </WithTooltip>
              )}
            </WithTooltip>
          </div>
