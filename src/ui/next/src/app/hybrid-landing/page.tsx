  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 font-inter flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        {/* Card 1: Standalone */}
        <div className="ohc-growth-card glass-panel p-8 md:p-10 rounded-[24px] border border-white/50 shadow-xl bg-white/40 backdrop-blur-xl relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
