        ...
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:glassmorphism shadow-2xl">
           ...
           <div className="flex-1 overflow-y-auto px-6 space-y-6 pb-24">
              {drafts.map((d, idx) => (
                ...
                >
                   <div className="h-32 bg-white dark:bg-black/30 flex items-center justify-center relative backdrop-blur-[30px] saturate-[210%] border-b border-white/40 dark:border-white/10">
                   ...
                   <div className="p-4 bg-white dark:bg-black/40 backdrop-blur-[30px] saturate-[210%]">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <button
                    ...
                    className="w-full p-6 bg-white dark:bg-black/30 backdrop-blur-[30px] saturate-[210%] rounded-[8px] border border-white/50 dark:border-white/10 flex flex-col items-center gap-2 active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] group hover:bg-white/80 dark:hover:bg-black/50"
                  >
            ...
            {wizardStep === 2 && (
              <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                ...
                <div className="flex gap-4">
                  <button
                    className="flex-1 p-4 glassmorphism text-gray-700 dark:text-gray-300 font-bold font-outfit text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-white dark:hover:bg-black/40 active:scale-[0.98] border border-white/50 dark:border-white/10 backdrop-blur-[30px] saturate-[210%]"
                    style={{ borderRadius: '8px' }}
...
<div style="text-align: center; margin-top: 8px; font-family: sans-serif; font-size: 11px;">
  <a href="/onboarding?ref=${tenantId}" style="color: #646b78; text-decoration: none;">Powered by <b>OHC</b></a>
          ...
          <button
            className="w-full glassmorphism text-[#1D1D1F] dark:text-[#F5F5F7] font-bold p-4 rounded-[8px] active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-white dark:hover:bg-black/40 border border-white/50 dark:border-white/10 backdrop-blur-[30px] saturate-[210%]"
      ...
      <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:glassmorphism shadow-2xl">
            ...
            {blocks[selectedBlockIndex || 0]?.type === 'Hero' && (
              <>
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <button className="p-4 glassmorphism backdrop-blur-[30px] saturate-[210%] rounded-[8px] border border-white/50 dark:border-white/10 text-sm font-bold flex flex-col items-center gap-2 hover:bg-white dark:hover:bg-black/40">
                    <span>🖼️</span>
        ...
        <div className="absolute bottom-0 w-full p-4 glassmorphism border-t border-white/40 dark:border-white/10 z-50">
          <div className="flex gap-3 mb-2">
            ...
            <button className="flex-1 py-2 text-sm font-medium text-gray-600 bg-white dark:bg-black/20 backdrop-blur-[30px] saturate-[210%] border border-white/40 dark:border-white/10 rounded-[8px] inline-flex items-center justify-center gap-2">
