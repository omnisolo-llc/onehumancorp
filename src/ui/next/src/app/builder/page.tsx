...
export default function BuilderPage() {
  ...
  if (status === "selection") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter overflow-hidden">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden rounded-[16px] mac-glass-container shadow-2xl">
           ...
           <div className="absolute bottom-0 w-full p-6 mac-glass-container border-t border-white/40 dark:border-white/10 z-50">
              <button
                ...
                className="w-full bg-gradient-to-r from-[#0071E3] to-[#0052cc] text-white p-4 rounded-[8px] font-bold font-outfit shadow-md hover:shadow-lg active:scale-[0.98] transition-all"
              >
                ...
                <button
                  className={`w-full p-4 font-bold font-outfit text-lg transition-all ${
                    businessName.trim().length >= 3 && businessCategory.trim().length >= 5
                      ? "text-white shadow-md active:scale-[0.98] bg-gradient-to-r from-[#0071E3] to-[#0052cc]"
  ...
  if (status === "live") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col items-center overflow-x-hidden overflow-y-auto hide-scrollbar rounded-[16px] mac-glass-container shadow-2xl px-6 pt-12 pb-8">
        ...
        >
          <div className="space-y-4 font-inter">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#0071E3] to-[#0052cc] text-white p-4 rounded-[8px] font-bold mt-4 shadow-md hover:shadow-lg active:scale-[0.98] transition-all"
            >
              Save Changes
            </button>
          </div>
