...
export default function BuilderPage() {
  ...
  if (status === "selection") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter overflow-hidden">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] ohc-hybrid-panel shadow-2xl">
           ...
           <div className="absolute bottom-0 w-full p-6 ohc-hybrid-panel border-t border-white/40 dark:border-white/10 z-50">
              <button
  ...
  if (status === "live") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col items-center overflow-x-hidden overflow-y-auto hide-scrollbar sm:rounded-[16px] ohc-hybrid-panel shadow-2xl px-6 pt-12 pb-8">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter">
      <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] ohc-hybrid-panel shadow-2xl">
        ...
        {/* Bottom Action Bar */}
        <div className="absolute bottom-0 w-full p-4 ohc-hybrid-panel border-t border-white/40 dark:border-white/10 z-50">
