...
export default function BuilderPage() {
      ...
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter overflow-hidden">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] mac-glass-container shadow-2xl">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
            <div
              className="bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-[16px] border border-white/50 dark:border-white/10 shadow-sm p-8 w-full animate-fade-in"
          ...
          <div className="px-8 pt-12 pb-4">
            <div className="flex justify-between mb-8">
              {[1, 2, 3].map((step) => (
                <div
                  key={step}
                  className={`h-1.5 flex-1 mx-1 rounded-full ${step <= wizardStep ? "bg-[#0071E3]" : "bg-gray-200 dark:bg-gray-700"}`}
                  style={{
                      ...
                      <button
                        ...
                        className={`p-4 border text-left transition-all font-semibold backdrop-blur-md ${
                          vibe === v
                            ...
                            : "border-white/50 dark:border-white/10 text-gray-700 dark:text-gray-300 hover:border-white/80 dark:hover:border-white/20 bg-white/40 dark:bg-black/20"
                        }`}
                        style={{ borderRadius: "8px" }}
                      >
                        {v}
  ...
  if (status === "publishing") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] mac-glass-container shadow-2xl justify-center items-center">
      ...
      <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] mac-glass-container shadow-2xl">
        ...
        <div className="absolute bottom-0 w-full p-4 mac-glass-container border-t border-white/40 dark:border-white/10 z-50">
          <div className="flex gap-3 mb-2">
            <button className="flex-1 py-2 text-sm font-medium text-gray-600 bg-white/50 dark:bg-black/20 backdrop-blur-md border border-white/40 dark:border-white/10 rounded-[8px]">
              Change Vibe
            </button>
            {!isPremium && (
              <button
        ...
        {domainSelectionOpen && (
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm z-[60] flex flex-col justify-end">
            <div className="bg-white/90 dark:bg-[#16161a]/90 backdrop-blur-xl w-full rounded-t-[16px] p-6 shadow-2xl animate-slide-up pb-10">
              ...
              <div className="space-y-4">
                <button
                  className="w-full bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 p-4 rounded-[8px] font-semibold text-left hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full border border-gray-300 dark:border-gray-600 p-3 rounded-[8px] bg-white dark:bg-black focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 dark:text-gray-100"
