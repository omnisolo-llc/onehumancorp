      ...
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div className="w-[375px] h-[812px] bg-white shadow-2xl flex flex-col items-center justify-center border-x border-gray-200 text-center px-6 relative overflow-hidden">
          ...
          <div className="w-full mb-8">
            <p className="text-sm font-bold font-outfit text-gray-900 mb-3 text-left">Get Your First Sale 🚀</p>
            <div className="flex gap-3">
              <a
                href={`https://twitter.com/intent/tweet?text=I%20just%20launched%20my%20new%20store!%20Check%20it%20out:&url=${liveUrl}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-[#1DA1F2] text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-sm hover:bg-[#1a91da] transition-colors"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
                Twitter
              </a>
              <a
                href={`https://wa.me/?text=I%20just%20launched%20my%20new%20store!%20Check%20it%20out:%20${liveUrl}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-[#25D366] text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-sm hover:bg-[#22bf5b] transition-colors"
              >
