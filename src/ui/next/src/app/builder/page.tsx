...
export default function BuilderPage() {
  ...
  if (status === "selection") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter overflow-hidden">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] macos-translucent-glass shadow-2xl">
           ...
           <div className="flex-1 overflow-y-auto px-6 space-y-6 pb-24">
              {drafts.map((d, idx) => (
                <button
                  ...
                  className={`w-full text-left macos-translucent-glass backdrop-blur-[30px] saturate-[210%] rounded-[8px] border-2 transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] overflow-hidden ${selectedDraftIndex === idx ? 'border-[#0066FF] ring-2 ring-[#0066FF]/20 shadow-lg' : 'border-white/50 dark:border-white/10 opacity-70 hover:opacity-100 hover:border-white/80'}`}
                >
           ...
           <div className="absolute bottom-0 w-full p-6 macos-translucent-glass border-t border-white/40 dark:border-white/10 z-50">
              <button
      ...
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter overflow-hidden">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] macos-translucent-glass shadow-2xl">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
            <div className="macos-translucent-glass backdrop-blur-[30px] saturate-[210%] rounded-[16px] border border-white/50 dark:border-white/10 shadow-sm p-8 w-full animate-fade-in" style={{ animation: 'fadeIn 300ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
          ...
          <div className="px-8 pb-8 flex flex-col flex-1 justify-start overflow-y-auto">
            {wizardStep === 1 && (
              <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                ...
                <input
                  type="text"
                  className="w-full border border-white/50 dark:border-white/10 macos-translucent-glass backdrop-blur-[30px] saturate-[210%] p-4 mb-6 focus:ring-2 focus:ring-[#0066FF]/50 focus:border-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#f5f5f7] shadow-inner"
                ...
                <input
                  type="text"
                  className="w-full border border-white/50 dark:border-white/10 macos-translucent-glass backdrop-blur-[30px] saturate-[210%] p-4 mb-8 focus:ring-2 focus:ring-[#0066FF]/50 focus:border-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#f5f5f7] shadow-inner"
                  style={{ borderRadius: '8px' }}
                ...
                <button
                  className={`w-full p-4 font-bold font-outfit text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${
                    businessName.trim().length >= 3 && businessCategory.trim().length >= 5
                      ...
                      : "macos-translucent-glass text-gray-400 dark:text-gray-500 cursor-not-allowed border border-white/50 dark:border-white/10"
                  }`}
                  style={{ borderRadius: '8px' }}
            ...
            {wizardStep === 2 && (
              <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                  ...
                  {['Professional', 'Friendly', 'Energetic', 'Minimalist'].map((v) => (
                    <button
                      ...
                      className={`p-4 border text-left transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] font-semibold backdrop-blur-[30px] saturate-[210%] ${
                        vibe === v ? "border-[#0066FF] bg-[#0066FF]/10 text-[#0066FF] shadow-sm" : "border-white/50 dark:border-white/10 text-gray-700 dark:text-gray-300 hover:border-white/80 dark:hover:border-white/20 macos-translucent-glass"
                      }`}
                      style={{ borderRadius: '8px' }}
                    >
                      {v}
                ...
                <div className="flex gap-4">
                  <button
                    className="flex-1 p-4 macos-translucent-glass text-gray-700 dark:text-gray-300 font-bold font-outfit text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-white/60 dark:hover:bg-black/40 active:scale-[0.98] border border-white/50 dark:border-white/10 backdrop-blur-[30px] saturate-[210%]"
                    style={{ borderRadius: '8px' }}
                  ...
                  <button
                    className={`flex-1 p-4 font-bold font-outfit text-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${
                      vibe
                        ? "text-white shadow-md active:scale-[0.98] bg-gradient-to-r from-[#0066FF] to-[#0052cc]"
                        : "macos-translucent-glass text-gray-400 dark:text-gray-500 cursor-not-allowed border border-white/50 dark:border-white/10 backdrop-blur-[30px] saturate-[210%]"
                    }`}
                    style={{ borderRadius: '8px' }}
                    onClick={() => {
                       if (!bio.trim()) {
            ...
            {wizardStep === 3 && (
              <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                ...
                <WithTooltip id="bio-input-tooltip" defaultText="Describe what you sell, your target audience, and the vibe of your brand.">
                  <textarea
                    id="bio-input"
                    className="w-full border border-white/50 dark:border-white/10 macos-translucent-glass backdrop-blur-[30px] saturate-[210%] p-4 mb-8 focus:ring-2 focus:ring-[#0066FF]/50 focus:border-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] resize-none text-[#1D1D1F] dark:text-[#f5f5f7] shadow-inner"
                    style={{ borderRadius: '8px' }}
                    value={bio}
  ...
  if (status === "live") {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col items-center overflow-x-hidden overflow-y-auto hide-scrollbar sm:rounded-[16px] macos-translucent-glass shadow-2xl px-6 pt-12 pb-8">
          ...
          <div className="w-full macos-translucent-glass backdrop-blur-[30px] saturate-[210%] rounded-[16px] border border-white/50 dark:border-white/10 shadow-sm p-5 mb-4 text-left">
...
<div style="text-align: center; margin-top: 8px; font-family: sans-serif; font-size: 11px;">
  <a href="/onboarding?ref=${tenantId}" style="color: #646b78; text-decoration: none;">Powered by <b>OHC</b></a>
          ...
          <button
            className="w-full macos-translucent-glass text-[#1D1D1F] dark:text-[#F5F5F7] font-bold p-4 rounded-[8px] active:scale-[0.98] transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-white/60 dark:hover:bg-black/40 border border-white/50 dark:border-white/10 backdrop-blur-[30px] saturate-[210%]"
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter">
      <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] macos-translucent-glass shadow-2xl">
          ...
          <div className="space-y-4 font-inter">
            {blocks[selectedBlockIndex || 0]?.type === 'Hero' && (
              <>
                ...
                <input
                  type="text"
                  className="w-full p-4 macos-translucent-glass backdrop-blur-[30px] saturate-[210%] rounded-[8px] border border-white/50 dark:border-white/10 focus:ring-2 focus:ring-[#0066FF] outline-none transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#F5F5F7] shadow-inner"
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <button className="p-4 macos-translucent-glass backdrop-blur-[30px] saturate-[210%] rounded-[8px] border border-white/50 dark:border-white/10 text-sm font-bold flex flex-col items-center gap-2 hover:bg-white/60 dark:hover:bg-black/40">
                    <span>🖼️</span>
        ...
        {/* Bottom Action Bar */}
        <div className="absolute bottom-0 w-full p-4 macos-translucent-glass border-t border-white/40 dark:border-white/10 z-50">
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .macos-translucent-glass { background: rgba(255, 255, 255, 0.65); backdrop-filter: blur(30px) saturate(210%); -webkit-backdrop-filter: blur(30px) saturate(210%); border: 1px solid rgba(255, 255, 255, 0.4); border-radius: 16px; }
        @media (prefers-color-scheme: dark) {
          .macos-translucent-glass { background: rgba(22, 22, 26, 0.7); backdrop-filter: blur(30px) saturate(210%); -webkit-backdrop-filter: blur(30px) saturate(210%); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 16px; }
        }
      `}} />
    </div>
  );
