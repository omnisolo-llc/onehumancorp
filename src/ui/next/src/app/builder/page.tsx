        ...
        <div className="relative w-[375px] h-[812px] bg-white shadow-2xl overflow-hidden flex flex-col border-x border-gray-200">
           ...
           <div className="absolute bottom-0 w-full p-6 bg-white/90 backdrop-blur-md border-t border-gray-200">
              <button
                ...
                className="w-full bg-[#0071E3] text-white p-4 rounded-[16px] font-bold font-outfit shadow-lg active:scale-[0.98] transition-all"
              >
...
<div style="text-align: center; margin-top: 8px; font-family: sans-serif; font-size: 11px;">
  <a href="https://ohc.store/join?ref=${tenantId}" target="_blank" style="color: #646b78; text-decoration: none;">Powered by <b>OHC</b></a>
          ...
          <div className="w-full bg-white rounded-2xl border border-gray-200 shadow-sm p-5 mb-4 text-left">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex-1 bg-[#25D366] text-white flex items-center justify-center gap-2 p-3 rounded-[16px] font-semibold text-sm shadow-sm hover:bg-[#20bd5a] transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-black text-white flex items-center justify-center gap-2 p-3 rounded-[16px] font-semibold text-sm shadow-sm hover:bg-gray-800 transition-all"
              >
          ...
          <div className="w-full bg-blue-50 border border-blue-200 shadow-sm p-5 mb-6 text-left rounded-2xl">
            ...
            {geoScore === null ? (
              <button
                ...
                className="w-full bg-blue-600 text-white font-semibold py-2 rounded-[16px] text-sm shadow-sm hover:bg-blue-700 transition-all"
              >
                Analyze Visibility
              </button>
            ) : (
              <div className="animate-fade-in">
                ...
                <button
                  ...
                  disabled={seoApplied}
                  className={`w-full font-semibold py-2 rounded-[16px] text-sm shadow-sm transition-all ${
                    seoApplied
          ...
          <button
            className="w-full bg-gray-100 text-gray-800 font-bold p-4 rounded-[16px] active:scale-[0.98] transition-all hover:bg-gray-200"
      ...
      <div className="w-[375px] h-[812px] bg-white shadow-2xl flex flex-col relative border-x border-gray-200 overflow-hidden">
          ...
          <div className="space-y-4 font-inter">
            {blocks[selectedBlockIndex || 0]?.type === 'Hero' && (
              <>
                ...
                <input
                  type="text"
                  className="w-full p-4 bg-gray-50 rounded-[16px] border-none focus:ring-2 focus:ring-blue-500 transition-all"
            ...
            <button
              ...
              className="w-full bg-gray-900 text-white p-4 rounded-[16px] font-bold mt-4"
            >
              Save Changes
            </button>
          </div>
        ...
        <div className="absolute bottom-0 w-full p-4 bg-white/90 backdrop-blur-md border-t border-gray-200 z-50">
          ...
          <WithTooltip id="launch-btn-tooltip" defaultText="Launch your storefront immediately to a live URL.">
            <button
              id="launch-btn"
              className="w-full bg-blue-600 text-white p-4 rounded-[16px] font-bold shadow-lg hover:bg-blue-700 active:scale-[0.98] transition-all flex justify-center items-center gap-2"
          ...
          <div className="absolute inset-0 bg-black/60 z-[60] flex flex-col justify-end">
            <div className="bg-white w-full rounded-t-3xl p-6 shadow-2xl animate-slide-up pb-10">
              <div className="flex justify-between items-start mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-[16px] flex items-center justify-center text-2xl shadow-inner">
                  👑
                </div>
                <button
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-gray-900 to-black text-white font-bold p-4 rounded-[16px] shadow-lg active:scale-[0.98] transition-all flex justify-between items-center"
              >
