    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter overflow-hidden">
        <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] mac-glass-container shadow-2xl">
           ...
           <div className="flex-1 overflow-y-auto px-6 space-y-6 pb-24">
              {drafts.map((d, idx) => (
                <button
                  ...
                  className={`w-full text-left bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-[16px] border-2 transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] overflow-hidden ${selectedDraftIndex === idx ? 'border-[#0066FF] ring-2 ring-[#0066FF]/20 shadow-lg' : 'border-white/50 dark:border-white/10 opacity-70 hover:opacity-100 hover:border-white/80'}`}
                >
           ...
           <div className="absolute bottom-0 w-full p-6 mac-glass-container border-t z-50">
              <button
                onClick={() => setStatus("draft")}
                className="w-full bg-gradient-to-r from-[#0066FF] to-[#0052cc] text-white p-4 rounded-[8px] font-bold font-outfit shadow-md hover:shadow-lg active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
              >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <button
                    ...
                    className="w-full p-6 bg-white/60 dark:bg-black/30 backdrop-blur-sm rounded-[16px] border border-white/50 dark:border-white/10 flex flex-col items-center gap-2 active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] group hover:bg-white/80 dark:hover:bg-black/50"
                  >
          ...
          <div className="px-8 pb-8 flex flex-col flex-1 justify-start overflow-y-auto">
            {wizardStep === 1 && (
              <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                ...
                <input
                  type="text"
                  className="w-full border border-white/50 dark:border-white/10 bg-white/40 dark:bg-black/20 backdrop-blur-md p-4 mb-6 focus:ring-2 focus:ring-[#0066FF]/50 focus:border-[#0066FF] outline-none transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#f5f5f7] shadow-inner"
                ...
                <input
                  type="text"
                  className="w-full border border-white/50 dark:border-white/10 bg-white/40 dark:bg-black/20 backdrop-blur-md p-4 mb-8 focus:ring-2 focus:ring-[#0066FF]/50 focus:border-[#0066FF] outline-none transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#f5f5f7] shadow-inner"
                  style={{ borderRadius: '8px' }}
                ...
                <button
                  className={`w-full p-4 font-bold font-outfit text-lg transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] ${
            ...
            {wizardStep === 2 && (
              <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                ...
                <div className="grid gap-4 mb-8">
                  {['Professional', 'Friendly', 'Energetic', 'Minimalist'].map((v) => (
                    <button
                      key={v}
                      onClick={() => setVibe(v)}
                      className={`p-4 border text-left transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] font-semibold backdrop-blur-md ${
                ...
                <div className="flex gap-4">
                  <button
                    className="flex-1 p-4 bg-white/40 dark:bg-black/20 text-gray-700 dark:text-gray-300 font-bold font-outfit text-lg transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-white/60 dark:hover:bg-black/40 active:scale-[0.98] border border-white/50 dark:border-white/10 backdrop-blur-md"
                    style={{ borderRadius: '8px' }}
                  ...
                  <button
                    className={`flex-1 p-4 font-bold font-outfit text-lg transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] ${
                      vibe
                        ? "text-white shadow-md active:scale-[0.98] bg-gradient-to-r from-[#0066FF] to-[#0052cc]"
            ...
            {wizardStep === 3 && (
              <div className="animate-fade-in" style={{ animation: 'fadeIn 250ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                ...
                <WithTooltip id="bio-input-tooltip" defaultText="Describe what you sell, your target audience, and the vibe of your brand.">
                  <textarea
                    id="bio-input"
                    className="w-full border border-white/50 dark:border-white/10 bg-white/40 dark:bg-black/20 backdrop-blur-md p-4 mb-8 focus:ring-2 focus:ring-[#0066FF]/50 focus:border-[#0066FF] outline-none transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] resize-none text-[#1D1D1F] dark:text-[#f5f5f7] shadow-inner"
                    style={{ borderRadius: '8px' }}
                    value={bio}
                ...
                <div className="flex gap-4">
                  ...
                  <WithTooltip id="generate-btn-tooltip" defaultText="Our AI agents will analyze your description and build a ready-to-launch store for you.">
                    <button
                      id="generate-btn"
                      className={`flex-[2] p-4 font-bold font-outfit text-lg transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] ${
                        bio.trim().length > 5
                          ? "text-white shadow-md active:scale-[0.98] bg-gradient-to-r from-[#0066FF] to-[#0052cc]"
                          : "bg-white/40 dark:bg-black/20 text-gray-400 dark:text-gray-500 cursor-not-allowed border border-white/50 dark:border-white/10 backdrop-blur-md"
                      }`}
...
<div style="text-align: center; margin-top: 8px; font-family: sans-serif; font-size: 11px;">
  <a href="https://ohc.store/join?ref=${tenantId}" target="_blank" style="color: #646b78; text-decoration: none;">Powered by <b>OHC</b></a>
          ...
          <div className="w-full bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-[16px] border border-white/50 dark:border-white/10 shadow-sm p-5 mb-4 text-left">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex-1 bg-[#25D366] text-white flex items-center justify-center gap-2 p-3 rounded-xl font-semibold text-sm shadow-sm hover:bg-[#20bd5a] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-black text-white flex items-center justify-center gap-2 p-3 rounded-xl font-semibold text-sm shadow-sm hover:bg-gray-800 transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
              >
          ...
          <div className="w-full bg-blue-50/50 dark:bg-blue-900/20 backdrop-blur-md border border-[#0066FF]/30 dark:border-[#0066FF]/20 shadow-sm p-5 mb-6 text-left rounded-[16px]">
            ...
            {geoScore === null ? (
              <button
                ...
                className="w-full bg-blue-600 text-white font-semibold py-2 rounded-xl text-sm shadow-sm hover:bg-blue-700 transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
              >
                Analyze Visibility
              </button>
            ) : (
              <div className="animate-fade-in">
                ...
                <button
                  ...
                  disabled={seoApplied}
                  className={`w-full font-semibold py-2 rounded-xl text-sm shadow-sm transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] ${
                    seoApplied
          ...
          <button
            className="w-full bg-white/40 dark:bg-black/20 text-[#1D1D1F] dark:text-[#F5F5F7] font-bold p-4 rounded-[8px] active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-white/60 dark:hover:bg-black/40 border border-white/50 dark:border-white/10 backdrop-blur-md"
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-[#000] font-inter">
      <div className="relative w-[375px] h-[812px] sm:h-[812px] min-h-[100dvh] sm:min-h-auto flex flex-col overflow-hidden sm:rounded-[16px] mac-glass-container shadow-2xl">
          ...
          <div className="space-y-4 font-inter">
            {blocks[selectedBlockIndex || 0]?.type === 'Hero' && (
              <>
                ...
                <input
                  type="text"
                  className="w-full p-4 bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-[8px] border border-white/50 dark:border-white/10 focus:ring-2 focus:ring-[#0066FF] outline-none transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] text-[#1D1D1F] dark:text-[#F5F5F7] shadow-inner"
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#0066FF] to-[#0052cc] text-white p-4 rounded-[8px] font-bold mt-4 shadow-md hover:shadow-lg active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
            >
              Save Changes
            </button>
          </div>
        ...
        {/* Bottom Action Bar */}
        <div className="absolute bottom-0 w-full p-4 mac-glass-container border-t z-50">
          ...
          <WithTooltip id="launch-btn-tooltip" defaultText="Launch your storefront immediately to a live URL.">
            <button
              id="launch-btn"
              className="w-full bg-gradient-to-r from-[#34C759] to-[#2eb350] text-white p-4 rounded-[8px] font-bold shadow-md hover:shadow-lg active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] flex justify-center items-center gap-2"
          ...
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm z-[60] flex flex-col justify-end">
            <div className="bg-white/90 dark:bg-[#16161a]/90 backdrop-blur-xl w-full rounded-t-[16px] p-6 shadow-2xl animate-slide-up pb-10 border-t border-white/40 dark:border-white/10">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-gray-900 to-black dark:from-gray-100 dark:to-white dark:text-black text-white font-bold p-4 rounded-[8px] shadow-lg active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] flex justify-between items-center"
              >
