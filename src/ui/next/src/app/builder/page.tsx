      ...
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 font-inter">
        <div className="w-[375px] h-[812px] bg-white shadow-2xl flex flex-col items-center justify-center border-x border-gray-200 text-center px-6 relative overflow-hidden">
          ...
          <div className="w-full space-y-3">
            <button
              className="w-full bg-[#1DA1F2] text-white font-bold p-4 rounded-xl shadow-md active:scale-[0.98] flex items-center justify-center gap-2"
              onClick={() => {
                window.open(`https://twitter.com/intent/tweet?text=Just launched my new automated storefront on OHC! Check it out:&url=${liveUrl}`, '_blank');
              }}
            >
