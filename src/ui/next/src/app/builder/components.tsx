...
export function SmartBlock({ type, props }: { type: string; props: any }) {
  ...
  if (type === "PoweredBy") {
    ...
    return (
      <div className="py-6 bg-transparent flex flex-col items-center justify-center border-t border-white/40 dark:border-white/10 mt-6 powered-by-footer">
        <a
          href={`https://ohc.store/join?ref=${tenantId}&utm_source=powered_by`} target="_blank"
