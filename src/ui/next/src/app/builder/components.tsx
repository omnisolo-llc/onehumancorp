...
export function SkeletonBlock() {
  return (
    <div className="w-full p-6 animate-pulse">
      <div className="h-40 macos-translucent-glass rounded-[16px] mb-4" />
      <div className="h-4 w-3/4 macos-translucent-glass rounded-[8px] mb-2" />
      <div className="h-4 w-1/2 macos-translucent-glass rounded-[8px]" />
    </div>
  );
}
...
export function ActionSheet({ isOpen, onClose, title, children }: { isOpen: boolean; onClose: () => void; title: string; children: React.ReactNode }) {
  ...
  return (
    <div className="absolute inset-0 z-[100] flex flex-col justify-end">
      ...
      <div className="macos-translucent-glass w-full rounded-t-[16px] p-6 shadow-2xl animate-slide-up relative z-10">
...
export function QRCode({ value }: { value: string }) {
  return (
    <div className="macos-translucent-glass p-4 rounded-[16px] shadow-sm inline-block">
...
export function SmartBlock({ type, props }: { type: string; props: any }) {
  if (type === "Hero") {
    return (
      <div className="relative w-full overflow-hidden bg-white/20 dark:bg-black/20 min-w-[375px]">
        ...
        <div className="relative z-10 p-6 flex flex-col items-center justify-center min-h-[300px] text-center text-white m-4 rounded-[16px] macos-translucent-glass shadow-lg">
      ...
      <div className="p-6 bg-transparent font-inter min-w-[375px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {props.items.map((item: any, i: number) => (
            <div key={i} className="macos-translucent-glass shadow-sm p-4 rounded-[16px] flex flex-col">
              {item.image && (
  ...
  if (type === "Booking") {
    return (
      <div className="p-6 bg-transparent font-inter min-w-[375px]">
        <div className="macos-translucent-glass shadow-sm p-5 rounded-[8px] text-center">
  ...
  if (type === "Referral") {
    return (
      <div className="builder-block p-6 macos-translucent-glass font-inter text-center my-4 shadow-sm">
  ...
  if (type === "Contact") {
    return (
      <div className="p-6 macos-translucent-glass text-[#1D1D1F] dark:text-[#F5F5F7] font-inter text-center">
