    ...
    return (
      <div className="builder-block p-6 bg-gradient-to-br from-[#0066FF]/10 to-[#00C24B]/10 font-inter text-center border-t border-b border-white/40 dark:border-white/10 my-4 shadow-sm backdrop-blur-sm">
        ...
        <div className="flex gap-3 justify-center">
          <a
            href={`https://wa.me/?text=${encodeURIComponent(`Check out this store and get a discount! ${props.url || 'https://ohc.app'}`)}`}
            target="_blank"
          ...
          <a
            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Check out this store and get a discount! ${props.url || 'https://ohc.app'}`)}`}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href={`https://ohc.app/join?ref=${props.tenantId || 'storefront'}-referral`}
