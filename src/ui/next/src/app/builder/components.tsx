    ...
    <div className="absolute inset-0 z-[100] flex flex-col justify-end">
      ...
      <div className="mac-glass-container w-full rounded-t-[16px] p-6 shadow-2xl animate-slide-up relative z-10">
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={onClose} className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-full hover:bg-white/40 dark:hover:bg-black/40 transition-colors duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]">
...
export function DraggableBlock({
  ...
  return (
    <div
      draggable
      className={`relative group transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] cursor-move ${isSelected ? 'ring-2 ring-blue-500 z-10 shadow-lg scale-[1.02]' : 'hover:ring-1 hover:ring-blue-300'}`}
...
export function SmartBlock({ type, props }: { type: string; props: any }) {
          ...
          {props.items.map((item: any, i: number) => (
            <div key={i} className="mac-glass-container shadow-sm p-4 rounded-[16px] flex flex-col">
              <div className="flex justify-between items-start mb-1">
                ...
                <span className="font-bold text-[#1D1D1F] dark:text-[#F5F5F7] mac-glass-container px-2 py-1 rounded-[8px] text-sm">{item.price}</span>
              </div>
    ...
    return (
      <div className="p-6 bg-transparent font-inter min-w-[375px]">
        <div className="mac-glass-container shadow-sm p-5 rounded-[16px] text-center">
          ...
          <button className="w-full bg-gradient-to-r from-[#0066FF] to-[#0052cc] text-white font-semibold py-3 rounded-[8px] shadow-md hover:shadow-lg active:scale-[0.98] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]">
            Select Time
          </button>
        </div>
      </div>
      ...
      <div className="p-6 bg-gradient-to-br from-[#0066FF]/10 to-[#00C24B]/10 font-inter text-center border-t border-b border-white/40 dark:border-white/10 my-4 shadow-sm backdrop-blur-sm">
        ...
        <div className="flex gap-3 justify-center">
          <a
            ...
            className="flex-1 bg-gradient-to-r from-[#34C759] to-[#2eb350] text-white flex items-center justify-center gap-2 p-3 rounded-[8px] font-semibold text-sm shadow-sm hover:shadow-md hover:scale-[1.02] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] max-w-[140px]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 bg-black dark:bg-white text-white dark:text-black flex items-center justify-center gap-2 p-3 rounded-[8px] font-semibold text-sm shadow-sm hover:shadow-md hover:scale-[1.02] transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] max-w-[140px]"
          >
  ...
  if (type === "Contact") {
    return (
      <div className="p-6 mac-glass-container text-[#1D1D1F] dark:text-[#F5F5F7] font-inter text-center border-y-0 border-x-0 border-b">
    ...
    return (
      <div className="py-6 bg-transparent flex flex-col items-center justify-center border-t border-white/40 dark:border-white/10 mt-6">
        <a
          ...
          className="group flex items-center gap-2 text-sm text-gray-500 dark:text-[#A1A1A6] hover:text-[#1D1D1F] dark:hover:text-white transition-colors duration-250 ease-[cubic-bezier(0.4,0,0.2,1)]"
        >
          <span className="font-inter">Powered by</span>
          <span className="font-outfit font-bold tracking-tight">OHC</span>
          <svg className="w-4 h-4 opacity-0 -ml-2 group-hover:opacity-100 group-hover:ml-0 transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] text-[#0066FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
