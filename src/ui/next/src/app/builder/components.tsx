...
export function DraggableBlock({
  ...
  return (
    <div
      draggable
      className={`builder-block relative group transition-all duration-200 cursor-move ${isSelected ? 'ring-2 ring-blue-500 z-10 shadow-lg scale-[1.02]' : 'hover:ring-1 hover:ring-blue-300'}`}
