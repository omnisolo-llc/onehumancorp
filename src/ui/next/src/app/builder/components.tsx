  ...
  if (type === "Hero") {
    return (
      <div className="relative w-full overflow-hidden bg-white">
        ...
        <div className="relative z-10 p-6 flex flex-col items-center justify-center min-h-[300px] text-center text-white bg-white/65 backdrop-blur-[30px] saturate-[210%] border border-white/40 shadow-sm rounded-xl">
