    ...
    return (
      <div className="p-6 bg-white font-inter min-w-[375px]">
        <div className="backdrop-blur-[30px] saturate-[210%] bg-white/65 border border-white/40 shadow-[0_8px_32px_0_rgba(0,0,0,0.1)] p-5 rounded-[16px] text-center">
          ...
          <button className="w-full bg-blue-600 text-white font-semibold py-3 rounded-[8px] shadow-sm active:scale-[0.98] transition-transform">
            Select Time
          </button>
        </div>
      </div>
      ...
      <div className="p-6 bg-gradient-to-br from-indigo-50 to-purple-50 font-inter text-center border-t border-b border-indigo-100 my-4 shadow-sm">
        ...
        <div className="flex gap-3 justify-center">
          <a
            ...
            className="flex-1 bg-[#25D366] text-white flex items-center justify-center gap-2 p-3 rounded-[16px] font-semibold text-sm shadow-sm hover:bg-[#20bd5a] transition-all max-w-[140px]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 bg-black text-white flex items-center justify-center gap-2 p-3 rounded-[16px] font-semibold text-sm shadow-sm hover:bg-gray-800 transition-all max-w-[140px]"
          >
