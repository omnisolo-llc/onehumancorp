                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-[8px] focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
                        />
                    </div>
                    <div>
            ...
            <div className="p-6 shadow-md" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 255, 255, 0.4)', borderRadius: '16px' }}>
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        className={`w-full py-2 rounded-[8px] text-sm font-semibold transition-all ${copied ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'}`}
                    >
                    ...
                    <a
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-black text-white py-2 rounded-[8px] font-semibold text-sm shadow-sm hover:bg-gray-800 transition-all"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full flex items-center justify-center gap-2 bg-[#25D366] text-white py-2 rounded-[8px] font-semibold text-sm shadow-sm hover:bg-[#20bd5a] transition-all"
                    >
