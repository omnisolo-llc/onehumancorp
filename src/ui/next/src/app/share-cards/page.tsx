    ...
    <div className="flex flex-col min-h-screen font-inter" style={{ backgroundColor: '#F5F5F7' }}>
            ...
            <div className="p-6 shadow-md" style={{ background: 'rgba(255, 255, 255, 0.65)', backdropFilter: 'blur(30px) saturate(210%)', border: '1px solid rgba(255, 255, 255, 0.4)', borderRadius: '16px' }}>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full flex items-center justify-center gap-2 bg-[#25D366]/80 text-white py-2 rounded-lg font-semibold text-sm shadow-sm hover:bg-[#20bd5a] transition-all"
                        style={{ backdropFilter: 'blur(30px) saturate(210%)' }}
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full flex items-center justify-center gap-2 bg-[#0A66C2]/80 text-white py-2 rounded-lg font-semibold text-sm shadow-sm hover:bg-[#004182] transition-all"
                        style={{ backdropFilter: 'blur(30px) saturate(210%)' }}
                    >
      ...
      {showSoftPaywall && (
        <div className="fixed inset-0 bg-black/60 z-[60] flex items-center justify-center p-4">
          <div className="app-card glass-card w-full max-w-md rounded-2xl p-8 shadow-2xl relative overflow-hidden font-inter border border-indigo-100 text-center">
