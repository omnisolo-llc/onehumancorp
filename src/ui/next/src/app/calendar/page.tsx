...
export default function CalendarPage() {
  const [appointments, setAppointments] = useState([
    { id: '1', customer: 'Maya', service: 'Custom Cake Consultation', time: '10:00 AM', date: 'Today', status: 'confirmed', ai_scheduled: true, link: "https://meet.ohc.com/mock_meeting_123" },
