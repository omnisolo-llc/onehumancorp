    ...
    <div className="min-h-screen font-inter" style={{ backgroundColor: '#F5F5F7' }}>
      ...
      <main className="p-6 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <section className="app-card glass-card rounded-[16px] shadow-sm p-6 bg-white" style={{ border: '1px solid rgba(0,0,0,0.05)' }}>
        ...
        <div className="md:col-span-1 space-y-6">
          <section className="app-card glass-card rounded-[16px] shadow-sm p-6 bg-white sticky top-24" style={{ border: '1px solid rgba(0,0,0,0.05)' }}>
