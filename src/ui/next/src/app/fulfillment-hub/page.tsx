              ...
              <section>
                ...
                {toPack.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {toPack.map((order) => (
                      <div key={order.id} className="app-card glass-card rounded-xl shadow-sm border border-gray-100 p-4 relative overflow-hidden group">
                ...
                {awaitingPickup.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {awaitingPickup.map((order) => (
                      <div key={order.id} className="app-card glass-card rounded-xl shadow-sm border border-gray-100 p-4 relative overflow-hidden">
