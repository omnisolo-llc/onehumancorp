...
vi.mock('../../components/AppShell', () => ({ __esModule: true, AppShell: ({ children }: any) => <div data-testid="app-shell-mock">{children}</div>, default: ({ children }: any) => <div data-testid="app-shell-mock">{children}</div> }));
vi.mock('@/app/components/AppShell', () => ({ __esModule: true, AppShell: ({ children }: any) => <div data-testid="app-shell-mock">{children}</div>, default: ({ children }: any) => <div data-testid="app-shell-mock">{children}</div> }));
