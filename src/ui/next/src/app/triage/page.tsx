...
export default function TriagePage() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 p-6 rounded-[16px] glassmorphism bg-white/20 dark:bg-black/20 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-sm">
        ...
        <section className="app-panel glassmorphism bg-white/20 dark:bg-black/20 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-sm rounded-[16px]">
          ...
          <div id="triage-list" className="app-list px-6 pb-6">
            ...
            {!error && items.length === 0 ? (
              <div className="app-empty text-gray-500">{loading ? "Loading triage items..." : "No items need your attention right now. Great job!"}</div>
            ) : items.map((item) => (
              <button
                key={item.id}
                type="button"
          ...
          {!selected ? (
            ...
            <div className="app-panel-body px-6 pb-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="app-card glassmorphism bg-white/30 dark:bg-black/30 border border-white/40 dark:border-white/10 rounded-xl p-4">
