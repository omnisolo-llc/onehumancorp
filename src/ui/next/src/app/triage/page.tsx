          ...
          items.map((item) => {
            ...
            return (
              <div
                ...
                className="ohc-card w-full bg-white/60 dark:bg-black/60 backdrop-blur-[30px] saturate-[210%] border border-white/40 dark:border-white/10 rounded-[24px] shadow-sm flex flex-col mb-4 overflow-hidden"
              >
                {/* Header Context */}
                <div className="p-5 border-b border-gray-200 dark:border-white/10 bg-white/40 dark:bg-black/20 backdrop-blur-[30px] saturate-[210%]">
