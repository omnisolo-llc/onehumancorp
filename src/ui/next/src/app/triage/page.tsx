          ...
          {loading ? (
            ...
            <div className="app-panel-body p-6 flex flex-col gap-6 w-full">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <button
                  className="w-full flex-1 min-h-[44px] min-w-[44px] px-4 rounded-[8px] font-medium transition-transform active:scale-[0.98] shadow-md flex items-center justify-center cursor-pointer text-white"
