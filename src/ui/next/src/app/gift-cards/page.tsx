    ...
    <div className="flex flex-col min-h-screen font-inter" style={{ backgroundColor: '#F5F5F7' }}>
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full p-6 flex flex-col md:flex-row gap-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-4 py-2 rounded-xl border border-gray-300 bg-white backdrop-blur-[30px] backdrop-saturate-[2.1] shadow-sm-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all font-semibold"
                    min="5"
                    max="1000"
                  />
                </div>
        ...
        <section className="w-full md:w-2/3 flex flex-col gap-4">
           ...
           {/* Share Modal */}
           {showShareModal && (
             <div className="mt-4 p-6 rounded-2xl bg-white backdrop-blur-[30px] backdrop-saturate-[2.1] shadow-sm-lg border border-gray-100 flex flex-col gap-4 animate-in slide-in-from-bottom-4">
