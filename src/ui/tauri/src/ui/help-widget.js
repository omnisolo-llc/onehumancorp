document.addEventListener('DOMContentLoaded', () => {
    ...
    style.textContent = `
        #ohc-floating-help-btn {
            ...
            color: white;
            border: none;
            box-shadow: 0 4px 12px rgba(0, 102, 255, 0.3), 0 8px 24px rgba(0, 102, 255, 0.2);
            display: flex;
            align-items: center;
    ...
    widget.innerHTML = `
        ...
        <div id="tab-articles" class="ohc-help-content active">
            <div style="margin-bottom: 16px;">
                <a href="/api/ui/help.html" style="display: block; padding: 12px; background: rgba(241, 245, 249, 0.8); border-radius: 8px; text-decoration: none; color: #0f172a; font-weight: 500; text-align: center;">Open Full Help Center</a>
            </div>
            <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 8px;" id="ohc-help-articles-list">
                <li><a href="/api/ui/help_article.html?id=getting-started-1" style="color: #0066FF; text-decoration: none; font-size: 14px;">Welcome to One Human Corp</a></li>
                <li><a href="/api/ui/help_article.html?id=my-store-1" style="color: #0066FF; text-decoration: none; font-size: 14px;">Setting up your storefront</a></li>
                <li><a href="/api/ui/help_article.html?id=payments-1" style="color: #0066FF; text-decoration: none; font-size: 14px;">Accepting your first payment</a></li>
            </ul>
            <div style="margin-top: auto; padding-top: 16px; border-top: 1px solid rgba(226, 232, 240, 0.5);">
                <a href="/api/ui/api-docs.html" style="color: #64748b; font-size: 13px; text-decoration: none;">API Reference for advanced users</a>
            </div>
        </div>
            ...
            function renderStep() {
                ...
                bubble.innerHTML = `
                    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #eee; padding-bottom: 8px; margin-bottom: 8px;">
                        <h4 class="ohc-walkthrough-title" style="margin: 0; font-size: 16px; font-weight: bold;">${step.title || 'Tour'}</h4>
                    ...
                    <p class="ohc-walkthrough-text" style="margin: 0; font-size: 14px; color: #333;">${step.content || step.text}</p>
                    <div class="ohc-walkthrough-controls" style="display: flex; justify-content: flex-end; gap: 8px; margin-top: 8px;">
                        ${currentStep > 0 ? '<button id="wt-prev" class="ohc-walkthrough-btn-secondary" style="padding: 6px 12px; border: 1px solid #ccc; border-radius: 4px; background: white; cursor: pointer;">Back</button>' : ''}
                        <button id="wt-next" class="ohc-walkthrough-btn" style="padding: 6px 12px; border: none; border-radius: 4px; background: #0066FF; color: white; cursor: pointer;">${currentStep === steps.length - 1 ? 'Finish' : 'Next'}</button>
                    </div>
                `;
                ...
                if (target) {
                    target.classList.add('ohc-walkthrough-highlight');
