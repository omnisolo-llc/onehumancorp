...
export default function ApprovalInbox({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 font-inter py-10">
      <div className="w-[375px] max-w-[375px] min-h-screen bg-[rgba(255,255,255,0.65)] backdrop-blur-[30px] saturate-[210%] border-[1px] border-[rgba(255,255,255,0.4)] shadow-2xl overflow-hidden flex flex-col relative">
        {/* Header */}
        <div className="pt-12 pb-6 px-6 bg-[rgba(255,255,255,0.65)] backdrop-blur-[30px] saturate-[210%] border-b border-[rgba(255,255,255,0.4)] sticky top-0 z-10 flex items-center gap-4">
          <button
            onClick={onBack}
          ...
          {approvals.length === 0 ? (
            ...
            approvals.map((req) => {
              ...
              return (
                <div
                  key={req.id}
                  className="bg-[rgba(255,255,255,0.65)] backdrop-blur-[30px] saturate-[210%] border-[1px] border-[rgba(255,255,255,0.4)] rounded-[16px] p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-all duration-300"
                >
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 py-3 px-4 rounded-[8px] font-bold text-sm bg-[#0071E3] text-white hover:bg-blue-700 shadow-md shadow-blue-500/20 active:scale-[0.98] transition-all min-h-[44px]"
                    >
                      {req.payload?.feature_type === "case_study"
                        ? "Publish to Website"
                        : req.payload?.feature_type === "social_post"
