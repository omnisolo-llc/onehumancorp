...
export interface MemoryWidget24Props {
    id: string;
    value: number;
}

export default function MemoryWidget24({ id, value }: MemoryWidget24Props) {
    return (
        <div className="widget-container bg-neutral-800 p-4 rounded-lg shadow-md border border-neutral-700 m-2">
            <h3 className="text-lg font-bold text-neutral-300">Widget 24 - {id}</h3>
