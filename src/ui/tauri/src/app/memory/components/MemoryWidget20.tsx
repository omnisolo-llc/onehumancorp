...
export interface MemoryWidget20Props {
    id: string;
    value: number;
}

export default function MemoryWidget20({ id, value }: MemoryWidget20Props) {
    return (
        <div className="widget-container bg-neutral-800 p-4 rounded-lg shadow-md border border-neutral-700 m-2">
            <h3 className="text-lg font-bold text-neutral-300">Widget 20 - {id}</h3>
