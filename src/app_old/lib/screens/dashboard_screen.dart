                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text("OHC v2.4 is available. Upgrade now for 2x faster task handling.", style: TextStyle(fontFamily: 'Inter', fontSize: 13)),
                        ],
                      ),
                    ),
                    FilledButton(
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _Metric(label: 'Business Speed', value: 'Fast', color: colors.tertiary, icon: Icons.speed),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            healthy ? 'Business Running Smoothly' : 'Degraded',
            style: TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.bold,
              color: color,
