...
mod tests {
    ...
    fn test_parse_voice_turn_plan_from_llm_json() {
        ...
        assert_eq!(plan.sms_body.as_deref(), Some("Confirm here: https://cloud.omnisolo.co/confirm"));
        ...
        assert_eq!(plan2.sms_body.as_deref(), Some("Order here: https://cloud.omnisolo.co/store/voice"));
    }
        ...
        let planner = Arc::new(ScriptedVoiceTurnPlanner {
            plans: tokio::sync::Mutex::new(vec![
                ...
                VoiceTurnPlan {
                    ...
                    sms_body: Some("Confirm your booking: https://cloud.omnisolo.co/book/session".to_string()),
                },
            ]),
        });
