...
mod tests {
    ...
    async fn test_get_analytics_caching() {
        ...
        request1.metadata_mut().insert("x-spiffe-id", "spiffe://omnisolo.io/system/test".parse().unwrap());
        ...
        request2.metadata_mut().insert("x-spiffe-id", "spiffe://omnisolo.io/system/test".parse().unwrap());
