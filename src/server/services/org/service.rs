...
impl OrgService for MyOrgService {
    ...
    async fn get_analytics(
        ...
        let agents = agents_res.map_err(|e| Status::internal(format!("Failed to get agents: {}", e)))?;
        let meetings = meetings_res.map_err(|e| Status::internal(format!("Failed to get meetings: {}", e)))?;
        let summary = summary_res.map_err(|e| Status::internal(format!("Failed to get summary: {}", e)))?;
