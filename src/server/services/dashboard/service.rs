...
impl MyDashboardService {
    ...
    ) -> Result<Vec<::server_omnisolo::orchestration::Agent>, String> {
    ...
    async fn fetch_meetings_impl(
        ...
        org_id: &str,
        mobile_optimized: bool,
    ) -> Result<Arc<Vec<::server_omnisolo::orchestration::MeetingRoom>>, String> {
    ...
    async fn fetch_products_impl(
        ...
        org_id: &str,
        mobile_optimized: bool,
    ) -> Result<Vec<::server_omnisolo::organization::Product>, String> {
    ...
    async fn fetch_orders_impl(
        ...
        org_id: &str,
        mobile_optimized: bool,
    ) -> Result<Vec<::server_omnisolo::app::Order>, String> {
        let q = if mobile_optimized {
    ...
    async fn fetch_bookings_impl(
        ...
        org_id: &str,
        mobile_optimized: bool,
    ) -> Result<Vec<::server_omnisolo::app::Booking>, String> {
        let q = if mobile_optimized {
...
impl DashboardService for MyDashboardService {
    ...
    async fn get_dashboard(
        ...
        match cache.get_with_swr(&cache_key).await {
            Some((cached, is_stale)) if !is_stale => {
        ...
        let final_meetings = _meetings
            ...
            .map(|m| {
                let transcript = if req.mobile_optimized {
                    ...
                    m.transcript
                        .iter()
                        .map(|msg| ::server_omnisolo::agent::AgentMessage {
                            id: msg.id.clone(),
...
mod tests {
    ...
    async fn setup_test_dashboard_service() -> MyDashboardService {
        ...
        let _ = hub
            .clone()
            .publish(::server_omnisolo::orchestration::Message {
                id: "msg_1".to_string(),
