...
impl DashboardService for MyDashboardService {
    async fn get_dashboard(
        ...
        let products = products_res.map_err(|e| Status::internal(e.to_string()))?.map_err(|e| Status::internal(e))?;
        let orders = orders_res.map_err(|e| Status::internal(e.to_string()))?.map_err(|e| Status::internal(e))?;
        let org = org_res.map_err(|e| Status::internal(e.to_string()))?.map_err(|e| Status::internal(e))?;
