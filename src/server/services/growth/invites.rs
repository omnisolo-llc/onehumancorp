...
impl InviteTracker {
    ...
    pub async fn record_invite(&self, team_id: &str, inviter_id: &str, invitee_id: &str) -> Result<String, String> {
        let id = format!("inv-{}", Utc::now().timestamp_nanos_opt().unwrap_or(0));
