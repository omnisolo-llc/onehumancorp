...
impl OnboardingAgent {
    ...
    async fn generate_initial_products(&self, org_id: &str, business_type: &str) -> Result<(), String> {
        let products = match business_type {
            ...
            "Home Bakery" => vec![
                ("Custom Celebration Cake", "Beautiful custom cake for your special occasion", 8500, "physical"),
                ("Dozen Cupcakes", "Assorted seasonal cupcakes", 3600, "physical"),
                ("Cake Tasting Box", "Sample 4 of our most popular flavors", 2500, "physical"),
                ("Macaron Tower", "Elegant tower of 40 French macarons", 12000, "physical"),
                ("Wedding Cake Consultation", "1-hour design and tasting session", 5000, "booking"),
            ],
            "Freelance Handyman" => vec![
                ("General Fixes (1 Hour)", "Quick repairs and odd jobs around the house", 8500, "booking"),
                ("TV Mounting & Setup", "Professional wall mounting and cable hiding", 12000, "booking"),
                ("Furniture Assembly", "Assembly of flat-pack furniture per item", 6500, "booking"),
                ("Minor Plumbing Repair", "Fix leaky faucets or replace fixtures", 9500, "booking"),
                ("Drywall Patch & Paint", "Repair holes and match existing paint", 15000, "booking"),
            ],
            "Boutique" => vec![
                ("Summer Floral Dress", "Light and breezy summer dress", 6500, "physical"),
                ("Classic Denim Jacket", "Timeless denim jacket with a modern cut", 8500, "physical"),
                ("Silk Scarf", "Elegant silk scarf in seasonal patterns", 3500, "physical"),
                ("Leather Crossbody Bag", "Genuine leather everyday bag", 12000, "physical"),
                ("Personal Styling Session", "1-hour personalized wardrobe consultation", 5000, "booking"),
            ],
            "Music Tutor" => vec![
                ("Guitar Lesson (45 min)", "One-on-one personalized guitar instruction", 5500, "booking"),
                ("Piano Lesson (45 min)", "Beginner to intermediate piano instruction", 6000, "booking"),
                ("Vocal Coaching (1 hr)", "Vocal technique and performance coaching", 7500, "booking"),
                ("4-Lesson Package", "Discounted bundle of 4 weekly lessons", 20000, "physical"),
                ("Music Theory Consultation", "30-minute assessment and planning", 3000, "booking"),
            ],
            "Food Cart" => vec![
                ("Signature Burger Combo", "Burger, fries, and a drink", 1400, "physical"),
                ("Spicy Chicken Wrap", "Grilled chicken wrap with spicy sauce", 900, "physical"),
                ("Loaded Fries", "Fries topped with cheese and bacon", 750, "physical"),
                ("Vegetarian Bowl", "Healthy bowl with quinoa and roasted veggies", 1100, "physical"),
                ("Catering Pre-Order (10 people)", "Assorted platters for a small gathering", 12000, "physical"),
            ],
