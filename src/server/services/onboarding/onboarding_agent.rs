...
impl OnboardingAgent {
    ...
    async fn generate_initial_products(&self, org_id: &str, business_type: &str) -> Result<(), String> {
        let products = match business_type {
            ...
            "Handyman" => vec![
                ("Plumbing Fix", "Repair leaky pipes and fixtures", 15000, "booking"),
                ("General Repair", "Hourly rate for general repairs", 8500, "booking"),
                ("Painting", "Interior and exterior painting service", 25000, "booking"),
                ("Consultation", "Expert advice and assessment", 5000, "booking"),
            ],
            "Boutique" => vec![
                ("Summer Dress", "Lightweight summer dress", 5999, "physical"),
                ("Classic T-Shirt", "100% cotton classic fit", 2999, "physical"),
                ("Denim Jacket", "Vintage wash denim jacket", 8999, "physical"),
                ("Accessories Bundle", "Curated accessories set", 4500, "physical"),
            ],
            "Music Tutor" => vec![
                ("Online Guitar Lesson", "1-hour 1-on-1 online session", 6000, "booking"),
                ("In-Person Lesson", "1-hour 1-on-1 local session", 8000, "booking"),
                ("Monthly Package", "4 lessons per month", 20000, "booking"),
                ("Introductory Session", "30-minute trial lesson", 3000, "booking"),
            ],
            "Food Cart" => vec![
                ("Signature Pre-Order", "Our famous signature dish for pickup", 1299, "physical"),
                ("Combo Meal", "Main, side, and drink", 1599, "physical"),
                ("Family Platter", "Feeds 4-6 people", 4599, "physical"),
                ("Daily Special", "Chef's choice of the day", 1099, "physical"),
            ],
            "Bakery" => vec![
                ("Custom Vegan Cake", "Plant-based celebration cake", 6500, "physical"),
                ("Assorted Cupcakes", "Box of 12 artisan cupcakes", 3500, "physical"),
                ("Wedding Cake Deposit", "Initial deposit for custom wedding cake", 15000, "booking"),
                ("Gluten-Free Brownies", "Box of 6 fudgy brownies", 2400, "physical"),
            ],
            "Restaurant / Food" => vec![
