...
pub fn generate_preflight_report(res: &PreflightResult) -> String {
    ...
    format!(
        "<div style=\"backdrop-filter: blur(30px) saturate(210%); background: rgba(255, 255, 255, 0.65); font-family: 'Outfit', 'Inter', sans-serif; color: #1D1D1F; padding: 20px; border-radius: 16px; border: 1px solid rgba(255, 255, 255, 0.4);\">\n\
...
mod tests {
    ...
    fn test_generate_preflight_report() {
        ...
        assert!(report.contains("blur(30px)"));
