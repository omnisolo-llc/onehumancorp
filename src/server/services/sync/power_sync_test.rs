...
mod tests {
    ...
    async fn test_power_sync_e2e_flow() {
        ...
        use ::server_omnisolo::orchestration::{PowerSyncPushRequest, PowerSyncPushResponse, PowerSyncPullRequest, PowerSyncPullResponse};
        use ::server_omnisolo::orchestration::sync_service_server::{SyncService, SyncServiceServer};
        ...
        impl SyncService for MockSyncService {
            async fn hybrid_sync_missions(
                &self,
                _request: Request<::server_omnisolo::orchestration::HybridSyncMissionsRequest>,
            ) -> Result<Response<::server_omnisolo::orchestration::HybridSyncMissionsResponse>, Status> {
                Ok(Response::new(::server_omnisolo::orchestration::HybridSyncMissionsResponse {
            ...
            async fn vector_sync(
                &self,
                _request: Request<::server_omnisolo::orchestration::VectorSyncRequest>,
            ) -> Result<Response<::server_omnisolo::orchestration::VectorSyncResponse>, Status> {
                Ok(Response::new(::server_omnisolo::orchestration::VectorSyncResponse {
                    status: "success".to_string(),
                    message: "mock".to_string(),
                }))
            }
            ...
            async fn sync_mcp_deltas(
                &self,
                _request: Request<::server_omnisolo::orchestration::SyncMcpDeltasRequest>,
            ) -> Result<Response<::server_omnisolo::orchestration::SyncMcpDeltasResponse>, Status> {
                Ok(Response::new(::server_omnisolo::orchestration::SyncMcpDeltasResponse {
                    status: "success".to_string(),
                    message: "mock".to_string(),
                    synced_count: 0,
                }))
            ...
            async fn sync_escalation(
                &self,
                _request: Request<::server_omnisolo::orchestration::SyncEscalationRequest>,
            ) -> Result<Response<::server_omnisolo::orchestration::SyncEscalationResponse>, Status> {
                Ok(Response::new(::server_omnisolo::orchestration::SyncEscalationResponse {
                    status: "success".to_string(),
                    message: "mock".to_string(),
                    synced_count: 0,
                }))
