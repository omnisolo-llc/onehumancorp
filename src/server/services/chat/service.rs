...
impl ChatService for MyChatService {
    ...
    async fn get_chat_messages(
        ...
        let req = request.into_inner();
        let messages = self.registry.chat_messages(&req.integration_id, &tenant_id);
    ...
    async fn send_chat_message(
        ...
        match self.registry.send_chat_message(&req.integration_id, &req.channel, &req.from_agent, &req.content, &req.thread_id, &tenant_id) {
...
mod tests {
    ...
    async fn test_chat_service() {
        ...
        let req = Request::new(ChatSendRequest {
            integration_id: "test-int".to_string(),
        ...
        let req = Request::new(GetChatMessagesRequest {
            integration_id: "test-int".to_string(),
        });
