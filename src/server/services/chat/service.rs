...
impl ChatService {
    ...
    pub async fn create_inbox(
        ...
        sqlx::query_as(
            ...
            VALUES ($1, $2, $3)
            RETURNING id, tenant_id, name, working_hours_enabled, out_of_office_message, greeting_enabled, greeting_message, csat_survey_enabled, auto_assignment_config, created_at, updated_at
            "#
        )
        .bind(Uuid::new_v4())
        .bind(tenant_id)
    ...
    pub async fn start_conversation(
        ...
        sqlx::query_as(
            ...
            RETURNING id, tenant_id, inbox_id, contact_id, assignee_id, bot_assignee_id, status, waiting_since, created_at, updated_at
            "#
        )
        .bind(Uuid::new_v4())
        .bind(tenant_id)
