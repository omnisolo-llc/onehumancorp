-- 059_harden_rls_final.sql
-- Harden RLS policies by removing the empty string ('') fail-open vulnerability.

-- Redefine policies from 055_missing_rls.sql
...
-- Redefine policy from 057_transcripts_rls.sql
