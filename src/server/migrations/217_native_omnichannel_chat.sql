...
CREATE INDEX IF NOT EXISTS idx_chat_conversations_tenant_status ON chat_conversations(tenant_id, status);

CREATE TABLE IF NOT EXISTS chat_messages (
    id UUID PRIMARY KEY,
    tenant_id UUID NOT NULL,
    conversation_id UUID NOT NULL REFERENCES chat_conversations(id) ON DELETE CASCADE,
    sender_type TEXT NOT NULL, -- e.g. 'Contact', 'Agent', 'Bot', 'System'
    sender_id UUID,
    content TEXT NOT NULL,
    message_type TEXT DEFAULT 'incoming', -- 'incoming', 'outgoing', 'template'
