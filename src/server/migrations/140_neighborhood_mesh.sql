-- Migration 140: Neighborhood Collective Mesh and Loyalty Ledger
...
ALTER TABLE ohc_shared_loyalty_ledger ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS tenant_isolation_ohc_shared_loyalty_ledger ON ohc_shared_loyalty_ledger;
CREATE POLICY tenant_isolation_ohc_shared_loyalty_ledger
ON ohc_shared_loyalty_ledger
USING (originating_tenant_id = current_setting('app.current_tenant', true) OR target_tenant_id = current_setting('app.current_tenant', true));
