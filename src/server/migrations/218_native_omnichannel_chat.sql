...
CREATE INDEX idx_chat_inboxes_tenant_id ON chat_inboxes(tenant_id);
...
CREATE INDEX idx_chat_contacts_tenant_id ON chat_contacts(tenant_id);
...
CREATE INDEX idx_chat_conversations_tenant_inbox ON chat_conversations(tenant_id, inbox_id);
CREATE INDEX idx_chat_conversations_tenant_contact ON chat_conversations(tenant_id, contact_id);
CREATE INDEX idx_chat_conversations_tenant_created ON chat_conversations(tenant_id, created_at);
...
CREATE INDEX idx_chat_messages_tenant_conversation_created ON chat_messages(tenant_id, conversation_id, created_at);
