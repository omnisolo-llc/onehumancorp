...
-- Apply RLS policies for newly created tables to enforce multi-tenant isolation
-- Note: SQLx's migrator executes this automatically on Postgres. SQLite does not use these files.
