...
CREATE POLICY system_bypass_swarm_truth_embeddings ON swarm_truth_embeddings USING (current_setting('app.current_tenant', true) = 'system');
CREATE POLICY system_bypass_agent_session_data ON agent_session_data USING (current_setting('app.current_tenant', true) = 'system');
