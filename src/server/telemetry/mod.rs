...
pub fn get_ohc_job_queue_delay_histogram() -> &'static Histogram<f64> {
...
pub fn record_ohc_job_queue_delay(delay: f64, deployment_mode: &str) {
    let histogram = get_ohc_job_queue_delay_histogram();
