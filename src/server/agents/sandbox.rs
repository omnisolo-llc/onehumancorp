...
impl LocalEnvironment {
    pub async fn execute(
        ...
        let rusage_start = rusage_helper::start();
        ...
        match timeout(timeout_dur, child).await {
            Ok(output_result) => {
                ...
                rusage_helper::end_and_record(rusage_start);
...
mod rusage_helper {
    ...
    pub fn end_and_record(rusage_start: libc::rusage) {
        unsafe {
