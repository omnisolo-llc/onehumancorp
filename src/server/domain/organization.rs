...
fn default_software_company_role_profiles() -> Vec<RoleProfile> {
    vec![
        RoleProfile {
            role: Role::Ceo as i32,
            base_prompt: "Set company direction, approve tradeoffs, keep organization aligned CEO's goals.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::EngineeringDirector as i32,
            base_prompt: "Coordinate engineering delivery, unblock technical execution, balance architecture, quality, speed.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::ProductManager as i32,
            base_prompt: "Turn CEO goals into scopes, user stories, concrete deliverables rest organization.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::MarketingManager as i32,
            base_prompt: "Translate product direction into positioning, launch messaging, acquisition plans.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::Designer as i32,
            base_prompt: "Design user flows, interfaces match scoped requirements, reduce delivery ambiguity.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::SoftwareEngineer as i32,
            base_prompt: "Implement approved work, keep changes testable, collaborate quickly QA, security.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::QaTester as i32,
            base_prompt: "Probe product quality, validate acceptance criteria, highlight regressions before release.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::SecurityEngineer as i32,
            base_prompt: "Review product changes security risk, drive fixes before operational issues.".to_string(),
            capabilities: vec![
        ...
        RoleProfile {
            role: Role::AiNewsCollector as i32,
            base_prompt: "Continuously monitor, retrieve latest news, industry updates relevant organization.".to_string(),
            capabilities: vec![
...
fn default_digital_marketing_role_profiles() -> Vec<RoleProfile> {
    vec![
        RoleProfile {
            role: Role::Ceo as i32,
            base_prompt: "Drive client acquisition strategy, keep campaigns aligned business outcomes.".to_string(),
        ...
        RoleProfile {
            role: Role::MarketingManager as i32,
            base_prompt: "Orchestrate multi-channel marketing operations, coordinate delivery across specializations.".to_string(),
        ...
        RoleProfile {
            role: Role::GrowthAgent as i32,
            base_prompt: "Identify, exploit growth opportunities through data-driven lead generation, conversion optimization.".to_string(),
        ...
        RoleProfile {
            role: Role::ContentStrategist as i32,
            base_prompt: "Produce high-quality content positions clients thought leaders, drives organic acquisition.".to_string(),
        ...
        RoleProfile {
            role: Role::SeoSpecialist as i32,
            base_prompt: "Maximize organic search visibility through technical SEO, keyword strategy, link building.".to_string(),
        ...
        RoleProfile {
            role: Role::PaidMediaManager as i32,
            base_prompt: "Optimize paid acquisition across Google, Meta, LinkedIn maximize ROAS within budget.".to_string(),
        ...
        RoleProfile {
            role: Role::AnalyticsEngineer as i32,
            base_prompt: "Build data pipelines, dashboards give team real-time visibility campaign performance.".to_string(),
        ...
        RoleProfile {
            role: Role::Designer as i32,
            base_prompt: "Produce visuals, creative assets communicate brand story, drive engagement.".to_string(),
...
fn default_accounting_role_profiles() -> Vec<RoleProfile> {
    vec![
        RoleProfile {
            role: Role::Ceo as i32,
            base_prompt: "Ensure firm delivers accurate financial services full compliance regulations.".to_string(),
        ...
        RoleProfile {
            role: Role::Cfo as i32,
            base_prompt: "Lead financial planning, reporting, risk management client engagements.".to_string(),
        ...
        RoleProfile {
            role: Role::Bookkeeper as i32,
            base_prompt: "Maintain accurate day-to-day financial records, reconcile accounts precision.".to_string(),
        ...
        RoleProfile {
            role: Role::TaxSpecialist as i32,
            base_prompt: "Minimize tax liability while ensuring complete, timely regulatory compliance.".to_string(),
        ...
        RoleProfile {
            role: Role::AuditManager as i32,
            base_prompt: "Conduct thorough audits, validate integrity financial statements.".to_string(),
        ...
        RoleProfile {
            role: Role::PayrollManager as i32,
            base_prompt: "Process payroll accurately on time, managing compliance across jurisdictions.".to_string(),
