...
impl Conversation {
    pub fn new(tenant_id: impl Into<String>, inbox_id: Uuid, contact_id: Uuid) -> Self {
        let now = Utc::now();
        Self {
            id: Uuid::new_v4(),
...
mod tests {
    ...
    fn test_conversation_new() {
        ...
        let conversation = Conversation::new(tenant_id, inbox_id, contact_id);
    ...
    fn test_conversation_serialization() {
        let conversation = Conversation::new("tenant-123", Uuid::new_v4(), Uuid::new_v4());
