...
impl PromptCache {
    ...
    pub fn get_with_cost_cents(&self, prompt: &str) -> (Option<CachedResponse>, i64) {
        ...
        let cost = if let Some(ref r) = res {
            ...
            // Miser cost optimization: Calculate accurate cost saved using baseline model pricing.
            crate::calculator::calculate_cost_cents("gpt-4o", r.token_count as i64, 0, 0)
        } else {
            0
        };
        (res, cost)
...
mod tests {
    ...
    fn test_prompt_cache_get_with_cost_cents() {
        ...
        // 1,000,000 tokens = 5.00 USD = 500 cents.
        // 100,000 tokens = 0.50 USD = 50 cents.
        cache.set("What is the capital of France?", "Paris", 100000);
