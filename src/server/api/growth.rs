...
mod tests {
    ...
    async fn test_handle_zero_click_generate() {
        ...
        let _ = handle_zero_click_generate(Extension(state), axum::extract::Extension(::server_auth::orchestration::AuthInfo { org_id: "tenant_123".to_string(), agent_id: "".to_string(), spiffe_id: "".to_string() }), Json(req)).await;
    }
