...
pub async fn handle_track_share(
    axum::extract::Extension(state): axum::extract::Extension<GrowthState>,
    axum::extract::Extension(auth_info): axum::extract::Extension<::server_auth::orchestration::AuthInfo>,
    axum::Json(req): axum::Json<TrackShareRequest>,
) -> Result<axum::Json<TrackShareResponse>, axum::http::StatusCode> {
    let msg = state.hub.sanitize_hub_event(serde_json::json!({
    ...
    Ok(axum::Json(TrackShareResponse {
        success: true,
