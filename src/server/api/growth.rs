...
mod tests {
    ...
    async fn test_unboxing_share_generator() {
        ...
        let auth_info = ::server_auth::orchestration::AuthInfo {
            spiffe_id: "spiffe://onehumancorp.io/org/test_tenant/agent/test_agent".to_string(),
...
#[tokio::test]
    ...
    async fn test_handle_zero_click_generate() {
        ...
        let auth_info = ::server_auth::orchestration::AuthInfo {
            spiffe_id: format!("spiffe://onehumancorp.io/org/{}/agent/agent1", "test-tenant-zero"),
    ...
    async fn test_handle_conversational_chat_growth() {
        ...
        let auth_info = ::server_auth::orchestration::AuthInfo {
            spiffe_id: format!("spiffe://onehumancorp.io/org/{}/agent/agent1", test_tenant),
