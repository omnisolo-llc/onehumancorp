...
mod tests {
    ...
    async fn test_handle_zero_click_generate() {
        ...
        let req = ZeroClickGenerateRequestV2 {
    ...
    async fn test_zero_click_generate() {
        ...
        let res = handle_zero_click_generate_v2(axum::extract::Extension(state.clone()), axum::extract::Extension(auth_info.clone()), axum::Json(req)).await;
...
pub struct ZeroClickGenerateRequestV2 {
    pub prompt: String,
}

#[derive(Debug, serde::Serialize, serde::Deserialize)]
pub struct ZeroClickGenerateResponseV2 {
    pub name: String,
    pub url: String,
    pub products_count: usize,
}

pub async fn handle_zero_click_generate_v2(
    axum::extract::Extension(state): axum::extract::Extension<GrowthState>,
    axum::extract::Extension(auth_info): axum::extract::Extension<::server_auth::orchestration::AuthInfo>,
    axum::Json(req): axum::Json<ZeroClickGenerateRequestV2>,
) -> Result<axum::Json<ZeroClickGenerateResponseV2>, axum::http::StatusCode> {
    ...
    Ok(axum::Json(ZeroClickGenerateResponseV2 {
