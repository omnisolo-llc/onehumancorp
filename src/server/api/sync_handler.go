...
func HandleHybridSyncMissions(hub *orchestration.Hub) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx, span := otel.Tracer("github.com/onehumancorp/mono/src/server/api").Start(r.Context(), "HandleHybridSyncMissions")
		defer span.End()
...
func HandleTelemetrySync(w http.ResponseWriter, r *http.Request) {
	ctx, span := otel.Tracer("github.com/onehumancorp/mono/src/server/api").Start(r.Context(), "HandleTelemetrySync")
	defer span.End()
