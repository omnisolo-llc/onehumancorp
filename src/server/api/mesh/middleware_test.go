...
func TestValidationMiddleware(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			body:           `{"agent_id": "123", "channel": "mesh:tasks", "event_type": "TASK", "data": {"foo": "bar"}, "action": "do", "status": "ok"}`,
		...
		},
		{
			...
			method:         "POST",
			path:           "/api/mesh/broadcast",
			body:           `{"channel": "mesh:tasks", "event_type": "TASK", "data": {"foo": "bar"}, "action": "do", "status": "ok"}`,
		...
		},
		{
			...
			method:         "POST",
			path:           "/api/mesh/broadcast",
			body:           `{"agent_id": "", "channel": "mesh:tasks", "event_type": "TASK", "data": {"foo": "bar"}, "action": "do", "status": "ok"}`,
			expectedStatus: http.StatusBadRequest,
		},
		{
