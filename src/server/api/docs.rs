...
pub fn get_articles() -> Vec<HelpArticle> {
    vec![
        ...
        HelpArticle {
            ...
            desc: "Learn how to send verified proposals and generate secure checkout links."
                .to_string(),
...
pub fn get_article(id: &str) -> Option<HelpArticleDetail> {
    match id {
      ...
      <p class="text-gray-700 mb-4">
        OmniSolo ensures that the quote generated directly reflects the customer's inquiry and your explicit business rules. We validate owner-supplied line items and deposits with checked math. If pricing information is missing, the system will mark it as NEEDS_PRICING for your review, rather than guessing or fabricating a fixed amount. Optional, unselected items are strictly excluded from committed totals.
      </p>
      ...
      <ol class="list-decimal pl-5 text-gray-700 mb-4">
        ...
        <li class="mb-2">Click <strong>Generate Proposal</strong>. Review the line items carefully. If any items are marked NEEDS_PRICING, fill in the correct amounts.</li>
