...
async fn simulate_invoice_followup(
    ...
    let payload = serde_json::json!({
        ...
        "invoice_id": "inv_123",
        "original_message": "Invoice inv_123 is 3 days past due.",
        "generated_response": "Hi Client X, just checking in on invoice inv_123. It looks like it's 3 days past due. Let me know if you need me to resend it or if you have any questions!",
        "operational_action": "Draft personalized reminder",
        "customer_id": "client_X",
