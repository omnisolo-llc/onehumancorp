...
pub fn router() -> Router<AppState> {
    Router::new()
        .route("/api/v1/ledger/invoice/{id}", get(get_invoice))
        .route("/api/v1/ledger/invoice/draft", post(create_invoice_draft))
        .route("/api/v1/ledger/invoice/{id}/update", put(update_invoice_status))
        .route("/api/v1/ledger/invoice/{id}/pay", post(apply_payment))
        .route("/api/v1/ledger/entries/{tenant_id}", get(get_ledger_entries))
}
