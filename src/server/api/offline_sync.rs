...
mod tests {
    ...
    async fn test_sync_events_success() {
        ...
        headers.insert("x-spiffe-id", "spiffe://ohc.local/org/tenant-sync-1/agent/x".parse().unwrap());
    ...
    async fn test_sync_events_idempotent() {
        ...
        let mut headers = HeaderMap::new();
        headers.insert("x-spiffe-id", "spiffe://ohc.local/org/tenant-sync-2/agent/x".parse().unwrap());
    ...
    async fn test_sync_events_conflict() {
        ...
        let mut headers = HeaderMap::new();
        headers.insert("x-spiffe-id", "spiffe://ohc.local/org/tenant-sync-3/agent/x".parse().unwrap());
    ...
    async fn test_offline_sync_success_and_negative_guard() {
        ...
        let mut headers = HeaderMap::new();
        headers.insert("x-spiffe-id", "spiffe://ohc.local/org/tenant-offline/agent/x".parse().unwrap());
    ...
    async fn test_offline_sync_field_service_mutations() {
        ...
        let mut headers = HeaderMap::new();
        headers.insert("x-spiffe-id", "spiffe://ohc.local/org/tenant-field-service/agent/x".parse().unwrap());
