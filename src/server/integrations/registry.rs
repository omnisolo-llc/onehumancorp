...
pub struct IntegrationsRegistry {
    ...
    pub brevo_clients: std::sync::RwLock<std::collections::HashMap<String, std::sync::Arc<crate::integrations::brevo::provider::BrevoProvider>>>,
    pub outlook_clients: std::sync::RwLock<std::collections::HashMap<String, std::sync::Arc<crate::integrations::outlook::provider::OutlookProvider>>>,
    ...
    pub whereby_clients: std::sync::RwLock<std::collections::HashMap<String, std::sync::Arc<crate::integrations::whereby::provider::WherebyProvider>>>,
    pub shipengine_clients: std::sync::RwLock<std::collections::HashMap<String, std::sync::Arc<crate::integrations::shipengine::provider::ShipEngineProvider>>>,
...
impl IntegrationsRegistry {
    pub fn new() -> Self {
        ...
        IntegrationsRegistry {
            ...
            brevo_clients: std::sync::RwLock::new(std::collections::HashMap::new()),
            outlook_clients: std::sync::RwLock::new(std::collections::HashMap::new()),
