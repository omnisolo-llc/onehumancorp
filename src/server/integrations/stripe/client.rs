...
impl StripeClient {
    ...
    pub async fn create_payment_link(&self, price_id_or_name: &str, customer_id: &str, amount_usd: f64) -> Result<String, String> {
        self.create_checkout_session(price_id_or_name, customer_id, amount_usd, false).await
    }
