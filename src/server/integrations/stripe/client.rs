...
impl StripeClient {
    ...
    pub async fn create_checkout_session(&self, price_id_or_name: &str, customer_id: &str, amount_usd: f64, subscription_interval: Option<String>, inventory_lock_id: Option<String>) -> Result<String, String> {
