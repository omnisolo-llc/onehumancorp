            ...
            <html>
                <head>
                    ...
                    <style>
                        ...
                        #login-screen h1 { text-align: center; margin-bottom: 8px; font-size: 24px; font-family: 'Outfit', sans-serif; }
                        #login-screen h2 { text-align: center; margin-bottom: 8px; font-size: 20px; font-family: 'Outfit', sans-serif; }
                ...
                <body>
                    ...
                    <nav id="bottom-nav" style="display: none; position: fixed; bottom: 0; left: 0; width: 100%; height: 60px; background: var(--sidebar-bg); border-top: 1px solid var(--border); display: flex; justify-content: space-around; align-items: center; z-index: 100;" class="glass">
                        <button class="secondary" style="border: none; background: transparent; padding: 10px; width: 44px; height: 44px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;" onclick="showScreen('setup-screen')">
                            <span style="font-size: 12px; font-weight: 500;">Add</span>
                        </button>
                        <button class="secondary" style="border: none; background: transparent; padding: 10px; width: 44px; height: 44px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;" onclick="showScreen('dashboard-screen')">
                            <span style="font-size: 12px; font-weight: 500;">Orders</span>
                        </button>
                        <button class="secondary" style="border: none; background: transparent; padding: 10px; width: 44px; height: 44px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;" onclick="showScreen('inbox-screen')">
                            <span style="font-size: 12px; font-weight: 500;">Messages</span>
                        </button>
                        <button class="secondary" style="border: none; background: transparent; padding: 10px; width: 44px; height: 44px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;" onclick="showScreen('diagnostics-screen')">
                            <span style="font-size: 12px; font-weight: 500;">Analytics</span>
                        </button>
                        <button class="secondary" style="border: none; background: transparent; padding: 10px; width: 44px; height: 44px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;" onclick="showScreen('dashboard-screen')">
                    ...
                    <div id="dashboard-screen" class="screen glass">
                        ...
                        <div class="card glass">
                            <h3>Quick Actions <button class="secondary" style="border-radius: 50%; width: 24px; height: 24px; padding: 0; display: inline-flex; align-items: center; justify-content: center; font-size: 12px; margin-left: 8px;" onclick="document.getElementById('quick-actions-hint').style.display='block'">?</button></h3>
                            <p id="quick-actions-hint" style="display: none; font-size: 14px; color: var(--text-secondary); margin-top: 4px; margin-bottom: 12px; animation: fadeIn 300ms cubic-bezier(0.4, 0, 0.2, 1);">These buttons are shortcuts to your most common daily tasks.</p>
