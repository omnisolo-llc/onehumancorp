...
impl MyHubService {
    pub fn new(hub: Arc<Hub>, pool: sqlx::PgPool, db: Arc<crate::db::DB>) -> Self {
        ...
        let referral_score_tracker =
            Arc::new(crate::services::growth::referral_score::ReferralScoreTracker::new());
...
impl HubService for MyHubService {
    ...
    async fn invite(
        ...
        self.referral_score_tracker
            .record_invite_sent(&req.inviter_id);
