...
pub async fn run_server() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let advisor_agent = std::sync::Arc::new(tokio::sync::RwLock::new(crate::orchestration::departments::business_advisory_agent::BusinessAdvisoryAgent::new(dept_orchestrator.clone())));
    ...
    dept_orchestrator.register_department(advisor_agent).await;
