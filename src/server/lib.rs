...
pub struct MyHubService {
    ...
    referral_loop_tracker: Arc<crate::services::growth::referral_loop::ReferralLoopTracker>,
...
impl MyHubService {
    pub fn new(hub: Arc<Hub>, pool: sqlx::PgPool, db: Arc<crate::db::DB>) -> Self {
        ...
        let referral_loop_tracker = Arc::new(crate::services::growth::referral_loop::ReferralLoopTracker::new());
        ...
        MyHubService { hub, invite_tracker, referral_loop_tracker, onboarding_agent, publish_counter, stream_counter }
    }
}
...
impl HubService for MyHubService {
    ...
    async fn invite(
        ...
        self.referral_loop_tracker.record_invite_sent(&req.inviter_id);
    ...
    async fn accept_invite(
        ...
        self.referral_loop_tracker.record_invite_accepted(&req.invitee_id);
