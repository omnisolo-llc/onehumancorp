...
async fn get_inbox_messages_handler(axum::extract::Extension(user): axum::extract::Extension<::server_common::Claims>) -> axum::response::Response {
    ...
    let app = axum::Router::new()
        ...
        .route("/api/v1/sync/offline-pos", axum::routing::post(|headers: axum::http::HeaderMap, payload: axum::Json<api::offline_pos_sync::OfflinePosSyncRequest>| async move { api::offline_pos_sync::offline_pos_sync_handler(headers, payload).await }))
