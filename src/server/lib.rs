...
async fn create_ui_bom_item_handler(
    ...
    let app = axum::Router::new()
        ...
        .route("/api/v1/growth/affiliate/stats", axum::routing::get(crate::api::growth::get_affiliate_stats_handler).with_state(db.clone()))
        .route("/api/v1/growth/reputation/stats", axum::routing::get(crate::api::growth::get_reputation_stats_handler).with_state(db.clone()))
