...
async fn create_ui_bom_item_handler(
    ...
    let app = axum::Router::new()
        ...
        .route("/api/v1/settings/integrations/whatsapp_cloud_api", axum::routing::post(api::settings::integrations::whatsapp::connect_whatsapp_cloud_api).with_state(std::sync::Arc::new(crate::integrations::registry::IntegrationsRegistry::new())))
        .route("/api/v1/settings/integrations/whatsapp", axum::routing::post(api::settings::integrations::whatsapp::connect_whatsapp_twilio).with_state(std::sync::Arc::new(crate::integrations::registry::IntegrationsRegistry::new())))
