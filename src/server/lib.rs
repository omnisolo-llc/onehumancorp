...
async fn create_ui_bom_item_handler(
    ...
    let app = axum::Router::new()
        ...
        .nest("/api/v1/booking/engine/availability", api::booking::available_slots::router(db.clone()))
        .nest("/api/v1/booking/engine/reserve", api::booking::reserve::router(db.clone()))
