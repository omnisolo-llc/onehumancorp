...
async fn get_inbox_messages_handler(axum::extract::Extension(user): axum::extract::Extension<::server_common::Claims>) -> axum::response::Response {
    ...
    let app = axum::Router::new()
        .nest("/oauth", crate::api::oauth::proxy::router().nest("/google", crate::api::oauth::google::router()))
        ...
        .merge(api::syndication_handler::router(dept_orchestrator.clone()).with_state(mesh_transport.clone()))
