                ...
                <body>
                    ...
                    <div id="dashboard-screen" class="screen">
                        ...
                        <div class="card glass">
                            ...
                            <button id="integrations-btn" onclick="document.getElementById('meta-integration').style.display='block';">Integrations</button>
                            <button onclick="toggleMenu()">Menu</button>
                        </div>
                        <div id="meta-integration" class="card glass" style="display: none;">
                            <h3>💬 Meta Graph API</h3>
                            <p style="font-size: 13px; color: #555; margin-bottom: 12px;">Unified social media inbox for Instagram, Facebook, and WhatsApp.</p>
                            <button onclick="alert('Configure Meta Graph API'); showScreen('inbox-screen')">Configure</button>
                        </div>
                    ...
                    <div id="api-screen" class="screen glass">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 16px;">
                            ...
                            <div class="card glass" style="border-radius: 16px;">
                                ...
                                <button style="width: 100%; background: #0066FF; border-radius: 8px; color: #F5F5F7;" onclick="alert('Connecting to Meta Graph API...')">Connect my Instagram and Facebook</button>
                            </div>
                            ...
                            <div class="card glass" style="border-radius: 16px;">
                                ...
                                <button style="width: 100%; background: #0066FF; border-radius: 8px; color: #F5F5F7;" onclick="alert('Setting up SendGrid...')">Start sending emails</button>
                            </div>
