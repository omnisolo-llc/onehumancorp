        ...
        @media (max-width: 375px) {
            ...
            #setup-screen button, #setup-screen input {
                ...
                <body>
                    ...
                    <!-- Setup Wizard -->
                    <div id="setup-screen" class="screen glass" style="padding: 24px; margin: 16px auto; max-width: 375px; width: 100%; box-sizing: border-box;">
                        <h1 style="margin-bottom: 24px;">OneHuman</h1>
                        <div id="step-1" style="padding: 20px; border-radius: 16px;">
