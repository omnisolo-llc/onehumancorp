                    ...
                    <script>
                        ...
                        async function loadWizardState() {
                            ...
                            if (state) {
                                ...
                                onboardingState.website_template = state.website_template || document.querySelector('#step-8 button.selected')?.innerText || 'Modern';
                                onboardingState.domain_choice = state.domain_choice || document.querySelector('#step-9 button.selected')?.innerText || 'subdomain';
                            }
                        }
                        ...
                        async function nextStep(stepId) {
                            ...
                            if (stepId === 'generating') {
                                ...
                                try {
                                    ...
                                    let domainChoice = window.onboardingState?.domain_choice || document.querySelector('#step-9 button.selected')?.innerText || 'subdomain';
