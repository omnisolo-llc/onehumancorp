...
async fn get_inbox_messages_handler(axum::extract::Extension(user): axum::extract::Extension<::server_common::Claims>) -> axum::response::Response {
    ...
    let app = axum::Router::new()
        ...
        .route("/api/finance/receipts", axum::routing::post(crate::services::finance::receipts::upload_receipt).with_state(std::sync::Arc::new(crate::services::finance::receipts::FinanceState { db_pool: db_for_login.clone(), minimax_api_key: std::env::var("MINIMAX_API_KEY").unwrap_or_default() })))
