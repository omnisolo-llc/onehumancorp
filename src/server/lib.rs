...
async fn create_ui_bom_item_handler(
    ...
    let app = axum::Router::new()
        ...
        .route("/api/ui/yield-opportunities", axum::routing::get(crate::api::yield_opportunities::list_ui_yield_opportunities_handler).with_state(db.clone()))
        .route("/api/ui/yield-opportunities/:id/approve", axum::routing::post(crate::api::yield_opportunities::approve_yield_opportunity_handler).with_state(db.clone()))
