...
pub struct MyHubService {
    ...
    referral_score_tracker: Arc<crate::services::growth::referral_score_tracker::ReferralScoreTracker>,
...
impl MyHubService {
    pub fn new(hub: Arc<Hub>, pool: sqlx::PgPool, db: Arc<crate::db::DB>) -> Self {
        ...
        let referral_score_tracker = Arc::new(crate::services::growth::referral_score_tracker::ReferralScoreTracker::new());
