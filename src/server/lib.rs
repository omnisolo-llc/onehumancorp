...
async fn get_inbox_messages_handler(axum::extract::Extension(user): axum::extract::Extension<::server_common::Claims>) -> axum::response::Response {
    ...
    let app = axum::Router::new()
        ...
        .nest("/api/orchestration/tasks", api::orchestration::tasks::router(std::sync::Arc::new(crate::orchestration::tasks::TaskDecompositionService::new(db.clone(), handoff_mesh.clone()))))
