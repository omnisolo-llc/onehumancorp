...
async fn create_ui_bom_item_handler(
    ...
    let app = axum::Router::new()
        ...
        .route("/api/triage/simulate", axum::routing::post(crate::api::work_triage::simulate_inbound_signal_handler).with_state(db.clone()))
        .route("/api/triage/items", axum::routing::get(crate::api::work_triage::get_daily_work_handler).with_state(db.clone()))
        .route("/api/triage/items/:id/approve", axum::routing::post(crate::api::work_triage::approve_daily_work_handler).with_state(db.clone()))
