...
pub async fn run_server() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = axum::Router::new()
        ...
        .route("/manage-ai", axum::routing::get(ui_handler))
...
async fn ui_handler(req: axum::extract::Request) -> impl axum::response::IntoResponse {
    ...
    let content = match path {
        "/manage-ai" => crate::ui::api::manage_ai_html(),
        "/website-builder" => crate::ui::api::website_builder_html(),
        "/business-setup" => crate::ui::api::business_setup_html(),
        "/login" => crate::ui::api::login_html(),
        "/agents" => crate::ui::api::agents_html(),
        _ => crate::ui::api::dashboard_html(),
    };
