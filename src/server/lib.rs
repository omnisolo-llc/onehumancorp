...
async fn create_ui_bom_item_handler(
    ...
    grpc_server
        ...
        .add_service(::server_ohc::inbox::inbox_service_server::InboxServiceServer::with_interceptor(crate::api::inbox::grpc::InboxGrpcService::new(db.pool.clone()), spiffe_interceptor))
