                    ...
                    <div id="api-screen" class="screen glass">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 16px;">
                            ...
                            <div class="card glass" style="border-radius: 16px;">
                                ...
                                <p style="font-size: 14px; color: var(--text-secondary); margin-bottom: 16px;">Unified inbox for Instagram, Messenger, and WhatsApp.</p>
                            ...
                            <div class="card glass" style="border-radius: 16px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                                    <h3 style="margin: 0;">Mailchimp Automations</h3>
                                    <span style="font-size: 24px; padding: 8px; border-radius: 8px; background: rgba(255,255,255,0.1);">📧</span>
                                </div>
                                <p style="font-size: 14px; color: var(--text-secondary); margin-bottom: 16px;">Trigger email campaigns based on customer purchase behavior.</p>
