...
async fn create_ui_bom_item_handler(
    ...
    Server::builder()
        ...
        .add_service(::server_ohc::app::terminal_session_service_server::TerminalSessionServiceServer::with_interceptor(crate::services::pos::terminal_session::MyTerminalSessionService::new(db.clone()), spiffe_interceptor))
        .serve(addr)
        .await?;
