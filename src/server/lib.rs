...
async fn get_inbox_messages_handler(axum::extract::Extension(user): axum::extract::Extension<::server_common::Claims>) -> axum::response::Response {
    ...
    if ::server_config::get().telemetry_enabled {
        ...
        let telemetry_daemon = crate::services::sync::telemetry_sync::TelemetrySyncWorker::with_mode(db.clone(), cloud_url.clone(), crate::services::sync::telemetry_sync::perf::CoordinatorMode::Parallel);
