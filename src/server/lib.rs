...
pub async fn run_server() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = axum::Router::new()
        .route("/", axum::routing::get(ui::ui_handler))
        .route("/business-setup", axum::routing::get(ui::ui_handler))
        .route("/login", axum::routing::get(ui::ui_handler))
        .route("/agents", axum::routing::get(ui::ui_handler))
        .route("/meetings", axum::routing::get(ui::ui_handler))
        .route("/inbox", axum::routing::get(ui::ui_handler))
