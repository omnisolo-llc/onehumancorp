...
<<<<<<< HEAD
=======
    let lead_gen_worker = crate::workers::department_workers::lead_gen_worker::LeadGenWorker::new(db.clone());
...
>>>>>>> fb7649b2 (feat(marketing): Autonomous Hyperlocal Lead Generation Agent)
