...
pub async fn ui_handler(req: axum::extract::Request) -> impl axum::response::IntoResponse {
                ...
                <body>
                    ...
                    <div id="setup-screen" class="screen glass">
                        ...
                        <div id="step-100" style="display: none;">
                            ...
                            <p><a href="https://onehumancorp.com">Built with OHC — Start your free business →</a></p>
                        </div>
                    ...
                    <script>
                        ...
                        function nextStep(step) {
                            document.querySelectorAll('div[id^="step-"]').forEach(s => s.style.display = 'none');
