...
mod tests {
    ...
    fn test_authorize_register_agent() {
        ...
        let mut req = crate::ohc::orchestration::RegisterAgentRequest::default();
        let mut agent = crate::ohc::orchestration::Agent::default();
        ...
        let mut req2 = crate::ohc::orchestration::RegisterAgentRequest::default();
        let mut agent2 = crate::ohc::orchestration::Agent::default();
