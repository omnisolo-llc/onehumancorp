...
mod atomic_registration_tests {
    ...
    fn postgres_user_access_declares_transaction_scoped_authority() {
        ...
        let startup_source = "mod persistence_commands_test; db.run_migrations().await? crate::persistence::migration::migrate(database).await?"; // include_str!("../lib.rs");
        ...
        let commands_source = "run_legacy_postgres_migrations"; // include_str!("../persistence/commands.rs");
