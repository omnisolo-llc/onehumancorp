...
impl UserRepository for PgUserRepository {
    ...
    async fn get_by_id(&self, id: &str, org_id: &str) -> Result<User, String> {
        validate_org_id!(org_id);
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id, oidc_subject, created_at, updated_at FROM users WHERE id = $1 AND tenant_id = current_setting('app.current_tenant', true)";
    ...
    async fn get_by_username(&self, username: &str, org_id: &str) -> Result<User, String> {
        ...
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id, oidc_subject, created_at, updated_at FROM users WHERE username = $1 AND tenant_id = current_setting('app.current_tenant', true)";
    ...
    async fn get_by_email(&self, email: &str, org_id: &str) -> Result<User, String> {
        ...
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id, oidc_subject, created_at, updated_at FROM users WHERE email = $1 AND tenant_id = current_setting('app.current_tenant', true)";
    ...
    async fn get_by_oidc_subject(&self, sub: &str, org_id: &str) -> Result<User, String> {
        ...
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id, oidc_subject, created_at, updated_at FROM users WHERE oidc_subject = $1 AND tenant_id = current_setting('app.current_tenant', true)";
    ...
    async fn list_users(&self, org_id: &str) -> Result<Vec<User>, String> {
        validate_org_id!(org_id);
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id, oidc_subject, created_at, updated_at FROM users WHERE tenant_id = current_setting('app.current_tenant', true) ORDER BY created_at";
    ...
    async fn update_user(&self, user: User, org_id: &str) -> Result<(), String> {
        ...
        let query = r#"
            ...
            WHERE id=$1 AND tenant_id = current_setting('app.current_tenant', true) RETURNING id
            "#;
    ...
    async fn delete_user(&self, id: &str, org_id: &str) -> Result<(), String> {
        validate_org_id!(org_id);
        let query = "DELETE FROM users WHERE id = $1 AND tenant_id = current_setting('app.current_tenant', true) RETURNING id";
    ...
    async fn is_revoked(&self, jti: &str, org_id: &str) -> Result<bool, String> {
        ...
        let row = sqlx::query("SELECT COUNT(*) FROM revoked_tokens WHERE jti = $1 AND expires_at >= CURRENT_TIMESTAMP AND tenant_id = current_setting('app.current_tenant', true)")
            .bind(jti)
            .fetch_one(&mut *tx)
            .await
            .map_err(|e| e.to_string())?;
