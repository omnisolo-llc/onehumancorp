...
impl UserRepository for PgUserRepository {
    ...
    async fn get_by_id(&self, id: &str, org_id: &str) -> Result<User, String> {
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id as tenant_id as organization_id, oidc_subject, created_at, updated_at FROM users WHERE id = $1";
    ...
    async fn get_by_username(&self, username: &str, org_id: &str) -> Result<User, String> {
        ...
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id as tenant_id as organization_id, oidc_subject, created_at, updated_at FROM users WHERE username = $1";
    ...
    async fn get_by_email(&self, email: &str, org_id: &str) -> Result<User, String> {
        ...
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id as tenant_id as organization_id, oidc_subject, created_at, updated_at FROM users WHERE email = $1";
    ...
    async fn get_by_oidc_subject(&self, sub: &str, org_id: &str) -> Result<User, String> {
        ...
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id as tenant_id as organization_id, oidc_subject, created_at, updated_at FROM users WHERE oidc_subject = $1";
    ...
    async fn list_users(&self, org_id: &str) -> Result<Vec<User>, String> {
        let query = "SELECT id, username, email, password_hash, roles, active, tenant_id as tenant_id as organization_id, oidc_subject, created_at, updated_at FROM users ORDER BY created_at";
