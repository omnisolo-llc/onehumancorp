        ...
        match res {
            ...
            Err(e) => {
                if let sqlx::Error::Database(db_err) = &e {
                    if db_err.message().contains("could not obtain lock") || db_err.message().contains("deadlock detected") || db_err.message().contains("database is locked") {
