...
-- Drop any existing unique constraint before recreating
...
-- +goose Down
ALTER TABLE pricing_rules DROP CONSTRAINT IF EXISTS pricing_rules_tenant_id_target_id_key;
ALTER TABLE pricing_rules DROP COLUMN IF EXISTS target_id;
ALTER TABLE pricing_rules DROP COLUMN IF EXISTS is_active;
