...
CREATE POLICY chat_inboxes_tenant_isolation ON chat_inboxes FOR ALL
...
CREATE POLICY chat_channels_tenant_isolation ON chat_channels FOR ALL
USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
...
CREATE POLICY chat_contacts_tenant_isolation ON chat_contacts FOR ALL
USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
...
CREATE POLICY chat_conversations_tenant_isolation ON chat_conversations FOR ALL
USING (tenant_id = current_setting('app.current_tenant_id', true)::uuid);
