-- Migration 218: Native Rust Omnichannel Chat Schema
...
CREATE INDEX IF NOT EXISTS idx_chat_conversations_tenant_last_activity ON chat_conversations(tenant_id, last_activity_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_chat_messages_tenant_conversation ON chat_messages(tenant_id, conversation_id, created_at);
