...
impl DB {
    pub async fn new() -> Result<Self, Box<dyn std::error::Error>> {
        ...
        if database_url.starts_with("sqlite") {
            ...
            // Security: Ensure standalone SQLite DB has restricted permissions.
            // We do this after connection establishment to ensure the file exists if it was created by sqlx.
