...
find_server_bin() {
  ...
  for candidate in \
    ...
    "${script_dir}/ohc" \
    "${runfiles_root}/_main/src/server/ohc" \
    "${runfiles_root}/_main/src/server/ohc_/ohc" \
    "${runfiles_root}/__main__/src/server/ohc" \
    "${runfiles_root}/__main__/src/server/ohc_/ohc" \
    "${runfiles_root}/${TEST_WORKSPACE:-mono}/src/server/ohc" \
    "${runfiles_root}/${TEST_WORKSPACE:-mono}/src/server/ohc_/ohc"; do
