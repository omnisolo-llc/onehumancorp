...
mod tests {
    ...
    async fn test_simulate_sql_sync_lag() {
        ...
        let acquired1 = transport
            .acquire_lock("system_lock", "agent_1", 2)
            .await
            .unwrap();
        assert!(acquired1);
        ...
        let acquired2 = transport
            .acquire_lock("system_lock", "agent_2", 2)
            .await
            .unwrap();
        assert!(!acquired2);
    ...
    async fn test_drop_network_packets() {
        ...
        use ohc_builtin_agent::mesh::transport::{MemoryTransport, MeshTransport, Message};
    ...
    async fn test_ai_token_efficiency() {
        ...
        let compressed_text =
            "This is a very long text that has many words and needs to be compressed."; // Mocking compression behavior
