...
async fn geo_score(
    ...
    let tool = ohc_builtin_agent::tools::generative_visibility::generative_visibility_tool();
    ...
    let res_str = tool.execute.execute(args).await.map_err(|_| axum::http::StatusCode::INTERNAL_SERVER_ERROR)?;
