...
pub async fn list_sites(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid) -> Result<Vec<Site>, sqlx::Error> {
...
pub async fn create_site(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid, domain: Option<String>) -> Result<Site, sqlx::Error> {
    sqlx::query_as::<_, Site>(
...
pub async fn list_pages(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid, site_id: Uuid) -> Result<Vec<Page>, sqlx::Error> {
...
pub async fn create_page(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid, site_id: Uuid, path: String, title: String) -> Result<Page, sqlx::Error> {
    sqlx::query_as::<_, Page>(
...
pub async fn list_blocks(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid, page_id: Uuid) -> Result<Vec<Block>, sqlx::Error> {
...
pub async fn create_block(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid, page_id: Uuid, block_type: String, content: Value, sort_order: i32) -> Result<Block, sqlx::Error> {
    sqlx::query_as::<_, Block>(
...
pub async fn update_block(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid, block_id: Uuid, content: Value) -> Result<Block, sqlx::Error> {
    sqlx::query_as::<_, Block>(
...
pub async fn reorder_blocks(tx: &mut Transaction<'_, Postgres>, tenant_id: Uuid, page_id: Uuid, block_ids: Vec<Uuid>) -> Result<(), sqlx::Error> {
