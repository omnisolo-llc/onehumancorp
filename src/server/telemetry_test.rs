...
mod tests {
    ...
    fn test_buffer_metric_respects_standalone() {
        temp_env::with_vars(vec![("OHC_STANDALONE", Some("true"))], || {
        ...
        // Ensure OHC_STANDALONE is true. Telemetry should be ignored
    ...
    fn test_init_telemetry_standalone_opt_out() {
        temp_env::with_vars(
            ...
            || {
                ...
                // If OHC_STANDALONE=true and OHC_TELEMETRY_ENABLED=false, telemetry should NOT run.
    ...
    fn test_init_telemetry_standalone_opt_in() {
        temp_env::with_vars(
            ...
            || {
                ...
                // If OHC_STANDALONE=true and OHC_TELEMETRY_ENABLED=true, telemetry SHOULD run.
                let should_start_telemetry = config.telemetry_enabled;
