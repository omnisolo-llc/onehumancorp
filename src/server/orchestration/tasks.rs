...
impl TaskDecompositionService {
    ...
    async fn get_task_pg(&self, tx: &mut sqlx::Transaction<'_, sqlx::Postgres>, id: &str) -> Result<SharedTask, String> {
        ...
        Ok(SharedTask {
            ...
            action_risk: row.get::<Option<String>, _>("action_risk").map(|s| crate::__bazel_package::ActionRisk::from_str(&s)),
...
mod tests {
    ...
    async fn test_mission_telemetry_metrics() {
        ...
        let task = crate::__bazel_package::SharedTask {
        ...
        let fail_task = crate::__bazel_package::SharedTask {
    ...
    async fn test_task_dag_dependencies_sqlite() {
        ...
        // Create task 1
        let task1 = crate::__bazel_package::SharedTask {
            id: "task-1".to_string(),
            organization_id: "org-123".to_string(),
            mission_id: "mission-456".to_string(),
            parent_plan_id: "plan-456".to_string(),
        ...
        let task2 = crate::__bazel_package::SharedTask {
            id: "task-2".to_string(),
            organization_id: "org-123".to_string(),
            mission_id: "mission-456".to_string(),
            parent_plan_id: "plan-456".to_string(),
