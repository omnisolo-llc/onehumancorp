use super::{StateManager, TransportLockGuard};
...
impl StateManager for StandaloneStateManager {
    async fn transition_state(
        ...
        let _lock_guard = TransportLockGuard::acquire(self.transport.clone(), lock_key, "standalone_state_manager".to_string(), 30).await?;
