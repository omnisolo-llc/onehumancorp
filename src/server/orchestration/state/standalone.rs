...
impl StateManager for StandaloneStateManager {
    async fn transition_state(
        ...
        let _lock_guard = MeshLockGuard::acquire(self.mesh.clone(), tenant_id, task_id, "standalone_state_manager").await?;
    ...
    async fn pull_available_tasks(&self, limit: i64) -> Result<Vec<SharedTask>, String> {
        ...
        let _lock_guard = MeshLockGuard::acquire(self.mesh.clone(), "system", "pull_tasks", "standalone_state_manager").await?;
