                                ...
                                Ok(Some(job)) => {
                                    ...
                                    match result {
                                        ...
                                        Ok(Ok(Err(e))) => {
                                            ...
                                            if let Err(fail_err) = queue_clone.fail_with_reason(&job_id, 3, &e.to_string()).await {
                                        ...
                                        Err(_) => {
                                            ...
                                            join_handle.abort();
                                            if let Err(fail_err) = queue_clone.fail_with_reason(&job_id, 3, "Timeout exceeded").await {
