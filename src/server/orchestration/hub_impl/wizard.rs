...
impl MyHubService {
    pub async fn impl_handle_config_wizard(
        &self,
    ...
    pub async fn impl_save_wizard_state(
        &self,
    ...
    pub async fn impl_get_wizard_state(
        &self,
    ...
    pub async fn impl_reset_wizard_state(
        &self,
    ...
    pub async fn impl_get_wizard_profile(
        &self,
