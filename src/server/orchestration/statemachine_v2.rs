...
impl StateMachine {
    ...
    pub async fn transition(
        ...
        self.repo
            .update_task_state(task_id, new_state.clone(), agent_id)?;
    ...
    pub async fn transition_to_in_progress(
        ...
        self.transition(tenant_id, task_id, State::InProgress, agent_id)
            .await
    }
    ...
    pub async fn transition_to_completed(
        ...
        self.transition(tenant_id, task_id, State::Completed, "")
            .await
    }
    ...
    pub async fn transition_to_blocked(
        ...
        self.transition(tenant_id, task_id, State::Blocked, "")
            .await
    }
    ...
    pub async fn start_mesh_listener(
        self: Arc<Self>,
