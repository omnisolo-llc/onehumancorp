...
mod integration_tests {
    ...
    async fn test_customer_success_draft_reply_generation() {
        ...
        let event = DepartmentEvent {
            id: uuid::Uuid::new_v4().to_string(), tenant_id: "test_tenant".to_string(), event_type: "tenant.message.received".to_string(),
            payload: json!({ "source": "instagram", "message": "Do you sell vegan cakes?", "customer_id": "test_customer", "inbox_message_id": "test_inbox_message_id" }),
        };
