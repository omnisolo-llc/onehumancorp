    ...
    pub async fn execute_action(
        ...
        match risk {
            ...
            ActionRisk::DraftForReview => {
                ...
                let push_payload = crate::notifications::PushNotificationPayload {
                    title: format!("1-Tap Approval: {}", department),
                    body: description.clone(),
                    action_type: "draft_approval".to_string(),
                    action_id: req.id.clone(),
                };

                let _ = crate::notifications::dispatch_push_notification(&req.tenant_id, push_payload).await;
