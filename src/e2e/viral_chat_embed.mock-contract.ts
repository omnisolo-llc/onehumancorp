...
test.describe('Viral Chat Embed Loop', () => {
  test('should allow generating embed code and verifying the viral link', async ({ page, context }) => {
    ...
    const clipboardText = '<iframe src="https://cloud.omnisolo.co/api/v1/ui/chat-embed.html?tenant=e2e-tenant" />';
    ...
    await expect(brandingLink).toContainText('Powered by OmniSolo');
