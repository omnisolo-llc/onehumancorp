...
ALTER TABLE IF EXISTS field_service_jobs ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS service_stops ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS route_itineraries ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS job_estimates ENABLE ROW LEVEL SECURITY;
