...
('e2e-approval-cart', 'e2e-tenant', 'customer_success', 'Abandoned cart recovery: 10% discount for Sarah', 'DRAFT', 'HIGH', '{"feature_type": "abandoned_cart", "cart_count": 3, "potential_revenue": 120, "message": "Hi! We noticed you left some items in your cart. Here is a 10% discount: RECOVER10."}'::jsonb, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
