...
('e2e-approval-legal', 'e2e-tenant', 'legal', 'Compliance warning: Drafting updated European privacy policy', 'PENDING', 'HIGH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('e2e-approval-finance', 'e2e-tenant', 'finance', 'Invoice reminder for upcoming subscription', 'PENDING', 'LOW', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('e2e-approval-advisory', 'e2e-tenant', 'business_advisory', 'Weekly business insights and recommendations', 'PENDING', 'LOW', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO UPDATE
