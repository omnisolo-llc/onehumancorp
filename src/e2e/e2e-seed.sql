...
ALTER TABLE IF EXISTS users ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS vendors ENABLE ROW LEVEL SECURITY;
INSERT INTO quotes (id, tenant_id, customer_id, status, valid_until, total_amount, required_deposit)
VALUES ('00000000-0000-0000-0000-000000000001', 'tenant-1', '00000000-0000-0000-0000-000000000001', 'DRAFT', NOW() + INTERVAL '7 days', 15000, 7500)
ON CONFLICT DO NOTHING;

INSERT INTO quote_line_items (id, quote_id, description, unit_price_cents, quantity, is_optional)
VALUES ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Plumbing Fix', 15000, 1, false)
ON CONFLICT DO NOTHING;
