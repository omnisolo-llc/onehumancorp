...
('e2e-approval-social-variants', 'e2e-tenant', 'marketing', 'New product detected! Schedule a post to drive sales?', 'DRAFT', 'LOW', '{"feature_type": "social_post_variants", "product_name": "Vegan Celebration Cake", "image_url": "cake.jpg", "draft_variants": {"tiktok": "Check out this cake!", "instagram": "Look at this cake!", "facebook": "Buy this cake!"}}'::jsonb, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
