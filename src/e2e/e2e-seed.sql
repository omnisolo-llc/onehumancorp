...
('e2e-approval-social-post', 'e2e-tenant', 'marketing', 'Draft Instagram post for Seeded Vegan Cake', 'PENDING', 'LOW', '{"feature_type": "social_post", "product_name": "Seeded Vegan Cake", "draft_copy": "Check out our new product: Seeded Vegan Cake! 🚀 #newarrival #ohc", "image_url": ""}'::jsonb, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
