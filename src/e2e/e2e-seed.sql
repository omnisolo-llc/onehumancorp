...
ALTER TABLE IF EXISTS agent_activities DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS agent_activities ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS agent_activities FORCE ROW LEVEL SECURITY;
