...
test.describe.skip('Cross Device Onboarding CUJ', () => {
  test('Persona: Business Owner can save draft and resume cross device', async ({ page, context }) => {
    ...
    const nameInput = page.getByPlaceholder(/e.g. I am Maya. I bake vegan cakes in Austin. Prices start at $50./i);
    ...
    await expect(page.getByPlaceholder(/e.g. I am Maya. I bake vegan cakes in Austin. Prices start at $50./i)).toHaveValue('Cross Device Bakery', { timeout: 10000 });
  });
});
