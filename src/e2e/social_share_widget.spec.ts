...
test.describe('Social Share Widget Growth Loop', () => {
    test('renders social share widget with viral branding loop correctly', async ({ page }) => {
        ...
        const watermark = page.locator('.powered-by', { hasText: '⚡ Powered by OmniSolo' });
        ...
        const checkboxLabel = page.locator('label', { hasText: 'Remove "Powered by OmniSolo" Badge (Pro)' });
