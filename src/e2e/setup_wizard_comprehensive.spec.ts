...
test.describe('Business Setup Wizard Comprehensive Flow', () => {
  test('traverses the current wizard from welcome to launch', async ({ page }) => {
    ...
    await page.getByPlaceholder('What is your business called?').fill('Alex Art', { timeout: 15000 });
    await page.getByPlaceholder("e.g. Maya's Cakes").fill('Original art and prints', { timeout: 15000 });
