...
test.describe('Onboarding Wizard', () => {
  ...
  test('Test 2: Business Setup Wizard Flow state persistence', async ({ page }) => {
    ...
    await page.click('text="Auto-generate description"');
  ...
  test('Test 3: First Product & AI Description', async ({ page }) => {
    ...
    await expect(page.locator('text="Auto-generate description"')).toBeVisible();
    await page.click('text="Auto-generate description"');
    await page.waitForTimeout(1000);
  ...
  test('Test 4: Domain & Go-Live', async ({ page }) => {
    ...
    await expect(page.locator('text="You\'re set up!"')).toBeVisible({ timeout: 10000 });
  });
  ...
  test('Test 5: Welcome Checklist', async ({ page }) => {
    ...
    await expect(page.locator('text="Here\'s what to do next:"')).toBeVisible();
