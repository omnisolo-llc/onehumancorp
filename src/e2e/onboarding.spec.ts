...
test.describe('Onboarding Wizard', () => {
  ...
  test('Maya (The Home Baker) onboarding flow', async ({ page }) => {
    ...
    // Wait for the Smart Builder welcome screen (Step 1 - Description)
    ...
    await page.getByPlaceholder("e.g. I am Maya. I bake vegan cakes in Austin. Prices start at $50.").fill("I am Maya. I bake custom cakes in Portland.");
  ...
  test('Carlos (Handyman) onboarding flow', async ({ page }) => {
    ...
    await page.getByPlaceholder("e.g. I am Maya. I bake vegan cakes in Austin. Prices start at $50.").fill("I am Carlos. I do plumbing in Miami.");
