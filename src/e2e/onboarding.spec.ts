...
test.describe('Onboarding Wizard', () => {
  ...
  test('Maya (The Home Baker) onboarding flow', async ({ page }) => {
    ...
    await page.getByPlaceholder("e.g. I run a bakery called Maya's Custom Cakes.").fill("Maya's Custom Cakes. maya bakes custom cakes. Portland, OR.");
  ...
  test('Carlos (Handyman) onboarding flow', async ({ page }) => {
    ...
    await page.getByPlaceholder("e.g. I run a bakery called Maya's Custom Cakes.").fill("Carlos Plumbing. carlos does handyman services. Miami, FL.");
