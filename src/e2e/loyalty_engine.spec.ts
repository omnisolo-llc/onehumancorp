...
test.describe('Loyalty & Rewards Engine', () => {
  ...
  test('Should create and retrieve loyalty wallet balance', async ({ page, request }) => {
    ...
    await request.post('/api/ui/loyalty/balance', { data: JSON.parse('{ points_balance: 500, wallet_id: "test-wallet" }') }).catch(() => {});
  ...
  test('Should apply points to checkout', async ({ page, request }) => {
    await request.post('/api/ui/loyalty/balance', { data: JSON.parse('{ points_balance: 1000, wallet_id: "test-wallet" }') }).catch(() => {});
  ...
  test('Dashboard should have a link to the loyalty widget', async ({ page, request }) => {
