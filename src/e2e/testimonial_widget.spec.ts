...
test.describe('Testimonial Widget Generator E2E', () => {
    test('User can configure testimonial and copy embed code', async ({ page }) => {
        ...
        await expect(page.getByText('Remove "Powered by OmniSolo" Badge')).toBeVisible();
        ...
        await expect(page.getByText('Make the Testimonial Widget 100% yours. Upgrade to Pro to remove the "Powered by OmniSolo" watermark.')).toBeVisible();
