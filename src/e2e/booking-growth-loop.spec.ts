...
test.describe('Booking Page Growth Loop', () => {
    test('renders OmniSolo footer and links correctly', async ({ page }) => {
        ...
        // Check the "OmniSolo" footer on the main form view
        ...
        // Check the "OmniSolo" footer on the submitted view
        const submittedFooterLink = page.locator('a', { hasText: 'OmniSolo' });
