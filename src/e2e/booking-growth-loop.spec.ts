...
test.describe('Booking Page Growth Loop', () => {
    test('renders Powered by OmniSolo footer and links correctly', async ({ page }) => {
        ...
        // Check the "Powered by OmniSolo" footer on the main form view
        ...
        // Check the "Powered by OmniSolo" footer on the submitted view
        const submittedFooterLink = page.locator('a', { hasText: 'Powered by OmniSolo' });
