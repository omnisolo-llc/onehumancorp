...
test.describe('AI-Driven Subscription & Membership Lifecycle Management', () => {
  test('Subscription offer generation UI handles natural language parsing via m_k', async ({ page, adminUser, loginAs }) => {
    ...
    // Route the API call to return a m_ked response since we don't have the LLM running consistently in E2E
