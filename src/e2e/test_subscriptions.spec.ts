...
test.describe('AI-Driven Subscription & Membership Lifecycle Management', () => {
  test('Subscription offer generation UI handles natural language parsing via UI', async ({ browser }) => {
    ...
    if (await heading.isVisible()) {
        await expect(heading).toHaveText('Recurring Membership');
        ...
        // Verify the parsed structured data shows up in the UI (waiting for processing without mock)
