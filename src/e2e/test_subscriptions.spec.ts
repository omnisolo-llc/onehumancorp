...
test.describe.skip('AI-Driven Subscription & Membership Lifecycle Management', () => {
  test.skip('Subscription offer generation UI handles natural language parsing via mock', async ({ page, adminUser, loginAs }) => {
