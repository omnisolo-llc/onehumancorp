...
test.describe('Storefront E2E', () => {
  test('user can click storefront footer to open signup page', async ({ page, context }) => {
    await page.goto('/');
  ...
  test('should assert footer exists on desktop storefront', async ({ page }) => {
  ...
  test('should assert footer exists on mobile storefront', async ({ page }) => {
  ...
  test('should verify footer text matches precise marketing copy', async ({ page }) => {
    await page.goto('/login');
    await page.locator('input[type="email"]').fill('test@example.com');
    await page.locator('input[type="password"]').fill('password123');
    await page.locator('button:has-text("Login")').click();
  ...
  test('should verify clicking footer initiates redirect workflow', async ({ page, context }) => {
    await page.goto('/login');
    await page.locator('input[type="email"]').fill('test@example.com');
    await page.locator('input[type="password"]').fill('password123');
    await page.locator('button:has-text("Login")').click();
