...
test.describe('Business Setup Wizard - Persona: plumber', () => {
  test('Complete flow for Plumbing Pro', async ({ page }) => {
    await page.goto('/login');
    await page.click('button:has-text("Don\'t have an account? Sign Up")');
    await page.fill('input[placeholder="Email or Username"]', 'plumber@example.com');
    ...
    await page.fill('input[placeholder="e.g. Maya Smith"]', 'Founder plumber');
    await page.fill('input[placeholder="you@email.com"]', 'founder_plumber@example.com');
