...
test.describe('Business Setup Wizard Validation', () => {
  ...
  test('should display default pricing and allow zero pricing', async ({ page }) => {
    await page.click('text=Guided Setup →');
    await page.click('text=🛒 Online Store');
    await page.fill('input[placeholder="e.g. Maya\'s Cakes"]', 'Test Company');
    await page.click('text=Next →');
    ...
    await page.click('text=Next →');
    await page.fill('input[placeholder="e.g. Custom Birthday Cake"]', 'Test Cake');
    await page.fill('input[placeholder="e.g. 50.00"]', '0.00');
    await page.click('text=Next →');
    await page.click('text=🌐 Free OHC Domain');
    await page.click('text=Next →');
    await expect(page.locator('text="Launch My Business →"')).toBeVisible();
  ...
  test('should display default pricing and allow high pricing', async ({ page }) => {
    await page.click('text=Guided Setup →');
    await page.click('text=🛒 Online Store');
    await page.fill('input[placeholder="e.g. Maya\'s Cakes"]', 'Test Company');
    await page.click('text=Next →');
    ...
    await page.click('text=Next →');
    await page.fill('input[placeholder="e.g. Custom Birthday Cake"]', 'Test Cake');
    await page.fill('input[placeholder="e.g. 50.00"]', '10000.00');
    await page.click('text=Next →');
    await page.click('text=🌐 Free OHC Domain');
    await page.click('text=Next →');
    await expect(page.locator('text="Launch My Business →"')).toBeVisible();
  ...
  test('should display default pricing and allow fractional pricing', async ({ page }) => {
    await page.click('text=Guided Setup →');
    await page.click('text=🛒 Online Store');
    await page.fill('input[placeholder="e.g. Maya\'s Cakes"]', 'Test Company');
    await page.click('text=Next →');
    ...
    await page.click('text=Next →');
    await page.fill('input[placeholder="e.g. Custom Birthday Cake"]', 'Test Cake');
    await page.fill('input[placeholder="e.g. 50.00"]', '19.99');
    await page.click('text=Next →');
    await page.click('text=🌐 Free OHC Domain');
    await page.click('text=Next →');
    await expect(page.locator('text="Launch My Business →"')).toBeVisible();
  ...
  test('should display default pricing and allow another custom pricing', async ({ page }) => {
    await page.click('text=Guided Setup →');
    await page.click('text=🛒 Online Store');
    await page.fill('input[placeholder="e.g. Maya\'s Cakes"]', 'Test Company');
    await page.click('text=Next →');
    ...
    await page.click('text=Next →');
    await page.fill('input[placeholder="e.g. Custom Birthday Cake"]', 'Test Cake');
    await page.fill('input[placeholder="e.g. 50.00"]', '10.50');
    await page.click('text=Next →');
    await page.click('text=🌐 Free OHC Domain');
    await page.click('text=Next →');
    await expect(page.locator('text="Launch My Business →"')).toBeVisible();
  ...
  test('should display default pricing and allow high custom pricing', async ({ page }) => {
    await page.click('text=Guided Setup →');
    await page.click('text=🛒 Online Store');
    await page.fill('input[placeholder="e.g. Maya\'s Cakes"]', 'Test Company');
    await page.click('text=Next →');
