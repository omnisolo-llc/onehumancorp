...
test.describe('Agentic Work Triage Feed', () => {
  test('Owner can review and approve AI-drafted replies', async ({ page, loginAs, adminUser }) => {
    ...
    const approveButton = page.locator(`[data-testid="feed-approve-btn"], [id="feed-approve-btn-send-${triageItemId}"], [id="feed-approve-btn-asis-${triageItemId}"]`).first();
  ...
  test('Owner can dismiss AI-drafted replies', async ({ page, loginAs, adminUser }) => {
    ...
    const dismissButton = page.locator(`[data-testid="dismiss-instagram-dm"], [id="dismiss-instagram-dm-${triageItemId}"]`).first();
