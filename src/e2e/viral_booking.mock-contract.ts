...
test.describe('Viral Booking Footer', () => {
    test('renders standalone booking page with viral footer and referral loop link', async ({ page }) => {
        ...
        const htmlContent = `
            ...
            <html>
                <body>
                    ...
                    <a href="/api/v1/growth/referrals/click?target=/onboarding&ref=test-tenant-123">⚡ OmniSolo</a>
                </body>
            </html>
        `;
        ...
        // Check for the "⚡ OmniSolo" footer
        const brandingLink = page.locator('a', { hasText: '⚡ OmniSolo' });
