...
test('verify social media auto-posting flow', async ({ page }) => {
    // Navigate to the home page
    await page.goto('/');
    ...
    // Confirm and Execute
    await page.click('button:has-text("Launch Strategy")');

    // This should open Social Media Auto-Posting
    await expect(page.locator('text="Social Media Auto-Posting"')).toBeVisible();

    // Connect Instagram
    await page.click('button:has-text("Connect Instagram")');
    await expect(page.locator('button:has-text("Instagram (Connected)")')).toBeVisible();

    // Generate Draft Posts
    await page.click('button:has-text("Generate Draft Posts")');
    await expect(page.locator('text="Generated! Check your dashboard."')).toBeVisible();
    ...
    await expect(page.locator('text="Drafted Social Media Post"')).toBeVisible();
});
