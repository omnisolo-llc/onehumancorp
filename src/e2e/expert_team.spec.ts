...
test.describe('Collaborative Expert Team', () => {
  test('should execute an expert team workflow successfully', async ({ page }) => {
    ...
    // which in CI is handled. In E2E tests, the network must not be tested.
    ...
    // Click execute
    // Since backend might be tested out or unavailable in E2E environments that aren't fully configured
