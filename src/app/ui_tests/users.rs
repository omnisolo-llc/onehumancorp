...
#[test]
fn e2e_referral_widget_render_verify() {
    let ui = create();
...
#[test]
fn e2e_referral_widget_invite_callback() {
    let ui = create();
...
#[test]
fn e2e_referral_widget_mobile_scale_state() {
    let ui = create();
...
#[test]
fn e2e_referral_widget_render_users_present() {
    let ui = create();
    let users = slint::VecModel::from(vec![app::UiUser {
        id: "1".into(),
        username: "Bob".into(),
...
#[test]
fn e2e_referral_widget_render_multiple_users() {
    let ui = create();
    let users = slint::VecModel::from(vec![
        app::UiUser {
            id: "1".into(),
