...
#[test]
fn integr_flow_configure_chatwoot() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_calcom() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_twilio() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_resend() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_shippo() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_mercadopago() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_razorpay() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_manychat() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_calendly() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
...
#[test]
fn integr_flow_configure_mailchimp() {
    let ui = create();
    let called = std::rc::Rc::new(std::cell::RefCell::new(String::new()));
    let c = called.clone();
    ui.on_configure_integration(move |name| {
