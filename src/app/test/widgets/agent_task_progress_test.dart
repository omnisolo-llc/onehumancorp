...
void main() {
  testWidgets('AgentTaskProgressWidget renders correctly when not working', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'AgentTaskProgressWidget animation controller runs when working',
    (WidgetTester tester) async {
      ...
      expect(
        decoration.color,
        isNot(equals(const Color.fromRGBO(255, 255, 255, 0.03))),
      );
