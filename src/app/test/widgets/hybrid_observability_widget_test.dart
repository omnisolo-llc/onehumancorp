...
void main() {
  testWidgets('HybridObservabilityWidget renders correctly with OHC tokens', (WidgetTester tester) async {
    final mockSnapshot = DashboardSnapshot(
      organization: const Organization(tier: 'free', id: '1', name: 'Test Org', domain: 'test.com', members: [], roleProfiles: []),
      meetings: [],
      costs: const CostSummary(totalCostUSD: 0, totalTokens: 0, agents: [], totalActions: 0),
      agents: [
        Agent(
          id: '1',
          name: 'Agent 1',
