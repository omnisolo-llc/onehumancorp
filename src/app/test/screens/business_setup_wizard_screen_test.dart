...
void main() {
  testWidgets(
    'BusinessSetupWizardScreen renders and navigates steps in Cloud Mode',
    (WidgetTester tester) async {
      ...
      expect(
        find.text('Welcome! Your AI team, ready in minutes.'),
        findsOneWidget,
      );
  ...
  test('BusinessSetupNotifier covers all state mutations', () {
    ...
    expect(
      container.read(businessSetupProvider).goals.contains('Support'),
      true,
    );
  ...
  testWidgets(
    'BusinessSetupWizardScreen renders and navigates steps in Standalone Mode',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
