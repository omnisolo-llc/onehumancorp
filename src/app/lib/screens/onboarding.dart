...
enum OnboardingState { welcome, input, generating, draft, live }
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.auto_awesome, size: 64, color: Color(0xFF0066FF)),
                          ),
                          SizedBox(height: 24),
                          Text(
                            businessName.isEmpty ? 'Your Beautiful Store' : businessName,
                            style: TextStyle(
                              fontFamily: 'Outfit',
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Generated seamlessly by your AI agent.',
                              textAlign: TextAlign.center,
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                elevation: 10,
                shadowColor: Color(0xFF0066FF).withOpacity(0.5),
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
