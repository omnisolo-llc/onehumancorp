...
CLOUD_HELM_SMOKE_ARGS=(
  ...
  --set-string backend.env.REDIS_URL=redis://${CLOUD_RELEASE_NAME}-valkey-master.ohc-e2e.svc.cluster.local:6379
  --set-string backend.env.REDIS_ADDR=${CLOUD_RELEASE_NAME}-valkey-master.ohc-e2e.svc.cluster.local:6379
