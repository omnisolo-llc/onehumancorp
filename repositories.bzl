...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:kpBdlEPbRvff0mDD1gk7o9BhI16b9p5yYAXRlidpqJE=",
    ...
    go_repository(
        ...
        sum = "h1:V0xpGuD/N8Mi+fQNDynXohVvp7ZztevW5io8CUWlPmU=",
        version = "v2.8.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:prQ9cPiWHcnwfT81Wi5lU9LL8TLY+7pxDru6fQYLCQQ=",
        version = "v2.12.7",
    )
    go_repository(
