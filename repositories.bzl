...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:Awaf8gmW99tZTOWqkLCOl6aw1/rxAWVlHsHIZ3fT2sA=",
        version = "v1.40.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:t8+9P0Y67B48i0u+70y6f/i1s7dI0N3W4wzQpY4l8rM=",
        version = "v0.5700.1",
    )
    go_repository(
        name = "com_github_deckarep_golang_set_v2",
        importpath = "github.com/deckarep/golang-set/v2",
        sum = "h1:Lw5d7X0r2+tT+oT8Aym8mS46F46Zc0ZJ5YqW/zYfMZw=",
        version = "v2.8.0",
    )
    go_repository(
        name = "com_github_go_jose_go_jose_v3",
        importpath = "github.com/go-jose/go-jose/v3",
        sum = "h1:W7wQhF0eOaE226U0u4f4Fq0T7B7/9mJz0h3v+WzYwWw=",
        version = "v3.0.4",
    )
    go_repository(
        name = "com_github_go_stack_stack",
        importpath = "github.com/go-stack/stack",
        sum = "h1:5SgMzNM5HxrEjV0ww2lTmX6E2Izsfxas4+Pt2yWxqqs=",
        version = "v1.8.1",
    )
