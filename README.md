...
| `OPENROUTER_API_KEY` | OpenRouter API key used by `OHC_LLM_PROVIDER=openrouter` |
| `ANTHROPIC_API_KEY` | Anthropic API key |
| `OPENAI_API_KEY` | OpenAI API key |
| `OHC_LLM_PROVIDER` | Builtin agent provider: `openai`, `openai-compatible`, `minimax`, `anthropic`, `openrouter`, or `ollama` |
