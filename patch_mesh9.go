...
`
    strContent = strings.Replace(strContent, "func (lm *LocalTeammateMesh) AdvertiseCapabilities(ctx context.Context, caps pb.AgentCapabilities) error {", discoverAgentsImplLocal, 1)
