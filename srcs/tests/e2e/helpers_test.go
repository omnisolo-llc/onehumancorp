...
func openApp(t *testing.T, page playwright.Page) {
	...
	if err := page.WaitForLoadState(playwright.LoadStateNetworkidle, nil); err != nil {
...
func loginAsAdmin(t *testing.T, page playwright.Page) {
	...
	if isLoginPage {
		...
		if err := emailInput.Fill(adminUser, nil); err != nil {
			t.Logf("loginAsAdmin fill email: %v", err)
		}
		if err := passwordInput.Fill(adminPass, nil); err != nil {
		...
		if err := submitBtn.Click(nil); err != nil {
...
func clickNext(t *testing.T, page playwright.Page) {
	...
	if err := nextBtn.Click(nil); err != nil {
...
func navigateTo(t *testing.T, page playwright.Page, label string) {
	...
	if err := navLink.Click(nil); err != nil {
