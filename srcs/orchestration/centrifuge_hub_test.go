...
func TestCentrifugeNode_MarshalError(t *testing.T) {
	...
	// We can pass a handoff.Message with something unmarshalable if there is a field that allows it.
...
// Actually json.Marshal is not a variable. But wait, what if I pass a channel or function in handoff.Message to force Marshal error?
// Oh, handoff.Message is a struct. Does it contain an `interface{}` field?
