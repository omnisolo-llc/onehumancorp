...
// DB returns the underlying sql.DB connection pool, allowing it to be shared
// with other SQLite-based repositories (like SqliteHubRepository) to avoid
// connection locks and ensure consistent WAL handling across the application.
