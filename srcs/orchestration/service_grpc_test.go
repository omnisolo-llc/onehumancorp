...
func TestOpenMeetingViaGRPC(t *testing.T) {
	hub := NewHub()
	hub.RegisterAgent(handoff.Agent{ID: "p1", Name: "P1", Role: "PM", OrganizationID: "org-1"})
	hub.RegisterAgent(handoff.Agent{ID: "p2", Name: "P2", Role: "SWE", OrganizationID: "org-1"})
	srv := NewHubServiceServer(hub)
...
func TestPublishViaGRPC(t *testing.T) {
	hub := NewHub()
	hub.RegisterAgent(handoff.Agent{ID: "a1", Name: "A1", Role: "PM", OrganizationID: "org-1"})
	hub.RegisterAgent(handoff.Agent{ID: "a2", Name: "A2", Role: "SWE", OrganizationID: "org-1"})
	srv := NewHubServiceServer(hub)
