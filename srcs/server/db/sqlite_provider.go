...
// convertBindVars translates pgx-style args ($1, $2) to SQLite style args (?1, ?2) safely avoiding literals.
// It also strips out Postgres-specific clauses like FOR UPDATE SKIP LOCKED.
