...
func init() {
	...
	ragSyncErrorsTotal, err = meter.Int64Counter(
		...
		metric.WithDescription("Total number of errors encountered during RAG sync operations"),
	)
	if err != nil {
		panic(err)
	}
...
// Ensure the vars are not unused
var _ = ragRecordsSyncedTotal
var _ = ragSyncErrorsTotal
