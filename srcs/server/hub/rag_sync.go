...
// Ensure the metrics variables are available for implementations
func GetRecordsSyncedCounter() metric.Int64Counter {
	return recordsSyncedCounter
}

func GetSyncErrorsCounter() metric.Int64Counter {
	return syncErrorsCounter
}
