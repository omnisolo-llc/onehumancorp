...
// HybridHealthProbe details the system health across Hybrid Architecture modes.
...
// CheckHealth executes unified local-to-cloud health probes, returning a HybridHealthProbe.
func (h *Hub) CheckHealth(ctx context.Context) (interface{}, error) {
