...
// TransitionWithTx performs a state transition for the given entity, using an existing transaction.
// It returns a broadcast payload function which MUST be called after the transaction is successfully committed.
