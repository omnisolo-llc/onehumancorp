...
func (s *PostgresTaskStore) ClaimTask(ctx context.Context, organizationID string, agentID string) (*SharedTask, error) {
	...
	query := `
		SELECT id, organization_id, title, description, status, assigned_agent_id, priority, payload, parent_plan_id, dependencies, created_at, updated_at
		FROM shared_tasks
...
func (s *PostgresTaskStore) CreateTask(ctx context.Context, task *SharedTask) error {
	query := `
		INSERT INTO shared_tasks (organization_id, title, description, status, assigned_agent_id, priority, payload, parent_plan_id, dependencies)
...
func (s *SqliteTaskStore) CreateTask(ctx context.Context, task *SharedTask) error {
	...
	query := `
		INSERT INTO shared_tasks (id, organization_id, title, description, status, assigned_agent_id, priority, payload, parent_plan_id, dependencies, created_at, updated_at)
