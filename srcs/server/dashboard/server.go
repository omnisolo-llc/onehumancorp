...
func NewServer(org domain.Organization, hub *orchestration.Hub, tracker *billing.Tracker, authStore ...*auth.Store) http.Handler {
	...
	mux.HandleFunc("/api/auth/powersync/jwks", server.authHandlers.PowerSyncJWKSHandler)
	mux.HandleFunc("/api/auth/powersync/token", server.authHandlers.PowerSyncTokenHandler)
