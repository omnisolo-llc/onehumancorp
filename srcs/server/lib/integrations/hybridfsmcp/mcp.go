...
func (m *HybridFSMCP) CallTool(ctx context.Context, toolName string, arguments map[string]interface{}) (interface{}, error) {
	...
	case "rag_query":
		...
		if m.escalator != nil && m.escalator.Escalate(ctx, query) {
			return map[string]interface{}{"status": "success", "result": "cloud_rag_result"}, nil
		}
		return map[string]interface{}{"status": "success", "result": "local_rag_result"}, nil
	case "read_file":
