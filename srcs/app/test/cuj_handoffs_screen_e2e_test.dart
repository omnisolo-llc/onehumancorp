...
class _SeededHandoffsApi extends ApiService {
  _SeededHandoffsApi() : super(baseUrl: 'http://test-host', token: 'tok');
  @override
  Future<List<Map<String, dynamic>>> listHandoffs() async => [];
}

Widget _wrap() => ProviderScope(
  overrides: [apiServiceProvider.overrideWithValue(_SeededHandoffsApi())],
  child: const MaterialApp(home: HandoffsScreen()),
);

void main() {
  group('CUJ: Handoffs Screen', () {
