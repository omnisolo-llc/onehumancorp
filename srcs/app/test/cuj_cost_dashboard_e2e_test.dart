...
class _SeededCostApiService extends ApiService {
  ...
  @override
  Future<DashboardSnapshot> getDashboard() async => DashboardSnapshot(
    organization: Organization(id: 'org-1', name: 'Acme', domain: 'acme.com', members: [], roleProfiles: []),
    costs: CostSummary(totalCostUSD: 10.0, totalTokens: 5000, agents: []),
    agents: [],
    meetings: [],
    statuses: [],
...
void main() {
  group('CUJ: Cost Dashboard', () {
    ...
    testWidgets('narrow viewport renders', (t) async {
    ...
    testWidgets('wide viewport renders', (t) async {
    ...
    testWidgets('medium viewport renders', (t) async {
