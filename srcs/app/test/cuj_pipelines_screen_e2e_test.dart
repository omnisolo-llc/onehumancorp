// CUJ: Pipelines Screen (Additional)
...
class _SeededPipelinesApi extends ApiService {
  _SeededPipelinesApi() : super(baseUrl: 'http://test-host', token: 'tok');
  @override
  Future<List<Pipeline>> listPipelines() async => [];
}

Widget _wrap() => ProviderScope(
  overrides: [apiServiceProvider.overrideWithValue(_SeededPipelinesApi())],
  child: const MaterialApp(home: PipelinesScreen()),
);

void main() {
  group('CUJ: Pipelines Screen Additional', () {
