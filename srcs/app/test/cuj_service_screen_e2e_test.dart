...
class _SeededServiceApi extends ApiService {
  _SeededServiceApi() : super(baseUrl: 'http://test-host', token: 'tok');
  @override
  Future<List<Map<String, dynamic>>> listServices() async => [];
}

Widget _wrap() => ProviderScope(
  overrides: [apiServiceProvider.overrideWithValue(_SeededServiceApi())],
