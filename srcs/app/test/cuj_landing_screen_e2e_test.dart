...
Widget _wrap() => const ProviderScope(child: MaterialApp(home: LandingScreen()));

void main() {
  group('CUJ: Landing Screen', () {
    testWidgets('renders Scaffold', (t) async { await t.pumpWidget(_wrap()); await t.pump(); expect(find.byType(Scaffold), findsOneWidget); });
    testWidgets('renders AppBar or body', (t) async { await t.pumpWidget(_wrap()); await t.pump(); expect(find.byType(MaterialApp), findsOneWidget); });
