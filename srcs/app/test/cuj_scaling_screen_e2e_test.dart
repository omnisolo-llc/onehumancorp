...
class _SeededScalingApi extends ApiService {
  _SeededScalingApi() : super(baseUrl: 'http://test-host', token: 'tok');
  @override
  Stream<Map<String, dynamic>> streamScaleEvents() async* {}
}

Widget _wrap() => ProviderScope(
  overrides: [apiServiceProvider.overrideWithValue(_SeededScalingApi())],
  child: const MaterialApp(home: ScalingScreen()),
);

void main() {
  group('CUJ: Scaling Screen', () {
