...
class _SeededIntegrationsApi extends ApiService {
  _SeededIntegrationsApi() : super(baseUrl: 'http://test-host', token: 'tok');
  @override
  Future<List<Map<String, dynamic>>> listIntegrations() async => [];
}

Widget _wrap() => ProviderScope(
  overrides: [apiServiceProvider.overrideWithValue(_SeededIntegrationsApi())],
  child: const MaterialApp(home: IntegrationsScreen()),
);

void main() {
  group('CUJ: Integrations Screen', () {
