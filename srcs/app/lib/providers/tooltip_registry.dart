...
class TooltipRegistryNotifier extends StateNotifier<Map<String, String>> {
  TooltipRegistryNotifier() : super({
  ...
  void registerTooltip(String key, String message) {
    state = {...state, key: message};
  }
}

final tooltipRegistryProvider = StateNotifierProvider<TooltipRegistryNotifier, Map<String, String>>((ref) {
  return TooltipRegistryNotifier();
});
