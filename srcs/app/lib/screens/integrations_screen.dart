                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            child: const Text('Configure', style: TextStyle(fontFamily: 'Inter')),
                          ),
                        ),
                      ],
                    ),
              ...
              child: BackdropFilter(
                ...
                child: AnimatedContainer(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {},
                    child: ListTile(
                      leading: Icon(Icons.build_circle_outlined, color: colors.primary),
                      title: Text(
                        name,
                        style: const TextStyle(
                          fontFamily: 'Outfit',
                      ...
                      trailing: OutlinedButton(
                        ...
                        child: const Text('Invoke', style: TextStyle(fontFamily: 'Inter')),
                      ),
                    ),
                  ),
                ),
