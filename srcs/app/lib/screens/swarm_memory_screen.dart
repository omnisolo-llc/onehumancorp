...
class _GlassMessageCard extends StatefulWidget {
  final CentrifugeMessage message;

  const _GlassMessageCard({required this.message});

  @override
  State<_GlassMessageCard> createState() => _GlassMessageCardState();
}

class _GlassMessageCardState extends State<_GlassMessageCard> with SingleTickerProviderStateMixin {
