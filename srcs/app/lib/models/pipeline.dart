...
class Pipeline {
  ...
  factory Pipeline.fromJson(Map<String, dynamic> json) {
    return Pipeline(
      ...
      stagingUrl:
          json['staging_url'] as String? ?? json['stagingUrl'] as String?,
      initiatedBy:
          json['initiated_by'] as String? ?? json['initiatedBy'] as String?,
      createdAt:
          json['created_at_unix'] != null
              ? DateTime.fromMillisecondsSinceEpoch(
                (json['created_at_unix'] as int) * 1000,
              )
              : json['created_at'] != null
              ? DateTime.parse(json['created_at'] as String)
              : DateTime.now(),
      updatedAt:
          json['updated_at_unix'] != null
              ? DateTime.fromMillisecondsSinceEpoch(
                (json['updated_at_unix'] as int) * 1000,
              )
