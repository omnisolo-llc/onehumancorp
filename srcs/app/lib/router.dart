    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/swarm-observability',
            builder: (context, state) => const SwarmObservabilityScreen(),
          ),
          GoRoute(
  ...
  Widget build(BuildContext context) {
    return NavigationDrawer(
      children: [
        ...
        _NavItem(icon: Icons.hub, label: 'Swarm Observability', path: '/swarm-observability'),
